        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="应急预案" EnableCollapse="true"
                ...
                <Columns>
                    ...
                    <f:TemplateField Width="180px" HeaderText="应急预案编号" HeaderTextAlign="Center" TextAlign="Left"
                    ...
                    <f:TemplateField Width="200px" HeaderText="应急预案名称" HeaderTextAlign="Center" TextAlign="Left"
                    ...
                    <f:TemplateField Width="120px" HeaderText="应急预案类型" HeaderTextAlign="Center" TextAlign="Left"
                    ...
                    <f:TemplateField Width="150px" HeaderText="备注" HeaderTextAlign="Center" TextAlign="Left"
                        SortField="Remark">
                        <ItemTemplate>
