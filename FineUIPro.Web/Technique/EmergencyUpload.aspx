<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmergencyUpload.aspx.cs"
    Inherits="FineUIPro.Web.Technique.EmergencyUpload" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>应急预案资源上传</title>
                            ...
                            <f:FormRow>
                                <Items>
                                    <f:TextBox ID="txtEmergencyName" runat="server" Label="名称" Required="true" ShowRedStar="true"
                                        MaxLength="100" AutoPostBack="true" OnTextChanged="TextBox_TextChanged" LabelAlign="Right">
                                    </f:TextBox>
                                </Items>
                            </f:FormRow>
                            <f:FormRow>
