<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpecialSchemeUpload.aspx.cs"
    Inherits="FineUIPro.Web.Technique.SpecialSchemeUpload" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>专项方案资源上传</title>
                ...
                <Items>
                    <f:Form BodyPadding="5px" ID="SimpleForm1" Layout="VBox" EnableCollapse="false" runat="server"
                        ...
                        <Rows>
                            ...
                            <f:FormRow>
                                <Items>
                                    <f:DropDownList ID="ddlUnit" runat="server" Label="单位" ShowRedStar="true" LabelAlign="Right">
                                    </f:DropDownList>
                                </Items>
                            </f:FormRow>
                            <f:FormRow>
                            ...
                            <f:FormRow>
                                <Items>
                                    <f:TextBox ID="txtSummary" runat="server" Label="摘要" MaxLength="200" LabelAlign="Right">
                                    </f:TextBox>
                                </Items>
                            </f:FormRow>
                            <f:FormRow>
                                <Items>
                                    <f:Label runat="server" ID="lbAttachUrl" BoxConfigPosition="Right">
                                    </f:Label>
                                    <f:Toolbar ID="Toolbar2" runat="server" ToolbarAlign="Right" Position="Bottom">
                                        <Items>
                                            <f:Button ID="btnUploadResources" Text="上传附件" Icon="SystemNew" runat="server" OnClick="btnUploadResources_Click" ValidateForms="SimpleForm1">
                                            </f:Button>
                                        </Items>
                                    </f:Toolbar>
                                </Items>
