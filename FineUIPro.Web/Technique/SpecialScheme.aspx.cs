    ...
    public partial class SpecialScheme : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                btnUploadResources.OnClientClick = Window2.GetShowReference("SpecialSchemeUpload.aspx") + "return false";
                btnAuditResources.OnClientClick = Window3.GetShowReference("SpecialSchemeAudit.aspx") + "return false;"; btnSelectColumns.OnClientClick = Window4.GetShowReference("SpecialSchemeSelectCloumn.aspx");
        ...
        {
            string strSql = "select * from View_Technique_SpecialScheme where IsPass=@IsPass ";
        ...
        private void DeleteData()
        {
            if (Grid1.SelectedRowIndexArray.Length > 0)
            {
                foreach (int rowIndex in Grid1.SelectedRowIndexArray)
                {
                    ...
                    var getV = BLL.SpecialSchemeService.GetSpecialSchemeListById(rowID);
                    if (getV != null)
                    {
                        BLL.LogService.AddSys_Log(this.CurrUser, getV.SpecialSchemeCode, getV.SpecialSchemeId, BLL.Const.SpecialSchemeMenuId, Const.BtnDelete);
        ...
        {
            this.BindGrid();
            BLL.LogService.AddSys_Log(this.CurrUser, string.Empty, string.Empty, BLL.Const.SpecialSchemeMenuId, Const.BtnQuery);
