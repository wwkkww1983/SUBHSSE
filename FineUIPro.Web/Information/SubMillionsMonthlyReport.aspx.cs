...
{
    public partial class SubMillionsMonthlyReport : PageBase
    {
        #region 加载页面
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {               
                ...
                UnitService.InitBranchUnitDropDownList(this.drpUnit, this.CurrUser.UnitId, false);
...
#pragma warning disable CS0108 // “SubMillionsMonthlyReport.GetGridTableHtml(Grid)”隐藏继承的成员“PageBase.GetGridTableHtml(Grid)”。如果是有意隐藏，请使用关键字 new。
        /// <summary>
        /// 导出方法
        /// </summary>
...
#pragma warning restore CS0108 // “SubMillionsMonthlyReport.GetGridTableHtml(Grid)”隐藏继承的成员“PageBase.GetGridTableHtml(Grid)”。如果是有意隐藏，请使用关键字 new。
        {
