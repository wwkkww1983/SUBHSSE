<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GeneralCarIn.aspx.cs" Inherits="FineUIPro.Web.InApproveManager.GeneralCarIn" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>普通车辆入场审批</title>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="普通车辆入场审批" EnableCollapse="true"
                runat="server" BoxFlex="1" EnableColumnLines="true" DataKeyNames="GeneralCarInId"
                AllowCellEditing="true" ClicksToEdit="2" DataIDField="GeneralCarInId" AllowSorting="true"
                ...
                <Columns>
                    ...
                    <f:WindowField TextAlign="Left" Width="160px" WindowID="WindowAtt" HeaderText="附件"
                        Text="上传查看" ToolTip="附件上传查看" DataIFrameUrlFields="GeneralCarInId" DataIFrameUrlFormatString="../AttachFile/webuploader.aspx?toKeyId={0}&path=FileUpload/GeneralCarInAttachUrl&menuId=7087F8BB-DC8C-4A77-8E16-232E0B8481D2"
    ...
    <f:Window ID="Window1" Title="普通车辆入场审批" Hidden="true" EnableIFrame="true" EnableMaximize="true"
