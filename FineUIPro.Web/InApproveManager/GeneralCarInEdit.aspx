<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GeneralCarInEdit.aspx.cs"
    Inherits="FineUIPro.Web.InApproveManager.GeneralCarInEdit" ValidateRequest="false" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            ...
            <f:FormRow>
                <Items>
                    <f:TextArea ID="txtDescription" runat="server" Label="情况说明" LabelAlign="Right" MaxLength="500"
                        Height="50px">
                    </f:TextArea>
                </Items>
            </f:FormRow>
