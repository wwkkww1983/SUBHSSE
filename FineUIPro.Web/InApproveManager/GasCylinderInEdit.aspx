<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GasCylinderInEdit.aspx.cs"
    Inherits="FineUIPro.Web.InApproveManager.GasCylinderInEdit" ValidateRequest="false" %>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            ...
            <f:FormRow ColumnWidths="30% 20% 50%">
                <Items>
                    <f:DatePicker ID="txtInDate" runat="server" Label="入场时间" LabelAlign="Right" EnableEdit="true"
                        EmptyText="请选择日期">
                    </f:DatePicker>
                    <f:TimePicker ID="txtInTime" EnableEdit="true" Increment="1" runat="server" EmptyText="请选择时间">
                    </f:TimePicker>
                    <f:TextBox ID="txtDriverMan" runat="server" Label="驾驶员姓名" LabelAlign="Right" MaxLength="20">
                    </f:TextBox>
                </Items>
            </f:FormRow>
            <f:FormRow>
            ...
            <f:FormRow>
                <Items>
                    <f:TextBox ID="txtLeadCarMan" runat="server" Label="带车人" LabelAlign="Right" MaxLength="20">
                    </f:TextBox>
