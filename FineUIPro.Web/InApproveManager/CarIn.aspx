<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarIn.aspx.cs" Inherits="FineUIPro.Web.InApproveManager.CarIn" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>特种车辆入场审批</title>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="特种车辆入场审批" EnableCollapse="true"
                runat="server" BoxFlex="1" EnableColumnLines="true" DataKeyNames="CarInId"
                AllowCellEditing="true" ClicksToEdit="2" DataIDField="CarInId" AllowSorting="true"
                ...
                <Columns>
                    ...
                    <f:WindowField TextAlign="Left" Width="160px" WindowID="WindowAtt" HeaderText="附件"
                        Text="上传查看" ToolTip="附件上传查看" DataIFrameUrlFields="CarInId" DataIFrameUrlFormatString="../AttachFile/webuploader.aspx?toKeyId={0}&path=FileUpload/CarInAttachUrl&menuId=3D12E3FD-5AC3-485A-A39F-08689234450A"
    ...
    <f:Window ID="Window1" Title="特种车辆入场审批" Hidden="true" EnableIFrame="true" EnableMaximize="true"
