<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EquipmentOut.aspx.cs" Inherits="FineUIPro.Web.InApproveManager.EquipmentOut" %>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="特种设备机具出场报批" EnableCollapse="true"
                runat="server" BoxFlex="1" EnableColumnLines="true" DataKeyNames="EquipmentOutId"
                AllowCellEditing="true" ClicksToEdit="2" DataIDField="EquipmentOutId" AllowSorting="true"
                SortField="EquipmentOutCode" SortDirection="DESC" OnSort="Grid1_Sort" AllowPaging="true"
                IsDatabasePaging="true" PageSize="10" OnPageIndexChange="Grid1_PageIndexChange"
                EnableRowDoubleClickEvent="true" OnRowDoubleClick="Grid1_RowDoubleClick" EnableTextSelection="True">
                <Toolbars>
                    <f:Toolbar ID="Toolbar2" Position="Top" runat="server" ToolbarAlign="Left">
                        <Items>
                            <f:TextBox runat="server" Label="设备出场编号" ID="txtEquipmentOutCode" EmptyText="输入查询条件"
                ...
                <Columns>
                    ...
                    <f:RenderField Width="120px" ColumnID="EquipmentOutCode" DataField="EquipmentOutCode"
                        SortField="EquipmentOutCode" FieldType="String" HeaderText="设备出场编号" HeaderTextAlign="Center"
                        TextAlign="Left">
                    </f:RenderField>
