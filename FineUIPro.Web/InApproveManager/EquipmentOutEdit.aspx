<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EquipmentOutEdit.aspx.cs"
    Inherits="FineUIPro.Web.InApproveManager.EquipmentOutEdit" ValidateRequest="false" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            <f:FormRow>
                <Items>
                    <f:TextBox ID="txtEquipmentOutCode" runat="server" Label="设备出场编号" LabelAlign="Right"
            ...
            <f:FormRow>
                <Items>
                    <f:DropDownList ID="drpUnitId" runat="server" Label="申请单位" Required="true" ShowRedStar="true"
                        LabelAlign="Right">
                    </f:DropDownList>
                    <f:DatePicker ID="txtApplicationDate" runat="server" Label="申请日期" EnableEdit="true"
                        LabelAlign="Right">
                    </f:DatePicker>
                </Items>
            </f:FormRow>
            <f:FormRow>
                <Items>
                    ...
                    <f:TextBox ID="txtCarModel" runat="server" Label="车型" LabelAlign="Right" MaxLength="20">
                    </f:TextBox>
                </Items>
            </f:FormRow>
            <f:FormRow>
            ...
            <f:FormRow>
                <Items>
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="出场机具设备清单" EnableCollapse="true"
                        runat="server" BoxFlex="1" EnableColumnLines="true" DataKeyNames="EquipmentOutItemId"
                        AllowCellEditing="true" ClicksToEdit="2" DataIDField="EquipmentOutItemId" AllowPaging="true"
