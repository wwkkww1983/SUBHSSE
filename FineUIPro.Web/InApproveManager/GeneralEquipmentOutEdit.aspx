<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GeneralEquipmentOutEdit.aspx.cs" Inherits="FineUIPro.Web.InApproveManager.GeneralEquipmentOutEdit" ValidateRequest="false" %>
            ...
            <f:FormRow>
                <Items>
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="出场机具设备清单" EnableCollapse="true"
                        ...
                        AllowCellEditing="true" ClicksToEdit="2" DataIDField="GeneralEquipmentOutItemId" AllowPaging="true"
                        IsDatabasePaging="true" PageSize="10" OnPageIndexChange="Grid1_PageIndexChange"
                        EnableRowDoubleClickEvent="true" OnRowDoubleClick="Grid1_RowDoubleClick" EnableTextSelection="True" Height="230px">
                        <Toolbars>
