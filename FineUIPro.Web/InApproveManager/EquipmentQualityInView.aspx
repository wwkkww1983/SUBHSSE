<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EquipmentQualityInView.aspx.cs" Inherits="FineUIPro.Web.InApproveManager.EquipmentQualityInView" %>
        ...
        <Rows>
            <f:FormRow ColumnWidths="75% 25%">
                <Items>
                    ...
                    </f:TextBox><f:Label ID="Label47" runat="server" >
                    </f:Label>
                </Items>
            </f:FormRow>
            <f:FormRow>
                <Items>
                    ...
                    <f:TextBox ID="txtDutyMan" runat="server" Label="负责人" LabelAlign="Right" Readonly="true">
                    </f:TextBox>
                </Items>
            </f:FormRow>
