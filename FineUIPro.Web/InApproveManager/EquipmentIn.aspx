<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EquipmentIn.aspx.cs" Inherits="FineUIPro.Web.InApproveManager.EquipmentIn" %>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="特种设备机具入场报批" EnableCollapse="true"
                runat="server" BoxFlex="1" EnableColumnLines="true" DataKeyNames="EquipmentInId"
                AllowCellEditing="true" ClicksToEdit="2" DataIDField="EquipmentInId" AllowSorting="true"
                SortField="EquipmentInCode" SortDirection="DESC" OnSort="Grid1_Sort" AllowPaging="true"
                ...
                <Columns>
                    ...
                    <f:RenderField Width="180px" ColumnID="EquipmentInCode" DataField="EquipmentInCode"
                        SortField="EquipmentInCode" FieldType="String" HeaderText="设备入场编号" HeaderTextAlign="Center"
                        TextAlign="Left">
                    </f:RenderField>
                    ...
                    <f:WindowField TextAlign="Left" Width="160px" WindowID="WindowAtt" HeaderText="附件"
                        Text="上传查看" ToolTip="附件上传查看" DataIFrameUrlFields="EquipmentInId" DataIFrameUrlFormatString="../AttachFile/webuploader.aspx?toKeyId={0}&path=FileUpload/EquipmentInAttachUrl&menuId=3E167389-4775-4AC3-9D31-2E570682EDA1"
