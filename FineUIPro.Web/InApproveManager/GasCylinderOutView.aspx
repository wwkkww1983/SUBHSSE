<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GasCylinderOutView.aspx.cs"
    Inherits="FineUIPro.Web.InApproveManager.GasCylinderOutView" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            ...
            <f:FormRow>
                <Items>
                    <f:TextBox ID="txtOutDate" runat="server" Label="出场时间" LabelAlign="Right" Readonly="true">
                    </f:TextBox>
            ...
            <f:FormRow>
                <Items>
                    <f:TextBox ID="txtLeaderName" runat="server" Label="带车人" LabelAlign="Right" Readonly="true">
                    </f:TextBox>
