<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagerMonthD.aspx.cs" Inherits="FineUIPro.Web.Manager.ManagerMonthD" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="安全生产月报" EnableCollapse="true"
                ...
                <Toolbars>
                    <f:Toolbar ID="Toolbar2" Position="Top" runat="server" ToolbarAlign="Left">
                        <Items>
                            ...
                            <f:Button ID="btnHelp" runat="server" ToolTip="点击下载本页面使用说明" Text="帮助">
                                         <Listeners>
                ...
                <Columns>
                    ...
                    <f:RenderField Width="100px" ColumnID="States" DataField="States"
                        SortField="States" FieldType="String" HeaderText="状态" TextAlign="Left"
                        HeaderTextAlign="Center">
                    </f:RenderField>
                </Columns>
                <Listeners>
    ...
    <script type="text/javascript">
        ...
        function onToolSourceCodeClick(event) {
            window.open('../Doc/安全生产月报.doc', '_blank');
        }
    </script>
</body>
</html>
