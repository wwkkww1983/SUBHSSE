<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HealthEdit.aspx.cs" ValidateRequest="false" Inherits="FineUIPro.Web.Manager.HealthEdit" %>
        ...
        <Rows>
            <f:FormRow>
                <Items>
                    ...
                    <f:TextBox ID="txtHealthName" runat="server" Label="月报名称" Required="true" ShowRedStar="true"
