<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonthReportCView3.aspx.cs" Inherits="FineUIPro.Web.Manager.MonthReportCView3" %>
                    ...
                    <f:GroupPanel ID="GroupPanel10" Layout="Anchor" Title="3.本月项目现场HSE人工日统计" runat="server" AutoScroll="true">
                        <Items>
                            <f:Grid ID="gvHSEDay" ShowBorder="true" ShowHeader="false" Title="本月项目现场HSE人工日统计" 
                                runat="server" AllowCellEditing="false" ClicksToEdit="1" DataIDField="MonthHSEDay" Width="1200px"
