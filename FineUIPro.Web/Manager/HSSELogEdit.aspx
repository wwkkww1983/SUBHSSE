<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HSSELogEdit.aspx.cs" Inherits="FineUIPro.Web.Manager.HSSELogEdit" ValidateRequest="false" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>编辑HSSE日志暨管理数据收集</title>
    <link href="../res/css/common.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <form id="form1" runat="server">
        <f:PageManager ID="PageManager1" runat="server" />
        <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" Title="HSSE日志暨管理数据收集" AutoScroll="true"
            BodyPadding="10px" runat="server" RedStarPosition="BeforeText" LabelAlign="Right" Layout="VBox" Width="990px">
            <Rows>
                <f:FormRow>
                    <Items>
                        <f:DatePicker ID="txtCompileDate" runat="server" Label="日志日期" LabelAlign="Right" Required="true" ShowRedStar="true"
                            EnableEdit="true" FocusOnPageLoad="true" AutoPostBack="true" OnTextChanged="TextBox_TextChanged">
                        </f:DatePicker>
                        <f:DropDownList ID="drpCompileMan" runat="server" Label="编制人" LabelAlign="Right" Enabled="false">
                        </f:DropDownList>
                        <f:DropDownList ID="drpWeather" runat="server" Label="天气" LabelAlign="Right">
                        </f:DropDownList>
                    </Items>
                </f:FormRow>
                ...
                <f:FormRow ColumnWidths="5% 15% 30% 50%">
                    <Items>
                        ...
                        <f:NumberBox ID="txtNum11" runat="server" LabelAlign="Left" NoDecimal="true" NoNegative="true"></f:NumberBox>
                    </Items>
                </f:FormRow>
                <f:FormRow ColumnWidths="5% 15% 30% 50%">
                    <Items>
                ...
                <f:FormRow ColumnWidths="5% 15% 30% 50%">
                    <Items>
                        ...
                        <f:NumberBox ID="txtNum21" runat="server" LabelAlign="Left" NoDecimal="true" NoNegative="true"></f:NumberBox>
                    </Items>
                </f:FormRow>
                <f:FormRow ColumnWidths="5% 15% 30% 50%">
                    <Items>
                ...
                <f:FormRow ColumnWidths="5% 15% 30% 50%">
                    <Items>
                        ...
                        <f:NumberBox ID="txtNum22" runat="server" LabelAlign="Left" NoDecimal="true" NoNegative="true"></f:NumberBox>
                    </Items>
                </f:FormRow>
                <f:FormRow ColumnWidths="5% 15% 30% 50%">
                    <Items>
                ...
                <f:FormRow ColumnWidths="5% 15% 30% 50%">
                    <Items>
                        ...
                        <f:NumberBox ID="txtNum23" runat="server" LabelAlign="Left" NoDecimal="true" NoNegative="true"></f:NumberBox>
                    </Items>
                </f:FormRow>
                <f:FormRow ColumnWidths="5% 15% 30% 50%">
                    <Items>
                ...
                <f:FormRow ColumnWidths="5% 15% 30% 50%">
                    <Items>
                        ...
                        <f:NumberBox ID="txtNum24" runat="server" LabelAlign="Left" NoDecimal="true" NoNegative="true"></f:NumberBox>
                    </Items>
                </f:FormRow>
                <%--<f:FormRow ColumnWidths="5% 15% 30% 50%">
                <Items>
                   ...
                   <f:TextBox ID="txtContents25" runat="server" LabelAlign="Left" MaxLength="2000">
                    </f:TextBox>
                </Items>
            </f:FormRow> 
            <f:FormRow ColumnWidths="5% 15% 30% 50%">
                <Items>
                   ...
                   <f:NumberBox ID="txtNum25" runat="server" LabelAlign="Left"  NoDecimal="true" NoNegative="true"></f:NumberBox>
                </Items>
            </f:FormRow>
            <f:FormRow ColumnWidths="5% 15% 30% 50%">
                <Items>
                   ...
                   <f:TextBox ID="txtContents26" runat="server" LabelAlign="Left" MaxLength="2000">
                    </f:TextBox>
                </Items>
            </f:FormRow> 
            <f:FormRow ColumnWidths="5% 15% 30% 50%">
                <Items>
                   ...
                   <f:NumberBox ID="txtNum26" runat="server" LabelAlign="Left"  NoDecimal="true" NoNegative="true"></f:NumberBox>
                </Items>
            </f:FormRow>
            <f:FormRow ColumnWidths="5% 15% 30% 50%">
                <Items>
                   ...
                   <f:TextBox ID="txtContents27" runat="server" LabelAlign="Left" MaxLength="2000">
                    </f:TextBox>
                </Items>
            </f:FormRow> 
            <f:FormRow ColumnWidths="5% 15% 30% 50%">
                <Items>
                   ...
                   <f:NumberBox ID="txtNum27" runat="server" LabelAlign="Left"  NoDecimal="true" NoNegative="true"></f:NumberBox>
                </Items>
            </f:FormRow>
            <f:FormRow ColumnWidths="5% 15% 30% 50%">
                <Items>
                   ...
                   <f:TextBox ID="txtContents28" runat="server" LabelAlign="Left" MaxLength="2000">
                    </f:TextBox>
                </Items>
            </f:FormRow> 
            <f:FormRow ColumnWidths="5% 15% 30% 50%">
                <Items>
                   ...
                   <f:NumberBox ID="txtNum28" runat="server" LabelAlign="Left"  NoDecimal="true" NoNegative="true"></f:NumberBox>
                </Items>
            </f:FormRow>
            <f:FormRow ColumnWidths="5% 15% 30% 50%">
                <Items>
                   ...
                   <f:TextBox ID="txtContents29" runat="server" LabelAlign="Left" MaxLength="2000">
                    </f:TextBox>
                </Items>
            </f:FormRow> 
            <f:FormRow ColumnWidths="5% 15% 30% 50%">
                <Items>
                   ...
                   <f:NumberBox ID="txtNum29" runat="server" LabelAlign="Left"  NoDecimal="true" NoNegative="true"></f:NumberBox>
                </Items>
            </f:FormRow>--%>
                <f:FormRow ColumnWidths="5% 15% 30% 50%">
                    <Items>
                ...
                <f:FormRow ColumnWidths="5% 15% 30% 50%">
                    <Items>
                        ...
                        <f:NumberBox ID="txtNum210" runat="server" LabelAlign="Left" NoDecimal="true" NoNegative="true"></f:NumberBox>
                    </Items>
                </f:FormRow>
                <f:FormRow ColumnWidths="5% 15% 30% 50%">
                    <Items>
                        ...
                        <f:NumberBox ID="txtNum211" runat="server" LabelAlign="Left" NoDecimal="true" NoNegative="true"></f:NumberBox>
                    </Items>
                </f:FormRow>
                <f:FormRow ColumnWidths="5% 15% 30% 50%">
                    <Items>
                ...
                <f:FormRow ColumnWidths="5% 15% 30% 50%">
                    <Items>
                        ...
                        <f:Label ID="Label92" runat="server" Text="HSE文件修编数量"></f:Label>
                        <f:Label ID="Label93" runat="server" Text="HSE体系文件修编、审核的数量，同存档文件对应"></f:Label>
                        <f:NumberBox ID="txtNum31" runat="server" LabelAlign="Left" NoDecimal="true" NoNegative="true"></f:NumberBox>
                    </Items>
                </f:FormRow>
                <f:FormRow ColumnWidths="5% 15% 30% 50%">
                    <Items>
                ...
                <f:FormRow ColumnWidths="5% 15% 30% 50%">
                    <Items>
                        ...
                        <f:Label ID="Label98" runat="server" Text="HSE文件审核数量"></f:Label>
                        <f:Label ID="Label99" runat="server" Text="五环公司及各分包商企业、人员资质核查的数量，同存档文件对应"></f:Label>
                        <f:NumberBox ID="txtNum32" runat="server" LabelAlign="Left" NoDecimal="true" NoNegative="true"></f:NumberBox>
                    </Items>
                </f:FormRow>
                <%--<f:FormRow ColumnWidths="5% 15% 30% 50%">
                <Items>
                   ...
                   <f:TextBox ID="txtContents33" runat="server" LabelAlign="Left" MaxLength="2000">
                    </f:TextBox>
                </Items>
            </f:FormRow> 
            <f:FormRow ColumnWidths="5% 15% 30% 50%">
                <Items>
                   ...
                   <f:NumberBox ID="txtNum33" runat="server" LabelAlign="Left"  NoDecimal="true" NoNegative="true"></f:NumberBox>
                </Items>
            </f:FormRow>
            <f:FormRow ColumnWidths="5% 15% 30% 50%">
                <Items>
                   ...
                   <f:NumberBox ID="txtNum34" runat="server" LabelAlign="Left"  NoDecimal="true" NoNegative="true"></f:NumberBox>
                </Items>
            </f:FormRow>--%>
                <f:FormRow ColumnWidths="5% 15% 30% 50%">
                    <Items>
                        <f:Label ID="Label109" runat="server" Text="四"></f:Label>
                        <f:Label ID="Label110" runat="server" Text="每周总结"></f:Label>
                ...
                <Items>
                   ...
                   <f:TextBox ID="txtContents43" runat="server" LabelAlign="Left" MaxLength="2000">
                    </f:TextBox>
                </Items>
            </f:FormRow>
            <f:FormRow ColumnWidths="5% 15% 30% 50%">
            ...
            <f:FormRow ColumnWidths="5% 15% 30% 50%">
                <Items>
                   ...
                   <f:TextBox ID="txtContents51" runat="server" LabelAlign="Left" MaxLength="2000">
                    </f:TextBox>
                </Items>
            </f:FormRow>
            <f:FormRow ColumnWidths="5% 15% 30% 50%">
                <Items>
                   ...
                   <f:TextBox ID="txtContents52" runat="server" LabelAlign="Left" MaxLength="2000">
                    </f:TextBox>
                </Items>
            </f:FormRow>--%>
            </Rows>
