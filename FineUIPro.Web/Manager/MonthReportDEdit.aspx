<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonthReportDEdit.aspx.cs"
    Inherits="FineUIPro.Web.Manager.MonthReportDEdit" %>
                                            ...
                                            <f:FormRow ColumnWidths="33% 33% 33%">
                                                <Items>
                                                    <f:NumberBox ID="txtPropertyLossMoney" NoDecimal="false" NoNegative="true" MinValue="0"
                                                        runat="server" Label="财产损失(万元)" LabelWidth="240px">
                                                    </f:NumberBox>
                                            ...
                                            <f:FormRow ColumnWidths="33% 33% 33%">
                                                <Items>
                                                    ...
                                                    <f:NumberBox ID="txtTrainPersonNum" NoDecimal="true" NoNegative="true" MinValue="0"
                                                        runat="server" Label="人员培训(人次)" LabelWidth="240px">
                                                    </f:NumberBox>
                                            ...
                                            <f:FormRow ColumnWidths="33% 33% 33%">
                                                <Items>
                                                    <f:NumberBox ID="txtPunishMoney" NoDecimal="false" NoNegative="true" MinValue="0"
                                                        runat="server" Label="罚款金额(元)" LabelWidth="240px">
                                                    </f:NumberBox>
                                                    <f:NumberBox ID="txtIncentiveMoney" NoDecimal="false" NoNegative="true" MinValue="0"
                                                        runat="server" Label="奖励金额(元)" LabelWidth="240px">
                                                    </f:NumberBox>
                                            ...
                                            <f:FormRow>
                                                <Items>
                                                    <f:NumberBox ID="txtEmergencyDrillNum" NoDecimal="true" NoNegative="true" MinValue="0"
                                                        runat="server" Label="应急演练次数(次)" LabelWidth="240px">
                                                    </f:NumberBox>
                                                    <f:NumberBox ID="txtParticipantsNum" NoDecimal="true" NoNegative="true" MinValue="0"
                                                        runat="server" Label="参演人次数(人次)" LabelWidth="240px">
                                                    </f:NumberBox>
                                                    <f:NumberBox ID="txtDrillInput" NoDecimal="false" NoNegative="true" MinValue="0"
                                                        runat="server" Label="演练直接投入(万元)" LabelWidth="240px">
                                                    </f:NumberBox>
                                                </Items>
                                            </f:FormRow>
                                            <f:FormRow>
                                                <Items>
                                                    <f:TextArea ID="txtDrillTypes" runat="server" MaxLength="500" Label="演练类型与方式" LabelWidth="120px">
                                                    </f:TextArea>
                                                </Items>
                                            </f:FormRow>
                                        </Rows>
                ...
                <Toolbars>
                    <f:Toolbar ID="Toolbar1" Position="Bottom" ToolbarAlign="Right" runat="server">
                        <Items>
                            ...
                            <f:Button ID="btnSubmit" Icon="SystemSaveNew" runat="server" ToolTip="提交" ValidateForms="form2"
