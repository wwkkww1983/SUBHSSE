    ...
    public partial class ManagerMonth_SeDinEdit : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                BLL.UserService.InitFlowOperateControlUserDropDownList(this.CompileManId, this.CurrUser.LoginProjectId, BLL.CommonService.GetIsThisUnitId(), false);
                BLL.UserService.InitFlowOperateControlUserDropDownList(this.AuditManId, this.CurrUser.LoginProjectId, BLL.CommonService.GetIsThisUnitId(), false);
                BLL.UserService.InitFlowOperateControlUserDropDownList(this.ApprovalManId, this.CurrUser.LoginProjectId, BLL.CommonService.GetIsThisUnitId(), false);
