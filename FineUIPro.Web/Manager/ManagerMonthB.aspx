<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagerMonthB.aspx.cs" Inherits="FineUIPro.Web.Manager.ManagerMonthB" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>施工现场HSE月报告</title>
    <style type="text/css">
        .labcenter
        {
            text-align: center;
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="施工现场HSE月报告" EnableCollapse="true"
                ...
                <Columns>
                    ...
                    <f:RenderField Width="150px" ColumnID="MonthReportCode" DataField="MonthReportCode"
                    ...
                    <f:RenderField Width="90px" ColumnID="ReportManName" DataField="ReportManName"
                    ...
                    <f:RenderField Width="120px" ColumnID="Manhours" DataField="Manhours"
                        SortField="Manhours" FieldType="String" HeaderText="当月完成人工时" TextAlign="Left"
                        HeaderTextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="120px" ColumnID="HseManhours" DataField="HseManhours"
                        SortField="HseManhours" FieldType="String" HeaderText="当月HSE人工时" TextAlign="Left"
                        HeaderTextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="120px" ColumnID="NoStartDate" DataField="NoStartDate" SortField="NoStartDate"
                        FieldType="Date" Renderer="Date" RendererArgument="yyyy-MM-dd" HeaderText="无事故开始日期"
                        HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="120px" ColumnID="NoEndDate" DataField="NoEndDate" SortField="NoEndDate"
                        FieldType="Date" Renderer="Date" RendererArgument="yyyy-MM-dd" HeaderText="无事故截止日期"
                        HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="120px" ColumnID="AccidentRateA" DataField="AccidentRateA"
                        SortField="AccidentRateA" FieldType="String" HeaderText="可记录事故率" TextAlign="Left"
                        HeaderTextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="120px" ColumnID="AccidentRateB" DataField="AccidentRateB"
                        SortField="AccidentRateB" FieldType="String" HeaderText="损失工时事故率" TextAlign="Left"
                        HeaderTextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="120px" ColumnID="AccidentRateC" DataField="AccidentRateC"
                        SortField="AccidentRateC" FieldType="String" HeaderText="事故伤害严重率" TextAlign="Left"
                        HeaderTextAlign="Center">
                    </f:RenderField>
                </Columns>
                <Listeners>
    ...
    <f:Window ID="Window1" Title="编辑管理月报" Hidden="true" EnableIFrame="true" EnableMaximize="true"
