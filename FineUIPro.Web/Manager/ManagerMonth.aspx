<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagerMonth.aspx.cs" Inherits="FineUIPro.Web.Manager.ManagerMonth" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="管理月报" EnableCollapse="true"
                ...
                <Columns>
                    ...
                    <f:RenderField Width="120px" ColumnID="MonthReportCode" DataField="MonthReportCode"
                        SortField="MonthReportCode" FieldType="String" HeaderText="月报编号" TextAlign="Left"
                        HeaderTextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="85px" ColumnID="ReportMonths" DataField="ReportMonths" SortField="ReportMonths"
                    ...
                    <f:RenderField Width="90px" ColumnID="ReportManName" DataField="ReportManName" 
                        SortField="ReportManName" FieldType="String" HeaderText="报告人" TextAlign="Left" HeaderTextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="150px" ColumnID="AllManhoursData" DataField="AllManhoursData" ExpandUnusedSpace="true"
                        SortField="AllManhoursData" FieldType="String" HeaderText="安全人工时" TextAlign="Left" HeaderTextAlign="Center">
                    </f:RenderField>
                </Columns>
                <Listeners>
