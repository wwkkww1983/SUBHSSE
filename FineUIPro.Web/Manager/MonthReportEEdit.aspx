<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonthReportEEdit.aspx.cs"
    Inherits="FineUIPro.Web.Manager.MonthReportEEdit" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>编辑海外工程项目月度HSSE统计表</title>
                        ...
                        <Items>
                            <f:Form ID="Form8" ShowBorder="false" ShowHeader="false" AutoScroll="true" BodyPadding="10px"
                                ...
                                <Rows>
                                    ...
                                    <f:FormRow>
                                        <Items>
                                            <f:TextBox runat="server" ID="txtCountryCities" Label="所在国别/城市">
                                            </f:TextBox>
                        ...
                        <Items>
                            <f:Form ID="Form9" ShowBorder="false" ShowHeader="false" AutoScroll="true" BodyPadding="10px"
                                ...
                                <Rows>
                                    <f:FormRow>
                                        <Items>
                                            <f:TextBox runat="server" ID="txtContractType" Label="合同类别">
                                            </f:TextBox>
                                            <f:NumberBox runat="server" ID="txtContractAmount" Label="合同额(万元)" NoDecimal="false"
                                ...
                                <Items>
                                    <f:Form ID="Form3" ShowBorder="false" ShowHeader="false" AutoScroll="true" BodyPadding="10px"
                                        ...
                                        <Rows>
                                            <f:FormRow>
                                                <Items>
                                                    <f:TextArea ID="txtThisMajorWork" runat="server" Height="100px">
                                                    </f:TextArea>
                                                </Items>
                                            </f:FormRow>
                                        </Rows>
                                ...
                                <Items>
                                    <f:Form ID="Form5" ShowBorder="false" ShowHeader="false" AutoScroll="true" BodyPadding="10px"
                                        ...
                                        <Rows>
                                            <f:FormRow>
                                                <Items>
                                                    <f:TextArea ID="txtNextMajorWork" runat="server" Height="100px">
                                                    </f:TextArea>
                                                </Items>
                                            </f:FormRow>
                                        </Rows>
                                ...
                                <Items>
                                    <f:Form ID="Form7" ShowBorder="false" ShowHeader="false" AutoScroll="true" BodyPadding="10px"
                                        ...
                                        <Rows>
                                            <f:FormRow>
                                                <Items>
                                                    <f:TextBox runat="server" ID="txtThisImageProgress" Label="本月形象进度">
                                                    </f:TextBox>
                                                    <f:TextBox runat="server" ID="txtYearImageProgress" Label="本年形象进度">
                                                    </f:TextBox>
                                                    <f:TextBox runat="server" ID="txtTotalImageProgress" Label="自开工累计形象进度" LabelWidth="150px">
                                                    </f:TextBox>
                                                </Items>
                                            </f:FormRow>
                                        </Rows>
                                        ...
                                        <Rows>
                                            <f:FormRow>
                                                <Items>
                                                    ...
                                                    <f:TextBox runat="server" ID="txtProjectManagerPhone" Label="电话">
                                                    </f:TextBox>
                                                </Items>
                                            </f:FormRow>
                                        </Rows>
                                ...
                                <Items>
                                    <f:Form ID="Form12" ShowBorder="false" ShowHeader="false" AutoScroll="true" BodyPadding="10px"
                                        ...
                                        <Rows>
                                            <f:FormRow>
                                                <Items>
                                                    <f:TextBox runat="server" ID="txtHSEManagerName" Label="姓名">
                                                    </f:TextBox>
                                                    <f:TextBox runat="server" ID="txtHSEManagerPhone" Label="电话">
                                                    </f:TextBox>
                                                </Items>
                                            </f:FormRow>
                                        </Rows>
