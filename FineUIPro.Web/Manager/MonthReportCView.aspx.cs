...
{
    public partial class MonthReportCView : PageBase
    {
        #region 定义项
        /// <summary>
        /// 月报告查主键
        ...
        private void BindLeftTree()
        {
            ...
            foreach (var item in items)
            {
                TreeNode newNode = new TreeNode
                {
                    ...
                    NavigateUrl = item.ConstValue.Replace("Edit", "View") + "?monthReportId=" + MonthReportId + "&months=" + months + "&startTime=" + startTime + "&endTime=" + endTime + "&yearStartTime=" + yearStartTime,
                    Target = "mainframe"
                };
        ...
        protected void btnAttachUrl_Click(object sender, EventArgs e)
        {
            ...
            {
                PageContext.RegisterStartupScript(WindowAtt.GetShowReference(String.Format("../AttachFile/webuploader.aspx?toKeyId={0}&path=FileUpload/ManagerMonthReport&menuId={1}&type=-1", this.MonthReportId, BLL.Const.ProjectManagerMonthCMenuId)));
            }
        }
        #endregion
