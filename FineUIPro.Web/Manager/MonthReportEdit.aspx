                        ...
                        <f:ContentPanel ID="ContentPanel7" BodyPadding="10" ShowBorder="true" EnableCollapse="true" CssClass="blockpanel myblockform" ShowHeader="true" Title="基本信息" runat="server">
                            <Items>
                                <f:Panel ID="Panel1" Layout="Block" CssClass="blockpanel myblockform" BlockMD="12" ShowHeader="false" ShowBorder="false"
                                    ...
                                    <Items>
                                        <f:DatePicker runat="server"  DateFormatString="yyyy-MM" Label="月报月份" EmptyText="请选择年月" Readonly="true" BlockMD="4"
                    ...
                    <Items>
                        <f:Panel ID="pan" Layout="Block" CssClass="blockpanel myblockform" BlockMD="12"
                            ...
                            <Items>
                                ...
                                <f:DatePicker runat="server"  BlockMD="3" LabelAlign="right" DateFormatString="yyyy-MM-dd" Label="工期时间"
                                    EmptyText="请选择开始日期"
                                    ID="pStartDate">
                                </f:DatePicker>
                    ...
                    <Items>
                        <f:ContentPanel ID="ContentPanel1" BodyPadding="10" ShowBorder="true" EnableCollapse="true" CssClass="blockpanel myblockform" ShowHeader="true" Title="项目安全工时统计" runat="server">
                            ...
                            <table style="width: unset; padding-left: 30px">
                                <tr>
                                    <td>
                                        <f:Label runat="server" Text="本项目自"></f:Label>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <f:Label runat="server" Text="安全生产"></f:Label>
                                    </td>
                                    <td>
                                        <f:TextBox ID="SafeWorkTime" runat="server" MaxLength="50">
                                        </f:TextBox>
                                    </td>
                                    <td>
                ...
                <f:FormRow>
                    <Items>
                        <f:ContentPanel ID="ContentPanel4" BodyPadding="10" ShowBorder="true" EnableCollapse="true" CssClass="blockpanel myblockform" ShowHeader="true" Title="本月大型、特种设备投入情况" runat="server">
                            <f:Grid ID="GvSeDinMonthReport5Item"  ShowBorder="true" AllowCellEditing="true" EnableColumnLines="true" ShowHeader="false" ForceFit="true" EnableCollapse="false" runat="server">
                                <Columns>
                                    <f:BoundField ColumnID="UnitName" DataField="UnitName" Width="80px" HeaderText="单位名称" />
...
<script type="text/javascript">
    ...
    function onGridAfterEdit(event, value, params) {
        ...
        var SafeManangerNum = me.getCellValue(rowId, 'SafeManangerNum') ? me.getCellValue(rowId, 'SafeManangerNum'):0;
        var OtherManangerNum = me.getCellValue(rowId, 'OtherManangerNum') ? me.getCellValue(rowId, 'OtherManangerNum'):0;
        var SpecialWorkerNum = me.getCellValue(rowId, 'SpecialWorkerNum') ? me.getCellValue(rowId, 'SpecialWorkerNum'):0;
        var GeneralWorkerNum = me.getCellValue(rowId, 'GeneralWorkerNum') ? me.getCellValue(rowId, 'GeneralWorkerNum'):0;
