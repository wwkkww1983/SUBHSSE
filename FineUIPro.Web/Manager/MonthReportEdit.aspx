<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonthReportEdit.aspx.cs"
    Inherits="FineUIPro.Web.Manager.MonthReportEdit" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            <f:FormRow ColumnWidths="20% 20% 20% 20% 15% 5%">
                <Items>
                    <f:TextBox ID="txtMonthReportCode" runat="server" Label="编号" Readonly="true" MaxLength="50">
                    </f:TextBox>
                    <f:DatePicker runat="server" Label="月报月份" ID="txtReportMonths" LabelWidth="100px" AutoPostBack="true"
                        OnTextChanged="txtReportMonths_TextChanged"
                        LabelAlign="right" DateFormatString="yyyy-MM" ShowRedStar="true" Required="true">
                    </f:DatePicker>
                    <f:DatePicker runat="server" Label="报告日期" ID="txtMonthReportStartDate" LabelAlign="right" LabelWidth="100px" ShowRedStar="true" Required="true">
                    </f:DatePicker>
                    <f:DatePicker runat="server" Label="至" ID="txtMonthReportDate" AutoPostBack="true"
                        OnTextChanged="TextBox_TextChanged" LabelAlign="right" LabelWidth="40px" ShowRedStar="true" Required="true">
                    </f:DatePicker>
                    <f:TextBox ID="txtReportMan" runat="server" Label="报告人" Readonly="true" LabelWidth="60px">
                    </f:TextBox>
                    <f:Button ID="btnArrowRefresh" Icon="ArrowRefresh" runat="server" ToolTip="刷新数据" 
                        OnClick="TextBox_TextChanged">
                    </f:Button>
                </Items>
            </f:FormRow>
            <f:FormRow>
                <Items>
                    <f:GroupPanel ID="GroupPanel2" Layout="Anchor" Title="项目总体数据统计" runat="server">
                        <Items>
                            <f:TextArea ID="txtAllProjectData" runat="server" Height="100px">
                            </f:TextArea>
                            <f:TextArea ID="txtAllManhoursData" runat="server" Height="50px">
                            </f:TextArea>
                        </Items>
                    </f:GroupPanel>
                </Items>
                ...
                <Items>
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="true" Title="教育与培训情况统计" runat="server"
                        ...
                        <Columns>
                            ...
                            <f:RenderField Width="180px" ColumnID="TrainNumber11" DataField="TrainNumber11" SortField="TrainNumber11"
                                FieldType="String" HeaderTextAlign="Center" TextAlign="Left" HeaderText="本月培训次数">
                            </f:RenderField>
                            <f:RenderField Width="180px" ColumnID="TrainNumber12" DataField="TrainNumber12" SortField="TrainNumber12"
                                FieldType="String" HeaderTextAlign="Center" TextAlign="Left" HeaderText="累计次数">
                            </f:RenderField>
                            <f:RenderField Width="180px" ColumnID="TrainNumber13" DataField="TrainNumber13" SortField="TrainNumber13"
                                FieldType="String" HeaderTextAlign="Center" TextAlign="Left" HeaderText="本月培训人数">
                            </f:RenderField>
                            <f:RenderField Width="180px" ColumnID="TrainNumber14" DataField="TrainNumber14" SortField="TrainNumber14"
                ...
                <Items>
                    <f:Grid ID="Grid2" ShowBorder="true" ShowHeader="true" Title="事故分类统计" runat="server"
                        ...
                        <Columns>
                            ...
                            <f:RenderField Width="250px" ColumnID="AccidentNumber01" DataField="AccidentNumber01"
                            ...
                            <f:RenderField Width="250px" ColumnID="AccidentNumber02" DataField="AccidentNumber02"
                            ...
                            <f:RenderField Width="1px" ColumnID="AccidentSortId" DataField="AccidentSortId" 
                                FieldType="String" HeaderText="主键"  Hidden="true" HeaderTextAlign="Center">                                        
                            </f:RenderField>
                            <f:RenderField Width="1px" ColumnID="AccidentTypeId" DataField="AccidentTypeId" 
                                FieldType="String" HeaderText="类型"  Hidden="true" HeaderTextAlign="Center">                                        
                            </f:RenderField>
                        </Columns>
                        <Listeners>
                                    ...
                                    <f:FormRow ColumnWidths="30% 5% 65%">
                                        <Items>
                                            <f:NumberBox ID="txtHseNumber01" NoDecimal="true" NoNegative="true" MinValue="0"
                                                runat="server" Label="本月现场施工车辆总共" LabelWidth="150px">
                                            </f:NumberBox>
                                    ...
                                    <f:FormRow ColumnWidths="30% 30% 5% 35%">
                                        <Items>
                                            <f:NumberBox ID="txtHseNumber02" NoDecimal="true" NoNegative="true" MinValue="0"
                                                runat="server" Label="本月施工机械设备" LabelWidth="125px">
                                            </f:NumberBox>
                                            <f:NumberBox ID="txtHseNumber03" NoDecimal="true" NoNegative="true" MinValue="0"
                                                runat="server" Label="台。其中特种设备" LabelWidth="125px">
                                            </f:NumberBox>
                                    ...
                                    <f:FormRow ColumnWidths="30% 30% 5% 35%">
                                        <Items>
                                            <f:NumberBox ID="txtHseNumber04" NoDecimal="true" NoNegative="true" MinValue="0"
                                                runat="server" Label="本月隐患整改总共" LabelWidth="125px">
                                            </f:NumberBox>
                                            <f:NumberBox ID="txtHseNumber05" NoDecimal="true" NoNegative="true" MinValue="0"
                                                runat="server" Label="项，已经整改完成" LabelWidth="125px">
                                            </f:NumberBox>
                                    ...
                                    <f:FormRow ColumnWidths="30% 30% 5% 35%">
                                        <Items>
                                            <f:NumberBox ID="txtHseNumber06" NoDecimal="true" NoNegative="true" MinValue="0"
                                                runat="server" Label="本月方案审批数量" LabelWidth="125px">
                                            </f:NumberBox>
                                            <f:NumberBox ID="txtSpecialNumber" NoDecimal="true" NoNegative="true" MinValue="0"
                                                runat="server" Label="。其中专项方案数量" LabelWidth="140px">
                                            </f:NumberBox>
                                    ...
                                    <f:FormRow>
                                        <Items>
                                            <f:NumberBox ID="txtHseNumber07" NoDecimal="true" NoNegative="true" MinValue="0"
                                                runat="server" Label="本月共计签发隐患整改单" LabelWidth="165px">
                                            </f:NumberBox>
                                    ...
                                    <f:FormRow>
                                        <Items>
                                            <f:NumberBox ID="txtHseNumber08" NoDecimal="true" NoNegative="true" MinValue="0"
                                                runat="server" Label="本月共计签发《隐患整改暂时停止作业令》" LabelWidth="270px">
                                            </f:NumberBox>
                                    ...
                                    <f:FormRow>
                                        <Items>
                                            <f:NumberBox ID="txtHseNumber09" NoDecimal="true" NoNegative="true" MinValue="0"
                                                runat="server" Label="本月共计办理作业许可证" LabelWidth="165px">
                                            </f:NumberBox>
                                    ...
                                    <f:FormRow>
                                        <Items>
                                            <f:NumberBox ID="txtHseNumber00" NoDecimal="true" NoNegative="true" MinValue="0"
                                                runat="server" Label="本月共计签发处罚单" LabelWidth="140px">
                                            </f:NumberBox>
                                    ...
                                    <f:FormRow>
                                        <Items>
                                            <f:NumberBox ID="txtHseNumber10" NoDecimal="false" NoNegative="true" MinValue="0"
                                                runat="server" Label="入场安全培训率（现场参加培训人数与现场全部作业人数的比值）" LabelWidth="400px">
                                            </f:NumberBox>
                                    ...
                                    <f:FormRow>
                                        <Items>
                                            <f:NumberBox ID="txtHseNumber11" NoDecimal="false" NoNegative="true" MinValue="0"
                                                runat="server" Label="机械设备检验率（已检机械设备数量与全部在用机械设备数量的比值）" LabelWidth="425px">
                                            </f:NumberBox>
            ...
            <f:FormRow>
                <Items>
                    <f:GroupPanel ID="GroupPanel4" Layout="Anchor" Title="机具设备投入情况" runat="server">
                        <Items>
                            <f:TextArea ID="txtEquipmentQualityData" runat="server" Height="100px">
                            </f:TextArea>
                        </Items>
                    </f:GroupPanel>
                </Items>
            ...
            <f:FormRow>
                <Items>
                    <f:GroupPanel ID="GroupPanel6" Layout="Anchor" Title="本月监控重点及措施（风险辨识及控制，职业健康及环境卫生等）"
                        runat="server">
                        <Items>
                            <f:TextArea ID="txtThisMonthKeyPoints" runat="server" Height="100px">
                            </f:TextArea>
                        </Items>
                    </f:GroupPanel>
                </Items>
            ...
            <f:FormRow>
                <Items>
                    <f:GroupPanel ID="GroupPanel7" Layout="Anchor" Title="本月主要安全活动" runat="server">
                        <Items>
                            <f:TextArea ID="txtThisMonthSafetyActivity" runat="server" Height="100px">
                            </f:TextArea>
                        </Items>
                    </f:GroupPanel>
                </Items>
            ...
            <f:FormRow>
                <Items>
                    <f:GroupPanel ID="GroupPanel8" Layout="Anchor" Title="下月工作重点" runat="server">
                        <Items>
                            <f:TextArea ID="txtNextMonthWorkFocus" runat="server" Height="100px">
                            </f:TextArea>
                        </Items>
                    </f:GroupPanel>
                </Items>
