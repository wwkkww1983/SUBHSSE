<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompletionReport.aspx.cs" Inherits="FineUIPro.Web.Manager.CompletionReport" %>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="完工报告" EnableCollapse="true"
                runat="server" BoxFlex="1" EnableColumnLines="true" DataKeyNames="CompletionReportId"
                AllowCellEditing="true" ClicksToEdit="2" DataIDField="CompletionReportId" AllowSorting="true"
                SortField="CompletionReportCode" SortDirection="DESC" OnSort="Grid1_Sort" AllowPaging="true"
                IsDatabasePaging="true" PageSize="10" OnPageIndexChange="Grid1_PageIndexChange"
                EnableRowDoubleClickEvent="true" OnRowDoubleClick="Grid1_RowDoubleClick" EnableTextSelection="True">
                <Toolbars>
                    <f:Toolbar ID="Toolbar2" Position="Top" runat="server" ToolbarAlign="Left">
                        <Items>
                            <f:TextBox runat="server" Label="完工报告编号" ID="txtCompletionReportCode" EmptyText="输入查询条件"
                                AutoPostBack="true" OnTextChanged="TextBox_TextChanged" Width="250px" LabelWidth="100px"
                                LabelAlign="right">
                            </f:TextBox>
                            <f:TextBox runat="server" Label="完工报告名称" ID="txtCompletionReportName" EmptyText="输入查询条件"
                                AutoPostBack="true" OnTextChanged="TextBox_TextChanged" Width="250px" LabelWidth="100px"
                                LabelAlign="right">
                            </f:TextBox>
                ...
                <Columns>
                    ...
                    <f:RenderField Width="220px" ColumnID="CompletionReportCode" DataField="CompletionReportCode"
                        SortField="CompletionReportCode" FieldType="String" HeaderText="完工报告编号" HeaderTextAlign="Center"
                        TextAlign="Left">
                    </f:RenderField>
                    <f:RenderField Width="250px" ColumnID="CompletionReportName" DataField="CompletionReportName"
                        SortField="CompletionReportName" FieldType="String" HeaderText="完工报告名称" HeaderTextAlign="Center"
                        TextAlign="Left">
                    </f:RenderField>
