<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinalFileList.aspx.cs" Inherits="FineUIPro.Web.FinalFileManage.FinalFileList" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="监理管理文档" EnableCollapse="true"
                ...
                <Columns>
                    ...
                    <f:WindowField TextAlign="Left" Width="60px" WindowID="WindowAtt" Text="附件" ToolTip="附件上传查看" 
                        DataIFrameUrlFields="FileId" DataIFrameUrlFormatString="../AttachFile/webuploader.aspx?toKeyId={0}&path=FileUpload/FinalFileListAttachUrl&menuId=719DA0D3-FA59-4A03-B6E0-6663A211956F"
    ...
    <f:Window ID="Window1" Title="监理管理文档" Hidden="true" EnableIFrame="true" EnableMaximize="true"
