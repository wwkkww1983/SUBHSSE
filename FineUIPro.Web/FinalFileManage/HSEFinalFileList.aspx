<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HSEFinalFileList.aspx.cs" Inherits="FineUIPro.Web.FinalFileManage.HSEFinalFileList" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="已定稿文件" EnableCollapse="true"
                ...
                <Columns>
                    ...
                    <f:WindowField TextAlign="Left" Width="60px" WindowID="WindowAtt" Text="附件" ToolTip="附件上传查看" 
                        DataIFrameUrlFields="FileId" DataIFrameUrlFormatString="../AttachFile/webuploader.aspx?toKeyId={0}&path=FileUpload/HSEFinalFileListAttachUrl&menuId=24D6B764-7B91-46EB-9D80-A6073FC5720D"
    ...
    <f:Window ID="Window1" Title="已定稿文件" Hidden="true" EnableIFrame="true" EnableMaximize="true"
