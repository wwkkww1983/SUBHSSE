...
{
    public partial class HSEFinalFileListView : PageBase
    {
        #region 定义项
        /// <summary>
        /// 主键
            ...
            {               
                ...
                if (!string.IsNullOrEmpty(this.FileId))
                {
                    ...
                    if (HSEFinalFileList != null)
                    {
                        ...
                        this.drpCompileMan.Text = BLL.UserService.GetUserNameByUserId(HSEFinalFileList.CompileMan);
        ...
        protected void btnAttachUrl_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(this.FileId))
            {
                PageContext.RegisterStartupScript(WindowAtt.GetShowReference(String.Format("../AttachFile/webuploader.aspx?toKeyId={0}&path=FileUpload/HSEFinalFileListAttachUrl&menuId={1}&type=-1", FileId, BLL.Const.HSEFinalFileListMenuId)));
            }            
        }
        #endregion
    }
