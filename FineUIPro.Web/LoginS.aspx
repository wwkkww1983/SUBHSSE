<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="LoginS.aspx.cs" Inherits="FineUIPro.Web.LoginS"  Async="true" AsyncTimeout="360000" %>
                ...
                <Items>                  
                        ...
                        <Items>   
                          <f:SimpleForm ID="SimpleForm1" BoxFlex="1" runat="server" ShowBorder="false" BodyPadding="10px"  LabelAlign="Right"
                                ...
                                <Items>     
                                    <f:TextBox ID="tbxUserName" Required="true" ShowRedStar="true" runat="server"  Label="用户名" FocusOnPageLoad="true"
                                         Margin="0px 60px 0 960px" NextFocusControl="tbxPassword"   ShowLabel="true"  >
                                    </f:TextBox>
