<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClassMeeting.aspx.cs" Inherits="FineUIPro.Web.Meeting.ClassMeeting" %>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="班前会" EnableCollapse="true"
                ...
                AllowCellEditing="true" ClicksToEdit="2" DataIDField="ClassMeetingId" AllowSorting="true"
                ...
                <Toolbars>
                    <f:Toolbar ID="Toolbar2" Position="Top" runat="server" ToolbarAlign="Left">
                        <Items>
                            <f:TextBox runat="server" Label="会议编号" ID="txtClassMeetingCode" EmptyText="输入查询条件"
                            ...
                            <f:TextBox runat="server" Label="会议名称" ID="txtClassMeetingName" EmptyText="输入查询条件"
                                AutoPostBack="true" OnTextChanged="TextBox_TextChanged" Width="250px" LabelWidth="80px"
                                LabelAlign="right">
                            </f:TextBox>
                ...
                <Columns>
                    ...
                    <f:RenderField Width="140px" ColumnID="ClassMeetingCode" DataField="ClassMeetingCode"
                        SortField="ClassMeetingCode" FieldType="String" HeaderText="会议编号" HeaderTextAlign="Center"
                        TextAlign="Left">
                    </f:RenderField>
                    <f:RenderField Width="150px" ColumnID="ClassMeetingName" DataField="ClassMeetingName"
                        SortField="ClassMeetingName" FieldType="String" HeaderText="会议名称" HeaderTextAlign="Center"
                        TextAlign="Left">
                    </f:RenderField>
                    ...
                    <f:WindowField TextAlign="Left" Width="160px" WindowID="WindowAtt" HeaderText="附件"
                        Text="上传查看" ToolTip="附件上传查看" DataIFrameUrlFields="ClassMeetingId" DataIFrameUrlFormatString="../AttachFile/webuploader.aspx?toKeyId={0}&path=FileUpload/ClassMeetingAttachUrl&menuId=F8ADCDBC-AAAD-4884-9935-2B63562E4779"
