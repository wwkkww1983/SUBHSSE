<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AttendMeeting.aspx.cs"
    Inherits="FineUIPro.Web.Meeting.AttendMeeting" %>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="其他会议记录" EnableCollapse="true"
                ...
                AllowCellEditing="true" ClicksToEdit="2" DataIDField="AttendMeetingId" AllowSorting="true"
                ...
                <Toolbars>
                    <f:Toolbar ID="Toolbar2" Position="Top" runat="server" ToolbarAlign="Left">
                        <Items>
                            <f:TextBox runat="server" Label="会议编号" ID="txtAttendMeetingCode" EmptyText="输入查询条件"
                            ...
                            <f:TextBox runat="server" Label="会议名称" ID="txtAttendMeetingName" EmptyText="输入查询条件"
                                AutoPostBack="true" OnTextChanged="TextBox_TextChanged" Width="250px" LabelWidth="80px"
                                LabelAlign="right">
                            </f:TextBox>
                ...
                <Columns>
                    ...
                    <f:RenderField Width="140px" ColumnID="AttendMeetingCode" DataField="AttendMeetingCode"
                        SortField="AttendMeetingCode" FieldType="String" HeaderText="会议编号" HeaderTextAlign="Center"
                        TextAlign="Left">
                    </f:RenderField>
                    <f:RenderField Width="180px" ColumnID="AttendMeetingName" DataField="AttendMeetingName"
                        SortField="AttendMeetingName" FieldType="String" HeaderText="会议名称" HeaderTextAlign="Center"
                        TextAlign="Left">
                    </f:RenderField>
                    ...
                    <f:RenderField Width="150px" ColumnID="AttendMeetingDate" DataField="AttendMeetingDate"
                    ...
                    <f:WindowField TextAlign="Left" Width="160px" WindowID="WindowAtt" HeaderText="附件"
                        Text="上传查看" ToolTip="附件上传查看" DataIFrameUrlFields="AttendMeetingId" DataIFrameUrlFormatString="../AttachFile/webuploader.aspx?toKeyId={0}&path=FileUpload/AttendMeetingAttachUrl&menuId=B2DA78EF-EECA-4AF4-9FAC-ECCFF1D6E459"
