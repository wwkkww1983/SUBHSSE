<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpecialMeetingView.aspx.cs"
    Inherits="FineUIPro.Web.Meeting.SpecialMeetingView" %>
        ...
        <Rows>
            <f:FormRow>
                <Items>
                    ...
                    <f:TextBox ID="txtSpecialMeetingName" runat="server" Label="会议名称" LabelAlign="Right"
                        Readonly="true">
                    </f:TextBox>
                    <f:TextBox ID="txtSpecialMeetingDate" runat="server" Label="会议日期" LabelAlign="Right"
                        Readonly="true">
                    </f:TextBox>
                </Items>
            </f:FormRow>
