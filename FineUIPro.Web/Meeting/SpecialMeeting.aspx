<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpecialMeeting.aspx.cs" Inherits="FineUIPro.Web.Meeting.SpecialMeeting" %>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="安全专题会议" EnableCollapse="true"
                ...
                AllowCellEditing="true" ClicksToEdit="2" DataIDField="SpecialMeetingId" AllowSorting="true"
                ...
                <Toolbars>
                    <f:Toolbar ID="Toolbar2" Position="Top" runat="server" ToolbarAlign="Left">
                        <Items>
                            <f:TextBox runat="server" Label="会议编号" ID="txtSpecialMeetingCode" EmptyText="输入查询条件"
                            ...
                            <f:TextBox runat="server" Label="会议名称" ID="txtSpecialMeetingName" EmptyText="输入查询条件"
                                AutoPostBack="true" OnTextChanged="TextBox_TextChanged" Width="250px" LabelWidth="80px"
                                LabelAlign="right">
                            </f:TextBox>
                ...
                <Columns>
                    ...
                    <f:RenderField Width="100px" ColumnID="SpecialMeetingCode" DataField="SpecialMeetingCode"
                        SortField="SpecialMeetingCode" FieldType="String" HeaderText="会议编号" HeaderTextAlign="Center"
                        TextAlign="Left">
                    </f:RenderField>
                    <f:RenderField Width="100px" ColumnID="SpecialMeetingName" DataField="SpecialMeetingName"
                        SortField="SpecialMeetingName" FieldType="String" HeaderText="会议名称" HeaderTextAlign="Center"
                        TextAlign="Left">
                    </f:RenderField>
                 ...
                 <%--   <f:RenderField Width="90px" ColumnID="AttentPerson" DataField="AttentPerson"
                    ...
                    <f:WindowField TextAlign="Left" Width="160px" WindowID="WindowAtt" HeaderText="附件"
                        Text="上传查看" ToolTip="附件上传查看" DataIFrameUrlFields="SpecialMeetingId" DataIFrameUrlFormatString="../AttachFile/webuploader.aspx?toKeyId={0}&path=FileUpload/SpecialMeetingAttachUrl&menuId=BB6CEC48-283B-46AD-BEDD-F964D261698F"
