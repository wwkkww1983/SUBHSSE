<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnitViolationStatistics.aspx.cs" Inherits="FineUIPro.Web.HiddenInspection.UnitViolationStatistics" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>单位违章统计明细表</title>
    <style>
    ...
    <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server" Margin="5px">
        <Regions>
            ...
            <f:Region ID="Region2" ShowBorder="false" ShowHeader="false" Position="Center" Layout="VBox"
                ...
                <Items>
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="单位违章统计明细表" EnableCollapse="true"
