<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubUnitRateStatistics.aspx.cs" Inherits="FineUIPro.Web.HiddenInspection.SubUnitRateStatistics" %>
...
<body>
    ...
    <f:Panel ID="Panel3" CssClass="blockpanel" runat="server" Height="200px" EnableCollapse="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="分包商占比统计" EnableCollapse="true"
