<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnvironmentalEmergencyPlan.aspx.cs" Inherits="FineUIPro.Web.Environmental.EnvironmentalEmergencyPlan" %>

<!DOCTYPE html>
<html>
<head id="Head1" runat="server">
    <title>环境事件应急预案</title>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="环境事件应急预案" EnableCollapse="true"
                ...
                <Columns>
                    ...
                    <f:RenderField Width="380px" ColumnID="ProjectName" DataField="ProjectName" ExpandUnusedSpace="true"
    ...
    <f:Window ID="Window1" Title="环境事件应急预案" Hidden="true" EnableIFrame="true" EnableMaximize="true"
