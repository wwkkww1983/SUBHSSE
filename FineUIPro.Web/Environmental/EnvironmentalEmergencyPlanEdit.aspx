<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnvironmentalEmergencyPlanEdit.aspx.cs"
    Inherits="FineUIPro.Web.Environmental.EnvironmentalEmergencyPlanEdit" ValidateRequest="false" %>
<%@ Register Src="~/Controls/FlowOperateControl.ascx" TagName="FlowOperateControl" TagPrefix="uc1" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>编辑环境事件应急预案</title>
    <link href="../res/css/common.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <form id="form1" runat="server">
    <f:PageManager ID="PageManager1" runat="server" />
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" Title="环境事件应急预案" AutoScroll="true"
