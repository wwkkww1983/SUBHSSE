<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EIAReport.aspx.cs" Inherits="FineUIPro.Web.Environmental.EIAReport" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="环评报告" EnableCollapse="true"
    ...
    <f:Window ID="Window1" Title="环评报告" Hidden="true" EnableIFrame="true" EnableMaximize="true"
