<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PictureType.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.PictureType" %>
...
<body>
   ...
   <f:PageManager ID="PageManager1" AutoSizePanelID="Panel1" runat="server" />
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" Title="项目图片分类" Layout="HBox" ShowHeader="false">
        <Items>
            <f:Grid ID="Grid1" Title="项目图片分类" ShowHeader="false" EnableCollapse="true" PageSize="10"  EnableColumnLines="true"
                ShowBorder="true" AllowPaging="true" IsDatabasePaging="true" runat="server" Width="760px"
                DataKeyNames="PictureTypeId" DataIDField="PictureTypeId" OnPageIndexChange="Grid1_PageIndexChange"
