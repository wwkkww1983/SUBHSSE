<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkStage.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.WorkStage" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" Title="工作阶段" Layout="HBox"
        ShowHeader="false">
        <Items>
            <f:Grid ID="Grid1" Title="工作阶段" ShowHeader="false" EnableCollapse="true" PageSize="10"
                EnableColumnLines="true" ShowBorder="true" AllowPaging="true" IsDatabasePaging="true"
                runat="server" Width="760px" DataKeyNames="WorkStageId" DataIDField="WorkStageId"
            ...
            <f:SimpleForm ID="SimpleForm1" runat="server" ShowBorder="true" ShowHeader="false"
                ...
                <Items>
                    ...
                    <f:TextBox ID="txtWorkStageName" Label="名称" ShowRedStar="true" Required="true"
                        runat="server" LabelAlign="right" AutoPostBack="true" OnTextChanged="TextBox_TextChanged">
                    </f:TextBox>
    ...
    <script type="text/javascript">
        ...
        var txtCodeClientID = '<%= txtWorkStageCode.ClientID %>';
        var txtNameClientID = '<%= txtWorkStageName.ClientID %>';
        ...
        function onGridRowSelect(event, rowId) {
            ...
            F(txtCodeClientID).setValue(rowValue['WorkStageCode']);
            F(txtNameClientID).setValue(rowValue['WorkStageName']);
            F(txtRemarkClientID).setValue(rowValue['Remarks']);
