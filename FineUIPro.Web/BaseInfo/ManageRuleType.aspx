<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageRuleType.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.ManageRuleType" %>
...
<body>
   ...
   <f:PageManager ID="PageManager1" AutoSizePanelID="Panel1" runat="server" />
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" Title="管理规定分类"  ShowHeader="false"
        Layout="HBox">
        <Items>
            <f:Grid ID="Grid1" Title="管理规定分类" ShowHeader="false" EnableCollapse="true" PageSize="10" EnableColumnLines="true"
                ShowBorder="true" AllowPaging="true" IsDatabasePaging="true" runat="server" Width="760px"
                DataKeyNames="ManageRuleTypeId" DataIDField="ManageRuleTypeId" OnPageIndexChange="Grid1_PageIndexChange" AllowFilters="true" OnFilterChange="Grid1_FilterChange" EnableTextSelection="True">
                <Columns>
                    <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center" TextAlign="Center"/>
                    <f:RenderField Width="150px" ColumnID="ManageRuleTypeCode" DataField="ManageRuleTypeCode" FieldType="String"
                        HeaderText="编号" HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="200px" ColumnID="ManageRuleTypeName" DataField="ManageRuleTypeName" FieldType="String"
            ...
            <f:SimpleForm ID="SimpleForm1" runat="server" ShowBorder="true" ShowHeader="false"
                ...
                <Items>
                    ...
                    <f:TextBox ID="txtManageRuleTypeName" Label="名称" ShowRedStar="true" Required="true" runat="server"  MaxLength="50"
                        LabelAlign="right" AutoPostBack="true" OnTextChanged="TextBox_TextChanged">
                    </f:TextBox>
    ...
    <script type="text/javascript">
        ...
        var txtCodeClientID = '<%= txtManageRuleTypeCode.ClientID %>';
        var txtNameClientID = '<%= txtManageRuleTypeName.ClientID %>';
        ...
        function onGridRowSelect(event, rowId) {
            ...
            F(txtCodeClientID).setValue(rowValue['ManageRuleTypeCode']);
            F(txtNameClientID).setValue(rowValue['ManageRuleTypeName']);
