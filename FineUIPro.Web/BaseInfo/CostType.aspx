<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CostType.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.CostType" %>
            ...
            <f:Grid ID="Grid1" Title="费用类型" ShowHeader="false" EnableCollapse="true" PageSize="10"  EnableColumnLines="true"
                ...
                <Columns>
                   <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center" TextAlign="Center"/>
                    <f:RenderField Width="150px" ColumnID="CostTypeCode" DataField="CostTypeCode" FieldType="String"
                        HeaderText="编号" HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="200px" ColumnID="CostTypeName" DataField="CostTypeName" FieldType="String"
