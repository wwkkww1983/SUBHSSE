<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RulesRegulationsType.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.RulesRegulationsType" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>政府部门安全规章类别</title>
    <link href="../res/css/common.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <form id="form1" runat="server">
   <f:PageManager ID="PageManager1" AutoSizePanelID="Panel1" runat="server" />
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" Title="政府部门安全规章类别"  ShowHeader="false"
        Layout="HBox">
        <Items>
            <f:Grid ID="Grid1" Title="政府部门安全规章类别" ShowHeader="false" EnableCollapse="true" PageSize="10"
                ShowBorder="true" AllowPaging="true" IsDatabasePaging="true" runat="server" Width="760px" EnableColumnLines="true"
                DataKeyNames="RulesRegulationsTypeId" DataIDField="RulesRegulationsTypeId" OnPageIndexChange="Grid1_PageIndexChange"  AllowFilters="true" OnFilterChange="Grid1_FilterChange" EnableTextSelection="True">
                <Columns>
                    <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center" TextAlign="Center"/>
                    <f:RenderField Width="150px" ColumnID="RulesRegulationsTypeCode" DataField="RulesRegulationsTypeCode" FieldType="String"  
                        HeaderText="编号" HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="200px" ColumnID="RulesRegulationsTypeName" DataField="RulesRegulationsTypeName" FieldType="String"
            ...
            <f:SimpleForm ID="SimpleForm1" runat="server" ShowBorder="true" ShowHeader="false"
                ...
                <Items>
                    ...
                    <f:TextBox ID="txtRulesRegulationsTypeName" Label="名称" ShowRedStar="true" Required="true" runat="server" MaxLength="50"
                        LabelAlign="right" AutoPostBack="true" OnTextChanged="TextBox_TextChanged">
                    </f:TextBox>
                    <f:TextArea ID="txtRemark" runat="server" Label="备注" MaxLength="500" LabelAlign="right">
                    </f:TextArea>
                </Items>
                <Toolbars>
    ...
    <script type="text/javascript">
        ...
        var txtCodeClientID = '<%= txtRulesRegulationsTypeCode.ClientID %>';
        var txtNameClientID = '<%= txtRulesRegulationsTypeName.ClientID %>';
        ...
        function onGridRowSelect(event, rowId) {
            ...
            F(txtCodeClientID).setValue(rowValue['RulesRegulationsTypeCode']);
            F(txtNameClientID).setValue(rowValue['RulesRegulationsTypeName']);
