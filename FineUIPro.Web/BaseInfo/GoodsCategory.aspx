<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsCategory.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.GoodsCategory" %>
...
<body>
  ...
  <f:PageManager ID="PageManager1" AutoSizePanelID="Panel1" runat="server" />
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" Title="物资类别" Layout="HBox"  ShowHeader="false">
        <Items>
            <f:Grid ID="Grid1" Title="物资类别" ShowHeader="false" EnableCollapse="true" PageSize="10"  EnableColumnLines="true"
                ShowBorder="true" AllowPaging="true" IsDatabasePaging="true" runat="server" Width="760px"
                DataKeyNames="GoodsCategoryId" DataIDField="GoodsCategoryId" OnPageIndexChange="Grid1_PageIndexChange"
                AllowFilters="true" OnFilterChange="Grid1_FilterChange" EnableTextSelection="True">
                <Columns>
                   <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center" TextAlign="Center"/>
                    <f:RenderField Width="150px" ColumnID="GoodsCategoryCode" DataField="GoodsCategoryCode" FieldType="String"
                        HeaderText="编号" HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="200px" ColumnID="GoodsCategoryName" DataField="GoodsCategoryName" FieldType="String"
            ...
            <f:SimpleForm ID="SimpleForm1" runat="server" ShowBorder="true" ShowHeader="false"
                ...
                <Items>
                    ...
                    <f:TextBox ID="txtGoodsCategoryName" Label="类型" ShowRedStar="true" Required="true" runat="server"
    ...
    <script type="text/javascript">
        ...
        var txtCodeClientID = '<%= txtGoodsCategoryCode.ClientID %>';
        var txtNameClientID = '<%= txtGoodsCategoryName.ClientID %>';
        ...
        function onGridRowSelect(event, rowId) {
            ...
            F(txtCodeClientID).setValue(rowValue['GoodsCategoryCode']);
            F(txtNameClientID).setValue(rowValue['GoodsCategoryName']);
