<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SolutionTempleteType.aspx.cs"
    Inherits="FineUIPro.Web.BaseInfo.SolutionTempleteType" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" Title="施工方案类型"
        ShowHeader="false" Layout="HBox">
        <Items>
            <f:Grid ID="Grid1" Title="施工方案类型" ShowHeader="false" EnableCollapse="true" PageSize="10"
                EnableColumnLines="true" ShowBorder="true" AllowPaging="true" IsDatabasePaging="true"
                runat="server" Width="760px" DataKeyNames="SolutionTempleteTypeCode" DataIDField="SolutionTempleteTypeCode"
    ...
    <script type="text/javascript">
        ...
        var txtCodeClientID = '<%= txtSolutionTempleteTypeCode.ClientID %>';
        var txtNameClientID = '<%= txtSolutionTempleteTypeName.ClientID %>';
        ...
        function onGridRowSelect(event, rowId) {
            ...
            F(txtCodeClientID).setValue(rowValue['SolutionTempleteTypeCode']);
            F(txtNameClientID).setValue(rowValue['SolutionTempleteTypeName']);
