<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViolationSort.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.ViolationSort" %>
...
<body>
   ...
   <f:PageManager ID="PageManager1" AutoSizePanelID="Panel1" runat="server" />
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" Title="违章种类" Layout="HBox"  ShowHeader="false">
        <Items>
            <f:Grid ID="Grid1" Title="违章种类" ShowHeader="false" EnableCollapse="true" PageSize="10"  EnableColumnLines="true"
                ShowBorder="true" AllowPaging="true" IsDatabasePaging="true" runat="server" Width="760px"
                DataKeyNames="ViolationSortId" DataIDField="ViolationSortId" OnPageIndexChange="Grid1_PageIndexChange"
                AllowFilters="true" OnFilterChange="Grid1_FilterChange" EnableTextSelection="True">
                <Columns>
                   <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center" TextAlign="Center"/>
                    <f:RenderField Width="150px" ColumnID="ViolationSortCode" DataField="ViolationSortCode" FieldType="String"
                        HeaderText="种类编号" HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="200px" ColumnID="ViolationSortName" DataField="ViolationSortName" FieldType="String"
                        HeaderText="种类名称" HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
            ...
            <f:SimpleForm ID="SimpleForm1" runat="server" ShowBorder="true" ShowHeader="false"
                ...
                <Items>
                    ...
                    <f:TextBox ID="txtViolationSortCode" Label="种类编号" ShowRedStar="true" Required="true" runat="server"
                        LabelAlign="right" AutoPostBack="true" OnTextChanged="TextBox_TextChanged">
                    </f:TextBox>
                    <f:TextBox ID="txtViolationSortName" Label="种类名称" ShowRedStar="true" Required="true" runat="server"
                        LabelAlign="right" AutoPostBack="true" OnTextChanged="TextBox_TextChanged">
                    </f:TextBox>
    ...
    <script type="text/javascript">
        ...
        var txtCodeClientID = '<%= txtViolationSortCode.ClientID %>';
        var txtNameClientID = '<%= txtViolationSortName.ClientID %>';
        ...
        function onGridRowSelect(event, rowId) {
            ...
            F(txtCodeClientID).setValue(rowValue['ViolationSortCode']);
            F(txtNameClientID).setValue(rowValue['ViolationSortName']);
