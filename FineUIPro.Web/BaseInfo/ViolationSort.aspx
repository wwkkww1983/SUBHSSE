        ...
        <Items>
                ...
                <Columns>
                   <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center" TextAlign="Center"/>
                    ...
                    <f:RenderField Width="200px" ColumnID="ViolationSortName" DataField="ViolationSortName" FieldType="String"
                        HeaderText="种类名称" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
            ...
            <f:SimpleForm ID="SimpleForm1" runat="server" ShowBorder="true" ShowHeader="false"
                ...
                <Items>
                    ...
                    <f:TextBox ID="txtViolationSortCode" Label="编号" ShowRedStar="true" Required="true" runat="server"
                        LabelAlign="right" AutoPostBack="true" OnTextChanged="TextBox_TextChanged">
                    </f:TextBox>
                    <f:TextBox ID="txtViolationSortName" Label="名称" ShowRedStar="true" Required="true" runat="server"
                        LabelAlign="right" AutoPostBack="true" OnTextChanged="TextBox_TextChanged">
                    </f:TextBox>
