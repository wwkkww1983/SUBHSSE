<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainLevel.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.TrainLevel" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" Title="培训级别信息" Layout="HBox"  ShowHeader="false">
        <Items>
            <f:Grid ID="Grid1" Title="培训级别信息" ShowHeader="false" EnableCollapse="true" PageSize="10"
                ShowBorder="true" AllowPaging="true" IsDatabasePaging="true" runat="server" Width="760px" EnableColumnLines="true"
                DataKeyNames="TrainLevelId" DataIDField="TrainLevelId" OnPageIndexChange="Grid1_PageIndexChange"
                AllowFilters="true" OnFilterChange="Grid1_FilterChange" EnableTextSelection="True">
                <Columns>
                    <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center"
                        TextAlign="Center" />
                    <f:RenderField Width="150px" ColumnID="TrainLevelCode" DataField="TrainLevelCode" FieldType="String"
                        HeaderText="级别编号" HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="200px" ColumnID="TrainLevelName" DataField="TrainLevelName" FieldType="String"
                        HeaderText="级别名称" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
    ...
    <script type="text/javascript">
        ...
        var txtCodeClientID = '<%= txtTrainLevelCode.ClientID %>';
        var txtNameClientID = '<%= txtTrainLevelName.ClientID %>';
        ...
        function onGridRowSelect(event, rowId) {
            ...
            F(txtCodeClientID).setValue(rowValue['TrainLevelCode']);
            F(txtNameClientID).setValue(rowValue['TrainLevelName']);
