<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExpertType.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.ExpertType" %>
...
<body>
   ...
   <f:PageManager ID="PageManager1" AutoSizePanelID="Panel1" runat="server" />
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" Title="专家类别"  ShowHeader="false"
        Layout="HBox">
        <Items> 
            <f:Grid ID="Grid1" Title="专家类别" ShowHeader="false" EnableCollapse="true" PageSize="10"  EnableColumnLines="true"
                ShowBorder="true" AllowPaging="true" IsDatabasePaging="true" runat="server" Width="760px"
                DataKeyNames="ExpertTypeId" DataIDField="ExpertTypeId" OnPageIndexChange="Grid1_PageIndexChange"  AllowFilters="true" OnFilterChange="Grid1_FilterChange" EnableTextSelection="True">
                <Columns>
                    ...
                    <f:RenderField  ColumnID="ExpertTypeCode" DataField="ExpertTypeCode" FieldType="String"
                        HeaderText="类别编号" HeaderTextAlign="Center" TextAlign="Center" Width="150px">
                    </f:RenderField>
                    <f:RenderField  ColumnID="ExpertTypeName" DataField="ExpertTypeName" FieldType="String"
                        HeaderText="类别名称" HeaderTextAlign="Center" TextAlign="Center" Width="200px">
                    </f:RenderField>
            ...
            <f:SimpleForm ID="SimpleForm1" runat="server" ShowBorder="true" ShowHeader="false"
                ...
                <Items>
                    ...
                    <f:TextBox ID="txtExpertTypeCode" Label="类别编号" ShowRedStar="true" Required="true" runat="server"  MaxLength="50"
                        LabelAlign="right" AutoPostBack="true" OnTextChanged="TextBox_TextChanged">
                    </f:TextBox>
                    <f:TextBox ID="txtExpertTypeName" Label="类别名称" ShowRedStar="true" Required="true" runat="server"  MaxLength="1000"
                        LabelAlign="right" AutoPostBack="true" OnTextChanged="TextBox_TextChanged">
                    </f:TextBox>
    ...
    <script type="text/javascript">
        ...
        var txtCodeClientID = '<%= txtExpertTypeCode.ClientID %>';
        var txtNameClientID = '<%= txtExpertTypeName.ClientID %>';
        ...
        function onGridRowSelect(event, rowId) {
            ...
            F(txtCodeClientID).setValue(rowValue['ExpertTypeCode']);
            F(txtNameClientID).setValue(rowValue['ExpertTypeName']);
