<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpecialSchemeType.aspx.cs"
    Inherits="FineUIPro.Web.BaseInfo.SpecialSchemeType" %>
                ...
                <Columns>
                   <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center" TextAlign="Center"/>
                    <f:RenderField Width="150px" ColumnID="SpecialSchemeTypeCode" DataField="SpecialSchemeTypeCode"
                        FieldType="String" HeaderText="类别编号" HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="200px" ColumnID="SpecialSchemeTypeName" DataField="SpecialSchemeTypeName"
                        FieldType="String" HeaderText="类别名称" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
