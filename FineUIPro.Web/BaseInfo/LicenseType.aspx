<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LicenseType.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.LicenseType" ValidateRequest="false" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" Title="许可证类型" ShowHeader="false"
        Layout="HBox">
        <Items>
            <f:Grid ID="Grid1" Title="许可证类型" ShowHeader="true" EnableCollapse="false" PageSize="10"   EnableColumnLines="true"  
                ...
                <Columns>                    
                    <f:RenderField Width="60px" ColumnID="LicenseTypeCode" DataField="LicenseTypeCode"
                        FieldType="String" HeaderText="编号" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
                    <f:RenderField Width="220px" ColumnID="LicenseTypeName" DataField="LicenseTypeName"
            ...
            <f:SimpleForm ID="SimpleForm1" runat="server" ShowBorder="true" ShowHeader="false"
                LabelWidth="60px" BodyPadding="5px" Width="650px">
                <Items>
                    ...
                    <f:TextBox ID="txtLicenseTypeName" Label="名称" ShowRedStar="true" Required="true"
                        runat="server" LabelAlign="right" AutoPostBack="true" OnTextChanged="TextBox_TextChanged">
                    </f:TextBox>
                    <f:TextBox ID="txtRemark" runat="server" Label="备注" LabelAlign="right"></f:TextBox>
                    <f:HtmlEditor runat="server" Label="模板" ID="txtLicenseContents" ShowLabel="false" 
                        Editor="UMEditor" BasePath="~/res/umeditor/" ToolbarSet="Basic" Height="400" LabelAlign="Right">
                    </f:HtmlEditor>
                </Items>
                <Toolbars>
    ...
    <script type="text/javascript">
        ...
        var txtCodeClientID = '<%= txtLicenseTypeCode.ClientID %>';
        var txtNameClientID = '<%= txtLicenseTypeName.ClientID %>';
        var txtRemarkClientID = '<%=txtRemark.ClientID %>';
        var txtLicenseContentsClientID = '<%=txtLicenseContents.ClientID %>';
        ...
        function onGridRowSelect(event, rowId) {
            ...
            F(txtCodeClientID).setValue(rowValue['LicenseTypeCode']);
            F(txtNameClientID).setValue(rowValue['LicenseTypeName']);
            F(txtRemarkClientID).setValue(rowValue['Remark']);
            //F(txtLicenseContentsClientID).setValue(rowValue['LicenseContents']);
