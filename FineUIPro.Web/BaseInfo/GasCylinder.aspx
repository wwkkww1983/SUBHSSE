<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GasCylinder.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.GasCylinder" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" Title="气瓶类型" Layout="HBox"  ShowHeader="false">
        <Items>
            <f:Grid ID="Grid1" Title="气瓶类型" ShowHeader="false" EnableCollapse="true" PageSize="10"  EnableColumnLines="true"
                ShowBorder="true" AllowPaging="true" IsDatabasePaging="true" runat="server" Width="760px"
                DataKeyNames="GasCylinderId" DataIDField="GasCylinderId" OnPageIndexChange="Grid1_PageIndexChange"
                AllowFilters="true" OnFilterChange="Grid1_FilterChange" EnableTextSelection="True">
                <Columns>
                    <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center"
                        TextAlign="Center" />
                    <f:RenderField Width="150px" ColumnID="GasCylinderCode" DataField="GasCylinderCode"
                        FieldType="String" HeaderText="类型编号" HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="200px" ColumnID="GasCylinderName" DataField="GasCylinderName"
                        FieldType="String" HeaderText="类型名称" HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
            ...
            <f:SimpleForm ID="SimpleForm1" runat="server" ShowBorder="true" ShowHeader="false"
                ...
                <Items>
                    ...
                    <f:TextBox ID="txtGasCylinderCode" Label="类型编号" ShowRedStar="true" Required="true"
                        runat="server" LabelAlign="right" AutoPostBack="true" OnTextChanged="TextBox_TextChanged">
                    </f:TextBox>
                    <f:TextBox ID="txtGasCylinderName" Label="类型名称" ShowRedStar="true" Required="true"
                        runat="server" LabelAlign="right" AutoPostBack="true" OnTextChanged="TextBox_TextChanged">
                    </f:TextBox>
    ...
    <script type="text/javascript">
        ...
        var txtCodeClientID = '<%= txtGasCylinderCode.ClientID %>';
        var txtNameClientID = '<%= txtGasCylinderName.ClientID %>';
        ...
        function onGridRowSelect(event, rowId) {
            ...
            F(txtCodeClientID).setValue(rowValue['GasCylinderCode']);
            F(txtNameClientID).setValue(rowValue['GasCylinderName']);
