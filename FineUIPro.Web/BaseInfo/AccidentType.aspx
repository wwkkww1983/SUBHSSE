<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccidentType.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.AccidentType" %>
...
<body>
   ...
   <f:PageManager ID="PageManager1" AutoSizePanelID="Panel1" runat="server" />
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" Title="事故类型" Layout="HBox" ShowHeader="false">
        <Items>
            <f:Grid ID="Grid1" Title="事故类型" ShowHeader="false" EnableCollapse="true" PageSize="10"  EnableColumnLines="true"
                ShowBorder="true" AllowPaging="true" IsDatabasePaging="true" runat="server" Width="760px"
                DataKeyNames="AccidentTypeId" DataIDField="AccidentTypeId" OnPageIndexChange="Grid1_PageIndexChange"
                AllowFilters="true" OnFilterChange="Grid1_FilterChange" EnableTextSelection="True">
                <Columns>
                   <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center" TextAlign="Center"/>
                    <f:RenderField Width="150px" ColumnID="AccidentTypeCode" DataField="AccidentTypeCode" FieldType="String"
                        HeaderText="类型编号" HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="200px" ColumnID="AccidentTypeName" DataField="AccidentTypeName" FieldType="String"
            ...
            <f:SimpleForm ID="SimpleForm1" runat="server" ShowBorder="true" ShowHeader="false"
                ...
                <Items>
                    ...
                    <f:TextBox ID="txtAccidentTypeCode" Label="类型编号" ShowRedStar="true" Required="true" runat="server"
                        LabelAlign="right" AutoPostBack="true" OnTextChanged="TextBox_TextChanged">
                    </f:TextBox>
                    <f:TextBox ID="txtAccidentTypeName" Label="类型名称" ShowRedStar="true" Required="true" runat="server"
                        LabelAlign="right" AutoPostBack="true" OnTextChanged="TextBox_TextChanged">
                    </f:TextBox>
    ...
    <script type="text/javascript">
        ...
        var txtCodeClientID = '<%= txtAccidentTypeCode.ClientID %>';
        var txtNameClientID = '<%= txtAccidentTypeName.ClientID %>';
        ...
        function onGridRowSelect(event, rowId) {
            ...
            F(txtCodeClientID).setValue(rowValue['AccidentTypeCode']);
            F(txtNameClientID).setValue(rowValue['AccidentTypeName']);
