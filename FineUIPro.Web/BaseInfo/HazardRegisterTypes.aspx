...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="true" Title="安全巡检类型" EnableCollapse="true"
                runat="server" BoxFlex="1" DataKeyNames="RegisterTypesId" AllowCellEditing="true" ClicksToEdit="2"
                DataIDField="RegisterTypesId" AllowSorting="true" SortField="TypeCode" SortDirection="ASC"
                ...
                <Columns>
                   ...
                   <f:RenderField Width="250px" ColumnID="TypeCode" DataField="TypeCode" SortField="TypeCode"
                        FieldType="String" HeaderText="编号" HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="250px" ColumnID="RegisterTypesName" DataField="RegisterTypesName" SortField="RegisterTypesName"
                    ...
                    <f:CheckBoxField Width="100px" RenderAsStaticField="true" TextAlign="Center"  DataField="IsPunished" HeaderText="是否处罚" /> 
                </Columns>
                <Listeners>
