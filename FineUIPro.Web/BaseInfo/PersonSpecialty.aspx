<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonSpecialty.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.PersonSpecialty" %>
...
<body>
   ...
   <f:PageManager ID="PageManager1" AutoSizePanelID="Panel1" runat="server" />
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" Title="专业信息"  ShowHeader="false"
        Layout="HBox">
        <Items>
            <f:Grid ID="Grid1" Title="专业信息" ShowHeader="false" EnableCollapse="true" PageSize="10"  EnableColumnLines="true"
                ShowBorder="true" AllowPaging="true" IsDatabasePaging="true" runat="server" Width="760px"
                DataKeyNames="PersonSpecialtyId" DataIDField="PersonSpecialtyId" OnPageIndexChange="Grid1_PageIndexChange" AllowFilters="true" OnFilterChange="Grid1_FilterChange" EnableTextSelection="True">
                <Columns>
                    ...
                    <f:RenderField  ColumnID="PersonSpecialtyCode" DataField="PersonSpecialtyCode" FieldType="String"
    ...
    <script type="text/javascript">
        ...
        var txtCodeClientID = '<%= txtPersonSpecialtyCode.ClientID %>';
        var txtNameClientID = '<%= txtPersonSpecialtyName.ClientID %>';
        ...
        function onGridRowSelect(event, rowId) {
            ...
            F(txtCodeClientID).setValue(rowValue['PersonSpecialtyCode']);
            F(txtNameClientID).setValue(rowValue['PersonSpecialtyName']);
