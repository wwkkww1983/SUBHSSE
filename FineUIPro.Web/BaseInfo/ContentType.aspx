<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContentType.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.ContentType" %>
...
<body>
   ...
   <f:PageManager ID="PageManager1" AutoSizePanelID="Panel1" runat="server" />
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" Title="交流类型"  ShowHeader="false"
        Layout="HBox">
        <Items>
            <f:Grid ID="Grid1" Title="交流话题类型" ShowHeader="false" EnableCollapse="true" PageSize="10"
                ShowBorder="true" AllowPaging="true" IsDatabasePaging="true" runat="server" Width="760px" EnableColumnLines="true"
                DataKeyNames="ContentTypeId" DataIDField="ContentTypeId" OnPageIndexChange="Grid1_PageIndexChange"  AllowFilters="true" OnFilterChange="Grid1_FilterChange" EnableTextSelection="True">
                <Columns>
                    <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center" TextAlign="Center"/>
                    <f:RenderField Width="200px" ColumnID="ContentTypeCode" DataField="ContentTypeCode" FieldType="String"
                        HeaderText="类型编号" HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="350px" ColumnID="ContentTypeName" DataField="ContentTypeName" FieldType="String"
                        HeaderText="类型名称" HeaderTextAlign="Center" TextAlign="Left" ExpandUnusedSpace="true">
                    </f:RenderField>
                </Columns>
                <Listeners>
    ...
    <script type="text/javascript">
        ...
        var txtCodeClientID = '<%= txtContentTypeCode.ClientID %>';
        var txtNameClientID = '<%= txtContentTypeName.ClientID %>';
        ...
        function onGridRowSelect(event, rowId) {
            ...
            F(txtCodeClientID).setValue(rowValue['ContentTypeCode']);
            F(txtNameClientID).setValue(rowValue['ContentTypeName']);
