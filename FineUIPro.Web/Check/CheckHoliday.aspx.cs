...
{
    public partial class CheckHoliday : PageBase
    {
        /// <summary>
        /// 项目id
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ////权限按钮方法
                this.GetButtonPower();
                btnNew.OnClientClick = Window1.GetShowReference("CheckHolidayEdit.aspx") + "return false;";  
        ...
        protected void btnMenuModify_Click(object sender, EventArgs e)
        {
            ...
            string CheckHolidayId = Grid1.SelectedRowID;
            var checkHoliday = BLL.Check_CheckHolidayService.GetCheckHolidayByCheckHolidayId(CheckHolidayId);
            if (checkHoliday != null)
            {
                if (this.btnMenuModify.Hidden || checkHoliday.States == BLL.Const.State_2)   ////双击事件 编辑权限有：编辑页面，无：查看页面 或者状态是完成时查看页面
                {
                    PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("CheckHolidayView.aspx?CheckHolidayId={0}", CheckHolidayId, "查看 - ")));
                }
                else
                {
                    PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("CheckHolidayEdit.aspx?CheckHolidayId={0}", CheckHolidayId, "编辑 - ")));
                }
            }
        }
        #endregion
        ...
        protected void btnCompletedDate_Click(object sender, EventArgs e)
        {
            ...
            var checkHoliday = BLL.Check_CheckHolidayService.GetCheckHolidayByCheckHolidayId(Grid1.SelectedRowID);
            if (checkHoliday != null && checkHoliday.States == BLL.Const.State_2)
            {
        ...
        private void GetButtonPower()
        {
            ...
            var buttonList = BLL.CommonService.GetAllButtonList(this.ProjectId, this.CurrUser.UserId, BLL.Const.ProjectCheckHolidayMenuId);
        ...
        protected void btnOut_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + System.Web.HttpUtility.UrlEncode("季节性/节假日检查" + filename, System.Text.Encoding.UTF8) + ".xls");
