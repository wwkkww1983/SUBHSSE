<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckColligationWHPrint.aspx.cs" Inherits="FineUIPro.Web.Check.CheckColligationWHPrint" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>打印综合检查（五环）</title>
                ...
                <table id="Table11" runat="server" width="100%" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td align="left" style="width: 33%; height: 45px;">
                            <asp:Label ID="Label4" runat="server" Font-Size="17px" Text="检查类型：HSE综合检查"></asp:Label>
                        </td>
                        <td align="left" style="width: 33%; height: 45px;">
