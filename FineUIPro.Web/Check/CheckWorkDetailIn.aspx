<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckWorkDetailIn.aspx.cs" Inherits="FineUIPro.Web.Check.CheckWorkDetailIn" %>
            ...
            <f:FormRow>
                <Items>
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" EnableCollapse="true" runat="server"
                        EnableColumnLines="true" BoxFlex="1" DataKeyNames="CheckWorkDetailId" AllowCellEditing="true"
                        ClicksToEdit="2" DataIDField="CheckWorkDetailId" AllowSorting="true" SortField="CheckItemStr"
