<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckDayWHEdit.aspx.cs"
    ValidateRequest="false" Inherits="FineUIPro.Web.Check.CheckDayWHEdit" %>
        ...
        <Rows>
            <f:FormRow>
                <Items>
                    ...
                    <f:DropDownList ID="drpWeather" runat="server" Label="天气">
                    </f:DropDownList>
                </Items>
            </f:FormRow>
            <f:FormRow>
                <Items>
                    <f:DropDownList ID="drpCheckPerson" runat="server" Label="检查人" LabelAlign="Right"
                        EnableEdit="true">
                    </f:DropDownList>
            ...
            <f:FormRow>
                <Items>
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" runat="server" ClicksToEdit="1"
                        ...
                        ShowGridHeader="true" Height="400px" EnableColumnLines="true" EnableRowDoubleClickEvent="true"
                        OnRowDoubleClick="Grid1_RowDoubleClick" OnRowCommand="Grid1_RowCommand">
                        <Toolbars>
                            <f:Toolbar ID="Toolbar2" Position="Top" runat="server" ToolbarAlign="Right">
                                <Items>
                                    <f:Label ID="Label1" runat="server" CssClass="fontred" Label="说明" Text="双击编辑检查项"
                        ...
                        <Columns>
                            ...
                            <f:RenderField Width="250px" ColumnID="Suggestions" DataField="Suggestions" SortField="Suggestions"
                                FieldType="String" HeaderTextAlign="Center" TextAlign="Left" HeaderText="整改要求">
                            </f:RenderField>
                            <f:TemplateField Width="100px" HeaderText="处理措施" HeaderTextAlign="Center" TextAlign="Left">
                                <ItemTemplate>
