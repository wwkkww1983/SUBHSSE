namespace FineUIPro.Web.Check
{
    ...
    public partial class CheckSpecialDetailIn : PageBase
    {
        ...
        /// 导入集合
        /// </summary>
        public static List<Model.View_Check_CheckSpecialDetail> viewDetails = new List<Model.View_Check_CheckSpecialDetail>();
        ...
        {
            if (Session["CheckSpecialDetails"] != null)
            {
                viewDetails = Session["CheckSpecialDetails"] as List<Model.View_Check_CheckSpecialDetail>;
            }
            if (viewDetails.Count > 0)
            {
                this.Grid1.Hidden = false;
        ...
        protected void PageManager1_CustomEvent(object sender, CustomEventArgs e)
        {
            ...
            {
                string rootPath = Server.MapPath("~/");
                string filePath = Const.CheckSpecialTemplateUrl;
