<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RectifyNoticeEdit.aspx.cs"
    ValidateRequest="false" Inherits="FineUIPro.Web.Check.RectifyNoticeEdit" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>编辑隐患整改通知单</title>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            ...
            <f:FormRow>
                <Items>                  
                    <f:DropDownList ID="drpSignPerson" runat="server" Label="签发人" ShowRedStar="true"
                        Required="true" LabelAlign="Right" EnableEdit="true">
                    </f:DropDownList>
            ...
            <f:FormRow>
                <Items>
                    <f:DropDownList ID="drpIsRectify" runat="server" Label="本单位检查是否完成整改" EnableEdit="true" Hidden="true">
                        <f:ListItem Value="True" Text="是" />
                        <f:ListItem Value="False" Text="否" />
                    </f:DropDownList>
                    <f:DropDownList ID="drpCheckPerson" runat="server" Label="本单位检查人" EnableEdit="true" Hidden="true">
                    </f:DropDownList>
                </Items>
            </f:FormRow>
        </Rows>
