<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckDayWH.aspx.cs" Inherits="FineUIPro.Web.Check.CheckDayWH" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="日常巡检（五环）" EnableCollapse="true"
