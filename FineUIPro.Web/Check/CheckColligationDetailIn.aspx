<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckColligationDetailIn.aspx.cs" Inherits="FineUIPro.Web.Check.CheckColligationDetailIn" %>
            ...
            <f:FormRow>
                <Items>
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" EnableCollapse="true" runat="server"
                        EnableColumnLines="true" BoxFlex="1" DataKeyNames="CheckColligationDetailId" AllowCellEditing="true"
                        ClicksToEdit="2" DataIDField="CheckColligationDetailId" AllowSorting="true" SortField="CheckItemStr"
