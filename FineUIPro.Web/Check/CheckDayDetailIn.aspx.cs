namespace FineUIPro.Web.Check
{
    ...
    public partial class CheckDayDetailIn : PageBase
    {
        #region 定义变量
        /// <summary>
        /// 上传预设的虚拟路径
        ...
        /// 导入集合
        /// </summary>
        public static List<Model.View_Check_CheckDayDetail> viewDetails = new List<Model.View_Check_CheckDayDetail>();
        ...
        {
            if (Session["CheckDayDetails"] != null)
            {
                viewDetails = Session["CheckDayDetails"] as List<Model.View_Check_CheckDayDetail>;
            }
            if (viewDetails.Count > 0)
            {
                this.Grid1.Hidden = false;
        ...
        protected void PageManager1_CustomEvent(object sender, CustomEventArgs e)
        {
            ...
            {
                string rootPath = Server.MapPath("~/");
                string filePath = Const.CheckDayTemplateUrl;
