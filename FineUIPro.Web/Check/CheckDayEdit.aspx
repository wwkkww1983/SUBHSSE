<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckDayEdit.aspx.cs" ValidateRequest="false"
    Inherits="FineUIPro.Web.Check.CheckDayEdit" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            ...
            <f:FormRow>
                <Items>
                     <f:DropDownList ID="drpCheckPerson" runat="server" Label="检查人" LabelAlign="Right" EnableEdit="true">
                    </f:DropDownList>
