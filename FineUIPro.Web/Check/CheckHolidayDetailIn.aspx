<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckHolidayDetailIn.aspx.cs" Inherits="FineUIPro.Web.Check.CheckHolidayDetailIn" %>
            ...
            <f:FormRow>
                <Items>
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" EnableCollapse="true" runat="server"
                        EnableColumnLines="true" BoxFlex="1" DataKeyNames="CheckHolidayDetailId" AllowCellEditing="true"
                        ClicksToEdit="2" DataIDField="CheckHolidayDetailId" AllowSorting="true" SortField="CheckItemStr"
