<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckWorkView.aspx.cs" Inherits="FineUIPro.Web.Check.CheckWorkView" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            ...
            <f:FormRow>
                <Items>
                    <f:TextBox ID="txtArea" runat="server" Label="被检查单位、区域或部位" MaxLength="200" Readonly="true" LabelWidth="180">
                    </f:TextBox>
                </Items>
            </f:FormRow>
            <f:FormRow>
