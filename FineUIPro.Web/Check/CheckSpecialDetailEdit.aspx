<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckSpecialDetailEdit.aspx.cs" Inherits="FineUIPro.Web.Check.CheckSpecialDetailEdit" %>
        ...
        <Rows>
            ...
            <f:FormRow ColumnWidths="35% 15% 50%">
                <Items>
                    ...
                    <f:DropDownList ID="drpUnit" runat="server" Label="责任单位" ShowLabel="true" Required="true">
                    </f:DropDownList>
                </Items>
            </f:FormRow>
            <f:FormRow>
