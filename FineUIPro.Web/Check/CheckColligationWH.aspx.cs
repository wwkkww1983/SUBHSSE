...
{
    public partial class CheckColligationWH : PageBase
    {
        #region 定义项
        /// <summary>
        /// 项目id
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ////权限按钮方法
                this.GetButtonPower();
                btnNew.OnClientClick = Window1.GetShowReference("CheckColligationWHEdit.aspx") + "return false;";
        ...
        protected void btnMenuModify_Click(object sender, EventArgs e)
        {
            ...
            if (checkColligation != null)
            {
                ...
                {
                    PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("CheckColligationWHView.aspx?CheckColligationId={0}", CheckColligationId, "查看 - ")));
                }
                else
                {
                    PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("CheckColligationWHEdit.aspx?CheckColligationId={0}", CheckColligationId, "编辑 - ")));
                }
            }
        }
        #endregion
        ...
        protected void btnMenuDel_Click(object sender, EventArgs e)
        {
            if (Grid1.SelectedRowIndexArray.Length > 0)
            {
                foreach (int rowIndex in Grid1.SelectedRowIndexArray)
                {
                    ...
                    if (getV != null)
                    {
                        BLL.LogService.AddSys_Log(this.CurrUser, getV.CheckColligationCode, getV.CheckColligationId, BLL.Const.ProjectCheckColligationWHMenuId, BLL.Const.BtnDelete);
        ...
        private void GetButtonPower()
        {
            ...
            var buttonList = BLL.CommonService.GetAllButtonList(this.ProjectId, this.CurrUser.UserId, BLL.Const.ProjectCheckColligationWHMenuId);
        ...
        protected void btnOut_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + System.Web.HttpUtility.UrlEncode("综合检查（五环）" + filename, System.Text.Encoding.UTF8) + ".xls");
...
#pragma warning disable CS0108 // “CheckColligationWH.GetGridTableHtml(Grid)”隐藏继承的成员“PageBase.GetGridTableHtml(Grid)”。如果是有意隐藏，请使用关键字 new。
        /// <summary>
        /// 导出方法
        /// </summary>
...
#pragma warning restore CS0108 // “CheckColligationWH.GetGridTableHtml(Grid)”隐藏继承的成员“PageBase.GetGridTableHtml(Grid)”。如果是有意隐藏，请使用关键字 new。
        {
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("CheckColligationWHPrint.aspx?CheckColligationId={0}", Grid1.SelectedRowID.Split(',')[0], "打印 - ")));
        }
        #endregion
    }
}