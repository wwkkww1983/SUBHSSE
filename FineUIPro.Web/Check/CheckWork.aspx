<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckWork.aspx.cs" Inherits="FineUIPro.Web.Check.CheckWork" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="开工前检查" EnableCollapse="true"
                runat="server" BoxFlex="1" DataKeyNames="CheckWorkId" AllowCellEditing="true"
                ClicksToEdit="2" DataIDField="CheckWorkId" AllowSorting="true" SortField="CheckTime"
                ...
                <Toolbars>
                    <f:Toolbar ID="Toolbar2" Position="Top" runat="server" ToolbarAlign="Left">
                        <Items>
                            ...
                            <f:TextBox runat="server" Label="编号" ID="txtCheckWorkCode" EmptyText="输入查询条件"
                ...
                <Columns>
                   <f:TemplateField ColumnID="tfPageIndex" Width="50px" HeaderText="序号" HeaderTextAlign="Center" TextAlign="Center"
                    ...
                    <f:RenderField Width="150px" ColumnID="CheckWorkCode" DataField="CheckWorkCode"
                        SortField="CheckWorkCode" FieldType="String" HeaderText="检查编号" TextAlign="Left"
                        HeaderTextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="400px" ColumnID="Area" DataField="Area" ExpandUnusedSpace="true"
                    ...
                    <f:CheckBoxField ID="cbfIs" Width="90px" RenderAsStaticField="true" TextAlign="Center"  DataField="IsAgree" HeaderText="同意开工" />
