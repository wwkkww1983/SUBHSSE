<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckDayDetailIn.aspx.cs" Inherits="FineUIPro.Web.Check.CheckDayDetailIn" %>
            ...
            <f:FormRow>
                <Items>
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" EnableCollapse="true" runat="server"
                        EnableColumnLines="true" BoxFlex="1" DataKeyNames="CheckDayDetailId" AllowCellEditing="true"
                        ClicksToEdit="2" DataIDField="CheckDayDetailId" AllowSorting="true" SortField="CheckItemStr"
