...
namespace FineUIPro.Web.Check
{
    public partial class RectifyNotice : PageBase
    {
        ...
        {
            string strSql = @"SELECT RectifyNotices.RectifyNoticesId,"
                          + @"RectifyNotices.ProjectId,"
                          + @"CodeRecords.Code AS RectifyNoticesCode,"
                          + @"RectifyNotices.UnitId,"
                          + @"RectifyNotices.WorkAreaId,"
                          + @"RectifyNotices.CheckedDate,"
                          + @"RectifyNotices.WrongContent,"
                          + @"RectifyNotices.SignPerson,"
                          + @"RectifyNotices.SignDate,"
                          + @"RectifyNotices.CompleteStatus,"
                          + @"RectifyNotices.DutyPerson,"
                          + @"RectifyNotices.CompleteDate,"
                          + @"RectifyNotices.IsRectify,"
                          + @"RectifyNotices.CheckPerson,"
                          + @"RectifyNotices.AttachUrl,"
                          + @"Unit.UnitName,"
