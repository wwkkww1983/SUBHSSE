...
{
    public partial class CheckSpecialAnalysis : PageBase
    {
        #region 定义项
        /// <summary>
        /// 项目主键
        ...
        {
            string strSql = @"select pd.CheckContent as '检查项',count(*) as '数量' from dbo.Check_CheckSpecialDetail d
                                left join dbo.Check_CheckSpecial c on c.CheckSpecialId=d.CheckSpecialId
            ...
            this.ChartCostTime.CreateChart(BLL.ChartControlService.GetDataSourceChart(tb, "专项检查分析", this.drpChartType.SelectedValue, 1150, 450, this.ckbShow.Checked));
        }
        #endregion
