...
{
    public partial class CheckHolidayAnalysis : PageBase
    {
        #region 定义项
        /// <summary>
        /// 项目主键
        ...
        {
            string strSql = @"select pd.CheckContent as '检查项',count(*) as '数量' from dbo.Check_CheckHolidayDetail d
                                left join dbo.Check_CheckHoliday c on c.CheckHolidayId=d.CheckHolidayId
            ...
            this.ChartCostTime.CreateChart(BLL.ChartControlService.GetDataSourceChart(tb, "季节性/节假日检查分析", this.drpChartType.SelectedValue, 1150, 450, this.ckbShow.Checked));
        }
        #endregion
