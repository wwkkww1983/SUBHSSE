...
{
    public partial class CheckWorkAnalysis : PageBase
    {
        #region 定义项
        /// <summary>
        /// 项目主键
        ...
        {
            string strSql = @"select pd.CheckContent as '检查项',count(*) as '数量' from dbo.Check_CheckWorkDetail d
                                left join dbo.Check_CheckWork c on c.CheckWorkId=d.CheckWorkId
            ...
            this.ChartCostTime.CreateChart(BLL.ChartControlService.GetDataSourceChart(tb, "开工前检查分析", this.drpChartType.SelectedValue, 1150, 450, this.ckbShow.Checked));
        }
        #endregion
