...
{
    public partial class CheckColligationAnalysis : PageBase
    {
        #region 定义项
        /// <summary>
        /// 项目主键
        ...
        {
            string strSql = @"select pd.CheckContent as '检查项',count(*) as '数量' from dbo.Check_CheckColligationDetail d
                                left join dbo.Check_CheckColligation c on c.CheckColligationId=d.CheckColligationId
            ...
            this.ChartCostTime.CreateChart(BLL.ChartControlService.GetDataSourceChart(tb, "综合检查分析", this.drpChartType.SelectedValue, 1150, 450, this.ckbShow.Checked));
        }
        #endregion
