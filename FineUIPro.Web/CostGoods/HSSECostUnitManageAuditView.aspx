<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HSSECostUnitManageAuditView.aspx.cs" Inherits="FineUIPro.Web.CostGoods.HSSECostUnitManageAuditView"
             ...
             <f:FormRow>
                <Items>
                    ...
                    <f:Label runat="server" ID="Label1" Text="费用（万元）">
                     ...
                     <f:Label runat="server" ID="Label22" Text="查看费用">
                    </f:Label>
                    <f:Label runat="server" ID="Label3" Text="费用明细">
                    </f:Label>
                    <f:Label runat="server" ID="Label23" Text="查看状态">
                    </f:Label>
                </Items>
            </f:FormRow>
            <f:FormRow >
