<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HSSECostManageEdit.aspx.cs" Inherits="FineUIPro.Web.CostGoods.HSSECostManageEdit" %>
    ...
    <f:Panel ID="Panel1" runat="server" ShowBorder="false" ShowHeader="false" Layout="Region">
        <Items>
             <f:Panel runat="server" ID="panel2" RegionPosition="Top" RegionSplit="true"  ShowHeader="false"
                EnableCollapse="true"  AutoScroll="true" BodyPadding="5px" Layout="VBox" Height="560px">                 
                <Items>                    
                    <f:Form ID="Form3" ShowBorder="false" ShowHeader="false" AutoScroll="true"
                                         ...
                                         <f:FormRow>
                                           <Items>
                                                <f:DropDownList ID="drpYear" runat="server" Label="月份" Required="true"
                                                    ShowRedStar="true" LabelWidth="100px" Readonly="true">
                                                </f:DropDownList>
                                                <f:DropDownList ID="drpMonths" runat="server" Required="true" ShowRedStar="true" Readonly="true">
                                                </f:DropDownList>  
                                                <f:TextBox ID="txtCode" runat="server" Label="编号" LabelWidth="100px" Readonly="true">
                                                </f:TextBox>
                                                <f:DatePicker ID="txtReportDate" runat="server" Label="填报日期" LabelWidth="100px" >
                                                </f:DatePicker>                       
                                            </Items>
                                        </f:FormRow>
                                  </Rows>
                                    ...
                                    ShowHeader="false" BodyPadding="1px">
                                        ...
                                        <f:Panel ID="Panel13" runat="server" BodyPadding="1px"  ShowBorder="false"
                                         ...
                                         <f:Panel ID="Panel11" runat="server" BodyPadding="1px" Width="300px"  ShowBorder="false"
                                            ...
                                            <Items>
                                                <f:Label runat="server" ID="Label41" Text="备注"  MarginLeft="100px">
                                                </f:Label>
                                            </Items>
                                        </f:Panel>
                                        <f:Panel ID="Panel14"  runat="server" BodyPadding="1px"  ShowBorder="false"
                                            ...
                                            <Items>
                                                <f:Label runat="server" ID="Label44" Text="当期"  MarginLeft="100px">
                                                </f:Label>
                                            </Items>
                                        </f:Panel>                                     
                                        <f:Panel ID="Panel16"  runat="server" BodyPadding="1px"  ShowBorder="false"
                                            Width="300px" ShowHeader="false" Height="30px">
                                            <Items>
                                                <f:Label runat="server" ID="Label46" Text="项目累计"  MarginLeft="100px">
                                                </f:Label>
                                            </Items>
                                        </f:Panel>
                                        </Items>
                            ...
                            <f:FormRow>
                                <Items>
                                    ...
                                    <f:NumberBox ID="txtMainIncome" runat="server"  LabelWidth="0" Width="300px" DecimalPrecision="4"
                                        AutoPostBack="true" OnTextChanged="Text_TextChanged">
                                    </f:NumberBox>                                   
                                    <f:NumberBox ID="txtProjectMainIncome" runat="server" LabelWidth="0" Width="300px" DecimalPrecision="4">
                                    </f:NumberBox>
                                    <f:TextBox ID="txtRemark1" runat="server" LabelWidth="0" Width="300px">
                                    </f:TextBox>
                                </Items>
                            </f:FormRow>
                            <f:FormRow >
                                <Items>
                                    ...
                                    <f:NumberBox ID="txtConstructionIncome" runat="server"  Label="" DecimalPrecision="4"
                                        AutoPostBack="true" OnTextChanged="Text_TextChanged">
                                    </f:NumberBox>
                                    <f:NumberBox ID="txtProjectConstructionIncome" DecimalPrecision="4"
                                        runat="server" LabelWidth="0" Width="300px">
                                    </f:NumberBox>
                                    <f:TextBox ID="txtRemark2"   runat="server" Label="">
                                    </f:TextBox>
                                </Items>
                            </f:FormRow> 
                            <f:FormRow >
                                <Items>                                     
                                    ...
                                    <f:NumberBox ID="txtSafetyCosts"  runat="server" Label="" DecimalPrecision="4"
                                        AutoPostBack="true" OnTextChanged="Text_TextChanged">
                                    </f:NumberBox>
                                    <f:NumberBox ID="txtProjectSafetyCosts"  DecimalPrecision="4"
                                        runat="server" LabelWidth="0" Width="300px">
                                    </f:NumberBox>
                                    <f:TextBox ID="txtRemark3"  runat="server" Label="">
                                    </f:TextBox>
                                </Items>
                            </f:FormRow> 
                            <f:FormRow >
                            ...
                            <f:FormRow >
                                <Items>                                     
                                    ...
                                    <f:NumberBox ID="txtEngineeringCost"  runat="server" Label="" DecimalPrecision="4"
                                        AutoPostBack="true" OnTextChanged="Text_TextChanged">
                                    </f:NumberBox>
                                    <f:NumberBox ID="txtProjectEngineeringCost" DecimalPrecision="4"
                                        runat="server" LabelWidth="0" Width="300px">
                                    </f:NumberBox>
                                    <f:TextBox ID="txtUnitRemark1"  runat="server" Label="">
                                    </f:TextBox>
                                </Items>
                            </f:FormRow> 
                            <f:FormRow >
                                <Items>                                     
                                    ...
                                    <f:NumberBox ID="txtSubUnitCost"  runat="server" Label="" DecimalPrecision="4"
                                        AutoPostBack="true" OnTextChanged="Text_TextChanged">
                                    </f:NumberBox>
                                    <f:NumberBox ID="txtProjectSubUnitCost" DecimalPrecision="4"
                                        runat="server" LabelWidth="0" Width="300px">
                                    </f:NumberBox>
                                    <f:TextBox ID="txtUnitRemark2"  runat="server" Label="">
                                    </f:TextBox>
                                </Items>
                            </f:FormRow> 
                            <f:FormRow >
                                <Items>                                     
                                    ...
                                    <f:TextBox ID="txtUnitRemark3" runat="server" Label="">
                                    </f:TextBox>
                                </Items>
                            </f:FormRow> 
                            <f:FormRow >
                                <Items>                                     
                                    ...
                                    <f:TextBox ID="txtUnitRemark4" runat="server" Label="">
                                    </f:TextBox>
                                </Items>
                            </f:FormRow> 
                            <f:FormRow>
                            ...
                            <f:Toolbar ID="Toolbar1" Position="Bottom" ToolbarAlign="Right" runat="server">
                                <Items>                                    
                                    <f:Button ID="btnSave" Icon="SystemSave" runat="server" ToolTip="保存" ValidateForms="SimpleForm1"
                                     ...
                                     <f:Button ID="btnSubmit" Icon="SystemSaveNew" runat="server" ToolTip="提交" ValidateForms="SimpleForm1" ConfirmText="确认提交？"
