<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HSSECostUnitManageView.aspx.cs" Inherits="FineUIPro.Web.CostGoods.HSSECostUnitManageView"
        ...
        <Rows>
            <f:FormRow>
                <Items>
                    <f:Form ID="Form2" ShowBorder="false" ShowHeader="false" AutoScroll="true"
                        ...
                        Layout="VBox">
                        <Rows>
                             <f:FormRow ColumnWidths="35% 20% 20% 25%">
                                <Items>
            ...
            <f:FormRow >
                <Items>
                    ...
                    <f:Button ID="btnA1" Text="查看" ToolTip="费用维护及查看" Icon="TableCell" runat="server"
            ...
            <f:FormRow >
                <Items>
                    ...
                    <f:Button ID="btnA2" Text="查看" ToolTip="费用维护及查看" Icon="TableCell" runat="server"
                        OnClick="btnUrl_Click" ValidateForms="SimpleForm1">
                    </f:Button> 
                </Items>
            </f:FormRow> 
             <f:FormRow >
                <Items>
                    ...
                    <f:Button ID="btnA3" Text="查看" ToolTip="费用维护及查看" Icon="TableCell" runat="server"
                        OnClick="btnUrl_Click" ValidateForms="SimpleForm1">
                    </f:Button> 
                </Items>
            </f:FormRow> 
             <f:FormRow >
                <Items>
                    ...
                    <f:Button ID="btnA4" Text="查看" ToolTip="费用维护及查看" Icon="TableCell" runat="server"
                        OnClick="btnUrl_Click" ValidateForms="SimpleForm1">
                    </f:Button> 
                </Items>
            </f:FormRow>
             <f:FormRow >
                <Items>
                    ...
                    <f:Button ID="btnA5" Text="查看" ToolTip="费用维护及查看" Icon="TableCell" runat="server"
                        OnClick="btnUrl_Click" ValidateForms="SimpleForm1">
                    </f:Button> 
                </Items>
            </f:FormRow>
             <f:FormRow >
                <Items>
                    ...
                    <f:Button ID="btnA6" Text="查看" ToolTip="费用维护及查看" Icon="TableCell" runat="server"
                        OnClick="btnUrl_Click" ValidateForms="SimpleForm1">
                    </f:Button> 
                </Items>
            </f:FormRow>
             <f:FormRow >
                <Items>
                    ...
                    <f:Button ID="btnA7" Text="查看" ToolTip="费用维护及查看" Icon="TableCell" runat="server"
                        OnClick="btnUrl_Click" ValidateForms="SimpleForm1">
                    </f:Button> 
                </Items>
            </f:FormRow>
             <f:FormRow >
                <Items>
                    ...
                    <f:Button ID="btnA8" Text="查看" ToolTip="费用维护及查看" Icon="TableCell" runat="server"
                        OnClick="btnUrl_Click" ValidateForms="SimpleForm1">
                    </f:Button> 
                </Items>
            </f:FormRow>
             ...
             <f:FormRow >
                <Items>
                    ...
                    <f:Button ID="btnB1" Text="查看" ToolTip="费用维护及查看" Icon="TableCell" runat="server"
                        OnClick="btnUrl_Click" ValidateForms="SimpleForm1">
                    </f:Button> 
                </Items>
            </f:FormRow>
             <f:FormRow >
                <Items>
                    ...
                    <f:Button ID="btnB2" Text="查看" ToolTip="费用维护及查看" Icon="TableCell" runat="server"
                        OnClick="btnUrl_Click" ValidateForms="SimpleForm1">
                    </f:Button> 
                </Items>
            </f:FormRow>
            ...
            <f:FormRow >
                <Items>
                    ...
                    <f:Button ID="btnC1" Text="查看" ToolTip="费用维护及查看" Icon="TableCell" runat="server"
                        OnClick="btnUrl_Click" ValidateForms="SimpleForm1">
                    </f:Button> 
                </Items>
            </f:FormRow>
             ...
             <f:FormRow >
                <Items>
                    ...
                    <f:Button ID="btnD1" Text="查看" ToolTip="费用维护及查看" Icon="TableCell" runat="server"
                        OnClick="btnUrl_Click" ValidateForms="SimpleForm1">
                    </f:Button> 
                </Items>
            </f:FormRow>
             <f:FormRow >
                <Items>
                    ...
                    <f:Button ID="btnD2" Text="查看" ToolTip="费用维护及查看" Icon="TableCell" runat="server"
                        OnClick="btnUrl_Click" ValidateForms="SimpleForm1">
                    </f:Button> 
                </Items>
            </f:FormRow>
            <f:FormRow >
                <Items>
                    ...
                    <f:Button ID="btnD3" Text="查看" ToolTip="费用维护及查看" Icon="TableCell" runat="server"
                        OnClick="btnUrl_Click" ValidateForms="SimpleForm1">
                    </f:Button> 
                </Items>
            </f:FormRow>
