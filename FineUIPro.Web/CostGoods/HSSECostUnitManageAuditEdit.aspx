<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HSSECostUnitManageAuditEdit.aspx.cs" Inherits="FineUIPro.Web.CostGoods.HSSECostUnitManageAuditEdit"
        ...
        <Rows>
                            ...
                            <f:FormRow ColumnWidths="30% 35% 35%">
                                <Items>
                                    ...
                                    <f:Label ID="txtCompileDate" runat="server" Label="填报日期" LabelWidth="100px">
                                     ...
                                     <f:DropDownList runat="server" ID="drpRatifiedManId" Label="总包费控工程师" LabelWidth="120px">
                                     </f:DropDownList>
                                </Items>
                            </f:FormRow>
                        </Rows>
            ...
            <f:FormRow >
                <Items>
                    ...
                    <f:Button ID="btnA1" Text="审核" ToolTip="费用维护及查看" Icon="TableCell" runat="server"
            ...
            <f:FormRow >
                <Items>
                    ...
                    <f:Button ID="btnA2" Text="审核" ToolTip="费用维护及查看" Icon="TableCell" runat="server"
                        OnClick="btnUrl_Click" ValidateForms="SimpleForm1">
                    </f:Button> 
             ...
             <f:FormRow >
                <Items>
                    ...
                    <f:Button ID="btnA3" Text="审核" ToolTip="费用维护及查看" Icon="TableCell" runat="server"
                        OnClick="btnUrl_Click" ValidateForms="SimpleForm1">
                    </f:Button> 
             ...
             <f:FormRow >
                <Items>
                    ...
                    <f:Button ID="btnA4" Text="审核" ToolTip="费用维护及查看" Icon="TableCell" runat="server"
                        OnClick="btnUrl_Click" ValidateForms="SimpleForm1">
                    </f:Button> 
             ...
             <f:FormRow >
                <Items>
                    ...
                    <f:Button ID="btnA5" Text="审核" ToolTip="费用维护及查看" Icon="TableCell" runat="server"
                        OnClick="btnUrl_Click" ValidateForms="SimpleForm1">
                    </f:Button> 
             ...
             <f:FormRow >
                <Items>
                    ...
                    <f:Button ID="btnA6" Text="审核" ToolTip="费用维护及查看" Icon="TableCell" runat="server"
                        OnClick="btnUrl_Click" ValidateForms="SimpleForm1">
                    </f:Button> 
             ...
             <f:FormRow >
                <Items>
                    ...
                    <f:Button ID="btnA7" Text="审核" ToolTip="费用维护及查看" Icon="TableCell" runat="server"
                        OnClick="btnUrl_Click" ValidateForms="SimpleForm1">
                    </f:Button> 
             ...
             <f:FormRow >
                <Items>
                    ...
                    <f:Button ID="btnA8" Text="审核" ToolTip="费用维护及查看" Icon="TableCell" runat="server"
                        OnClick="btnUrl_Click" ValidateForms="SimpleForm1">
                    </f:Button>
