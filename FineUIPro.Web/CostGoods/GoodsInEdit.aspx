<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsInEdit.aspx.cs" Inherits="FineUIPro.Web.CostGoods.GoodsInEdit"
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" Title="物资入库管理" AutoScroll="true"
        ...
        <Rows>
            <f:FormRow>
                <Items>
                    <f:TextBox ID="txtGoodsInCode" runat="server" Label="入库单号" LabelAlign="Right" MaxLength="50"
                        Readonly="true">
                    </f:TextBox>
                </Items>
            </f:FormRow>
            ...
            <f:FormRow>
                <Items>
                    <f:TextBox ID="txtInPerson" runat="server" Label="入库人" LabelAlign="Right" MaxLength="50">
                    </f:TextBox>
                    <f:DatePicker ID="txtInDate" runat="server" Label="入库时间" LabelAlign="Right" EnableEdit="true">
                    </f:DatePicker>
                </Items>
            </f:FormRow>
            <f:FormRow>
