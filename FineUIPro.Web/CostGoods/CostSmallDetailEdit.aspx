<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CostSmallDetailEdit.aspx.cs"
    Inherits="FineUIPro.Web.CostGoods.CostSmallDetailEdit" ValidateRequest="false" %>
        ...
        <Rows>
            <f:FormRow ColumnWidths="30% 20% 50%">
                <Items>
                    ...
                    <f:TextBox ID="txtCostSmallDetailCode" runat="server" Label="编号" LabelAlign="Right"
            ...
            <f:FormRow>
                <Items>
                    <f:Panel ID="Panel2" runat="server" ShowBorder="false" Layout="Table" TableConfigColumns="5"
                        ...
                        <Items>
                            <f:Panel ID="Panel1" Title="Panel1" TableRowspan="2" MarginRight="0" Width="150px"
                            ...
                            <f:Panel ID="Panel3" Title="Panel1" runat="server" BodyPadding="1px" Width="300px"
                                TableRowspan="2" ShowBorder="false" ShowHeader="false" MarginLeft="80px">
                                <Items>
                            ...
                            <f:Panel ID="Panel5" Title="Panel1" runat="server" BodyPadding="1px" ShowBorder="false"
                                TableColspan="2" Width="400px" ShowHeader="false" MarginLeft="120px">
                                <Items>
                            ...
                            <f:Panel ID="Panel6" Title="Panel1" runat="server" BodyPadding="1px" ShowBorder="false"
                                Width="200px" ShowHeader="false" MarginLeft="50">
                                <Items>
            ...
            <f:FormRow>
                <Items>
                    <f:Label runat="server" ID="Label5" Text="A1" Width="150px">
                    </f:Label>
                    <f:Label runat="server" ID="Label6" Text="基础管理" Width="300px">
                    </f:Label>
            ...
            <f:FormRow>
                <Items>
                    <f:Label runat="server" ID="Label7" Text="A2" Width="150px">
                    </f:Label>
                    <f:Label runat="server" ID="Label8" Text="安全技术" Width="300px">
                    </f:Label>
            ...
            <f:FormRow>
                <Items>
                    <f:Label runat="server" ID="Label9" Text="A3" Width="150px">
                    </f:Label>
                    <f:Label runat="server" ID="Label10" Text="职业健康" Width="300px">
                    </f:Label>
            ...
            <f:FormRow>
                <Items>
                    <f:Label runat="server" ID="Label11" Text="A4" Width="150px">
                    </f:Label>
                    <f:Label runat="server" ID="Label12" Text="安全防护" Width="300px">
                    </f:Label>
            ...
            <f:FormRow>
                <Items>
                    <f:Label runat="server" ID="Label13" Text="A5" Width="150px">
                    </f:Label>
                    <f:Label runat="server" ID="Label14" Text="化工试车" Width="300px">
                    </f:Label>
            ...
            <f:FormRow>
                <Items>
                    <f:Label runat="server" ID="Label15" Text="A6" Width="150px">
                    </f:Label>
                    <f:Label runat="server" ID="Label16" Text="教育培训" Width="300px">
                    </f:Label>
            ...
            <f:FormRow>
                <Items>
                    <f:Label runat="server" ID="Label29" Width="150px">
                    </f:Label>
                    <f:Label runat="server" ID="Label17" Text="A安全生产费用合计" Width="300px">
                    </f:Label>
            ...
            <f:FormRow>
                <Items>
                    <f:Label runat="server" ID="Label19" Text="B1" Width="150px">
                    </f:Label>
                    <f:Label runat="server" ID="Label20" Text="文明施工" Width="300px">
                    </f:Label>
            ...
            <f:FormRow>
                <Items>
                    <f:Label runat="server" ID="Label21" Text="B2" Width="150px">
                    </f:Label>
                    <f:Label runat="server" ID="Label22" Text="临时设施" Width="300px">
                    </f:Label>
                    ...
                    <f:TextBox runat="server" ID="txtDefB2" Width="200px">
                    </f:TextBox>
                </Items>
            </f:FormRow>
            <f:FormRow>
                <Items>
                    <f:Label runat="server" ID="Label23" Text="B3" Width="150px">
                    </f:Label>
                    <f:Label runat="server" ID="Label24" Text="环境保护" Width="300px">
                    </f:Label>
            ...
            <f:FormRow>
                <Items>
                    <f:Label runat="server" ID="Label30" Width="150px">
                    </f:Label>
                    <f:Label runat="server" ID="Label25" Text="B文明施工措施费合计" Width="300px">
                    </f:Label>
            ...
            <f:FormRow>
                <Items>
                    <f:Label runat="server" ID="Label31" Width="150px">
                    </f:Label>
                    <f:Label runat="server" ID="Label27" Text="A+B安全生产及文明施工措施费总计" Width="300px">
                    </f:Label>
