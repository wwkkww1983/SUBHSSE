<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayRegistration.aspx.cs"
    Inherits="FineUIPro.Web.CostGoods.PayRegistration" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>安全费用投入登记</title>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="安全费用投入登记" EnableCollapse="true"
                runat="server" BoxFlex="1" EnableColumnLines="true" DataKeyNames="PayRegistrationId"
                AllowCellEditing="true" ClicksToEdit="2" DataIDField="PayRegistrationId" AllowSorting="true"
                ...
                <Columns>              
                    ...
                    <f:WindowField TextAlign="Left" Width="150px" WindowID="WindowAtt" HeaderText="附件" Text="附件" ToolTip="附件上传查看"
                        DataIFrameUrlFields="PayRegistrationId" DataIFrameUrlFormatString="../AttachFile/webuploader.aspx?toKeyId={0}&path=FileUpload/PayRegistrationAttachUrl&menuId=9EFF1A0F-87AA-43E7-83B0-79EEAAC8848E"
