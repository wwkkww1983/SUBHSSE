<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HSSECostUnitManageAuditItem.aspx.cs" Inherits="FineUIPro.Web.CostGoods.HSSECostUnitManageAuditItem" %>
     ...
     <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" Title="分包费用审核" AutoScroll="true"
        ...
        <Rows>
            ...
            <f:FormRow runat ="server" ID="tr2" Hidden="true">
                <Items>
                    <f:NumberBox ID="txtAuditQuantity" runat="server" Label="工程量" DecimalPrecision="4"
                        NoDecimal="true" NoNegative="true" Width="180" LabelWidth="80px" AutoPostBack="true" OnTextChanged="txtQuantity_TextChanged">
                    </f:NumberBox>
                     <f:NumberBox ID="txtAuditPrice" runat="server" Label="单价" DecimalPrecision="4"
                         NoNegative="true" Width="180" LabelWidth="80px" AutoPostBack="true" OnTextChanged="txtQuantity_TextChanged">
                    </f:NumberBox>
                    <f:NumberBox ID="txtAuditTotalPrice" runat="server" Label="总价" DecimalPrecision="4" LabelWidth="80px"
            ...
            <f:FormRow runat ="server" ID="tr3" Hidden="true">
                <Items>
                  <f:TextArea runat="server" ID="txtAuditExplain" Label="审核意见" LabelWidth="80px"
                    ...
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false"  EnableCollapse="true" EnableColumnLines="true" 
                        ...
                        SortDirection="ASC" AllowPaging="true" EnableTextSelection="True" Height="400px">   
                         <Toolbars>                                   
                             <f:Toolbar ID="Toolbar1" Position="Top" ToolbarAlign="Right" runat="server">
                                 <Items>
                                    <f:Label runat="server" Text="右键审核工程量、单价、总价"></f:Label>
                        ...
                        <Columns>
                            ...
                            <f:RenderField Width="70px" ColumnID="TotalPrice" DataField="TotalPrice" 
                              ...
                              <f:RenderField Width="80px" ColumnID="IsAgreeName" DataField="IsAgreeName" 
                                FieldType="String" HeaderText="审核意见"  HeaderTextAlign="Center" TextAlign="Right">
                            </f:RenderField>
                              <f:RenderField Width="80px" ColumnID="AuditQuantity" DataField="AuditQuantity" 
                                FieldType="Double" HeaderText="工程量"  HeaderTextAlign="Center" TextAlign="Right">
                            </f:RenderField>
                            <f:RenderField Width="80px" ColumnID="AuditPrice" DataField="AuditPrice" 
                                FieldType="Double" HeaderText="审核单价"  HeaderTextAlign="Center" TextAlign="Right">
                            </f:RenderField>
                            <f:RenderField Width="80px" ColumnID="AuditTotalPrice" DataField="AuditTotalPrice" 
