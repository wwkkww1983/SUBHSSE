<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MeasuresPlan.aspx.cs" Inherits="FineUIPro.Web.CostGoods.MeasuresPlan" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>安全措施费使用计划</title>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="安全措施费使用计划" EnableCollapse="true"
                runat="server" BoxFlex="1" EnableColumnLines="true" DataKeyNames="MeasuresPlanId"
                AllowCellEditing="true" ClicksToEdit="2" DataIDField="MeasuresPlanId" AllowSorting="true"
                SortField="MeasuresPlanCode" SortDirection="DESC" OnSort="Grid1_Sort" AllowPaging="true"
                ...
                <Columns>                   
                    ...
                    <f:RenderField Width="200px" ColumnID="MeasuresPlanCode" DataField="MeasuresPlanCode"
                        SortField="MeasuresPlanCode" FieldType="String" HeaderText="编号" HeaderTextAlign="Center"
                        TextAlign="Left">
                    </f:RenderField>
                    ...
                    <f:WindowField TextAlign="Left" Width="220px" WindowID="WindowAtt" HeaderText="附件"
                        Text="附件" ToolTip="附件上传查看" DataIFrameUrlFields="MeasuresPlanId" DataIFrameUrlFormatString="../AttachFile/webuploader.aspx?toKeyId={0}&path=FileUpload/MeasuresPlanAttachUrl&menuId=6FBF4B7D-21D2-4013-9465-12AC093109D4"
    ...
    <f:Window ID="Window1" Title="安全措施费使用计划" Hidden="true" EnableIFrame="true" EnableMaximize="true"
