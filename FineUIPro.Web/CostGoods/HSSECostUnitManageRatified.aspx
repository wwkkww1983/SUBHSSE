<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HSSECostUnitManageRatified.aspx.cs" Inherits="FineUIPro.Web.CostGoods.HSSECostUnitManageRatified" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>安全分包费用核定</title>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="安全分包费用核定" EnableCollapse="true"
                ...
                <Toolbars>
                    <f:Toolbar ID="Toolbar2" Position="Top" runat="server" ToolbarAlign="Left">
                        <Items>
                            ...
                            <f:RadioButtonList runat="server" ID="rbStateType" AutoPostBack="true" Width="300px"
                                    OnSelectedIndexChanged="TextBox_TextChanged">
                                <f:RadioItem  Text="费控核定" Value="3" Selected="true"/>
                ...
                <Columns>
                    ...
                    <f:RenderField Width="220px" ColumnID="UnitName" DataField="UnitName" ExpandUnusedSpace="true"
                     ...
                     <f:RenderField Width="150px" ColumnID="CostAsum" DataField="CostAsum"
                        SortField="CostAsum" FieldType="Double" HeaderText="核定安全生产费用" HeaderTextAlign="Center"
                        TextAlign="Right">
                    </f:RenderField>
    ...
    <f:Window ID="Window1" Title="安全分包费用核定" Hidden="true" EnableIFrame="true" EnableMaximize="true"
        Target="Parent" EnableResize="true" runat="server" IsModal="true" Width="1200px"
        Height="600px">
    </f:Window>    
    <f:Menu ID="Menu1" runat="server">
        <f:MenuButton ID="btnMenuEdit" OnClick="btnMenuEdit_Click" Icon="TableEdit" EnablePostBack="true"
            Hidden="true" runat="server" Text="核定">
        </f:MenuButton>
