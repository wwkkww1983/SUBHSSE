...
{
    public partial class MeasuresPlan : PageBase
    {
        #region 项目主键
        /// <summary>
        /// 项目主键
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                this.btnNew.OnClientClick = Window1.GetShowReference("MeasuresPlanEdit.aspx") + "return false;";
        ...
        private void EditData()
        {
            ...
            var measuresPlan = BLL.MeasuresPlanService.GetMeasuresPlanById(id);
            if (measuresPlan != null)
            {
                PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("MeasuresPlanEdit.aspx?MeasuresPlanId={0}", id, "编辑 - ")));
            }
        }
        #endregion
        ...
        private void GetButtonPower()
        {
            ...
            var buttonList = BLL.CommonService.GetAllButtonList(this.CurrUser.LoginProjectId, this.CurrUser.UserId, BLL.Const.ProjectMeasuresPlanMenuId);
        ...
        protected void btnOut_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + System.Web.HttpUtility.UrlEncode("安全措施费使用计划" + filename, System.Text.Encoding.UTF8) + ".xls");
...
#pragma warning disable CS0108 // “MeasuresPlan.GetGridTableHtml(Grid)”隐藏继承的成员“PageBase.GetGridTableHtml(Grid)”。如果是有意隐藏，请使用关键字 new。
        /// <summary>
        /// 导出方法
        /// </summary>
...
#pragma warning restore CS0108 // “MeasuresPlan.GetGridTableHtml(Grid)”隐藏继承的成员“PageBase.GetGridTableHtml(Grid)”。如果是有意隐藏，请使用关键字 new。
        {
