<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PerfomanceRecordView.aspx.cs"
    Inherits="FineUIPro.Web.Perfomance.PerfomanceRecordView" ValidateRequest="false" %>
...
<head runat="server">
    ...
    <title>查看分包方绩效评价</title>
    <link href="../res/css/common.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <form id="form1" runat="server">
    <f:PageManager ID="PageManager1" runat="server" AutoSizePanelID="SimpleForm1"/>
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" Title="分包方绩效评价" AutoScroll="true"
                                ...
                                <Items>
                                    <f:Form ID="Form2" runat="server" ShowHeader="false" BodyPadding="5px">
                                        <Items>
                                            ...
                                            <f:FormRow>
                                                <Items>
                                                    <f:TextBox ID="txtRewardOrPunish" runat="server" Label="奖/罚">
                                                    </f:TextBox>
