<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PerfomanceRecord.aspx.cs"
    Inherits="FineUIPro.Web.Perfomance.PerfomanceRecord" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="分包方绩效评价" EnableCollapse="true"
                runat="server" BoxFlex="1" EnableColumnLines="true" DataKeyNames="PerfomanceRecordId"
                AllowCellEditing="true" ClicksToEdit="2" DataIDField="PerfomanceRecordId" AllowSorting="true"
                SortField="PerfomanceRecordCode" SortDirection="DESC" OnSort="Grid1_Sort" AllowPaging="true"
                IsDatabasePaging="true" PageSize="10" OnPageIndexChange="Grid1_PageIndexChange"
                EnableRowDoubleClickEvent="true" OnRowDoubleClick="Grid1_RowDoubleClick" EnableTextSelection="True">
                <Toolbars>
                    <f:Toolbar ID="Toolbar2" Position="Top" runat="server" ToolbarAlign="Left">
                        <Items>
                            <f:TextBox runat="server" Label="评价编号" ID="txtPerfomanceRecordCode" EmptyText="输入查询条件"
                ...
                <Columns>
                    <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center"
                        TextAlign="Center" />
                    <f:RenderField Width="200px" ColumnID="PerfomanceRecordCode" DataField="PerfomanceRecordCode"
                        SortField="PerfomanceRecordCode" FieldType="String" HeaderText="评价编号" HeaderTextAlign="Center"
                        TextAlign="Left">
                    </f:RenderField>
    ...
    <f:Window ID="Window1" Title="编辑分包方绩效评价" Hidden="true" EnableIFrame="true" EnableMaximize="true"
