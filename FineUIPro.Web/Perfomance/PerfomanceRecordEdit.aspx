<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PerfomanceRecordEdit.aspx.cs"
    Inherits="FineUIPro.Web.Perfomance.PerfomanceRecordEdit" ValidateRequest="false" %>
                    ...
                    <f:TabStrip ID="TabStrip1" Width="850px" Height="350px" ShowBorder="true" TabPosition="Top"
                        ...
                        <Tabs>
                            <f:Tab ID="Tab1" Title="模式一" BodyPadding="5px" Layout="Fit" runat="server">
                                <Items>
                                    <f:Form runat="server" ShowHeader="false" BodyPadding="5px">
                                        <Items>
                                            <f:FormRow>
                                                <Items>
