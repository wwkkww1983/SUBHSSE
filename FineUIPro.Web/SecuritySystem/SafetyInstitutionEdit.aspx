<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SafetyInstitutionEdit.aspx.cs"
    Inherits="FineUIPro.Web.SecuritySystem.SafetyInstitutionEdit" ValidateRequest="false" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" Title="安全制度" AutoScroll="true"
        ...
        <Rows>
            ...
            <f:FormRow>
                <Items>                   
                    <f:TextBox ID="txtScope" runat="server" Label="适用范围" LabelAlign="Right" MaxLength="50">
                    </f:TextBox>
                </Items>
            </f:FormRow>
            <f:FormRow>
                <Items>
                    <f:TextBox ID="txtRemark" runat="server" Label="备注" LabelAlign="Right" MaxLength="300">
                    </f:TextBox>               
                </Items>
            </f:FormRow>
            <f:FormRow>
