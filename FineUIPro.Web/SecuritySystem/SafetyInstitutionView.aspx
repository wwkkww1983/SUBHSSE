<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SafetyInstitutionView.aspx.cs"
    Inherits="FineUIPro.Web.SecuritySystem.SafetyInstitutionView" ValidateRequest="false" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" Title="安全制度" AutoScroll="true"
        ...
        <Rows>
            <f:FormRow>
                <Items>                    
                    <f:TextBox ID="txtTitle" runat="server" Label="制度名称" LabelAlign="Right"
                        Readonly="true">
                    </f:TextBox>
                    <f:TextBox ID="txtEffectiveDate" runat="server" Label="发布日期" LabelAlign="Right"
                        Readonly="true">
                    </f:TextBox>
                </Items>
            </f:FormRow>
            <f:FormRow>
                <Items>                   
                    <f:TextBox ID="txtScope" runat="server" Label="适用范围" LabelAlign="Right" Readonly="true">
                    </f:TextBox>
                </Items>
            </f:FormRow>
            <f:FormRow>
