<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageRuleUpload.aspx.cs"
    Inherits="FineUIPro.Web.Law.ManageRuleUpload" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>管理规定上传资源</title>
                            ...
                            <f:FormRow>
                                <Items>
                                    ...
                                    <f:Toolbar ID="Toolbar2" runat="server" ToolbarAlign="Right" Position="Bottom">
                                        <Items>
                                            <f:Button ID="btnUpFile" Icon="Tick" runat="server" OnClick="btnUpFile_Click" ToolTip="上传附件"
                                                Hidden="true">
                                            </f:Button>
