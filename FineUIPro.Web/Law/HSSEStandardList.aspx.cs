    ...
    public partial class HSSEStandardList : PageBase
    {
        ...
        {          
            if (!IsPostBack)
            {
                ...
                btnUploadResources.OnClientClick = Window2.GetShowReference("HSSEStandardListUpload.aspx") + "return false;";
                btnAuditResources.OnClientClick = Window3.GetShowReference("HSSEStandardListAudit.aspx") + "return false;";
        ...
        {
            string strSql = "select * from View_HSSEStandardsList  where IsPass=@IsPass";
