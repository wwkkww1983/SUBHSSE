<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LawRegulationListAudit.aspx.cs"
    Inherits="FineUIPro.Web.Law.LawRegulationListAudit" Async="true" %>
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="安全法律法规" EnableCollapse="true"
                ...
                <Columns>
                    ...
                    <f:RenderField Width="90px" ColumnID="LawRegulationCode" DataField="LawRegulationCode"
                        SortField="LawRegulationCode" FieldType="String" HeaderText="编号" HeaderTextAlign="Center"
                        TextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="120px" ColumnID="LawRegulationName" DataField="LawRegulationName"
                        EnableFilter="true" SortField="LawRegulationName" FieldType="String" HeaderText="名称"
                    ...
                    <f:RenderField Width="90px" ColumnID="LawsRegulationsTypeName" DataField="LawsRegulationsTypeName"
                        SortField="LawsRegulationsTypeName" FieldType="String" HeaderText="类别" HeaderTextAlign="Center"
                        TextAlign="Center">
                    </f:RenderField>
                    ...
                    <f:RenderField Width="200px" ColumnID="Description" DataField="Description" SortField="Description"
                   ...
                   <f:WindowField TextAlign="Center" Width="120px" WindowID="WindowAtt" HeaderText="附件" Text="附件上传查看"
                       ToolTip="附件上传查看" DataIFrameUrlFields="LawRegulationId" DataIFrameUrlFormatString="../AttachFile/webuploader.aspx?toKeyId={0}&path=FileUpload/LawRegulation&menuId=F4B02718-0616-4623-ABCE-885698DDBEB1"
                          />
