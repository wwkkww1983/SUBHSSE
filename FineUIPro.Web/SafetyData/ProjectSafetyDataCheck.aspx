<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectSafetyDataCheck.aspx.cs" Inherits="FineUIPro.Web.SafetyData.ProjectSafetyDataCheck" %>
                        ...
                        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" EnableCollapse="true" runat="server"
                            ...
                            <Columns>       
                                ...
                                <f:RenderField ColumnID="Title" DataField="Title" SortField="Title" Width="230px" 
                                 ...
                                 <f:RenderField Width="120px" ColumnID="RealStartDate" DataField="RealStartDate"  Renderer="Date"
                                    SortField="RealStartDate" HeaderText="单据开始日期" HeaderTextAlign="Center"  FieldType="Date"
                                    TextAlign="Left" >
                                </f:RenderField>    
                                 <f:RenderField Width="120px" ColumnID="RealEndDate" DataField="RealEndDate"  Renderer="Date"
