<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectSafetyDataItemView.aspx.cs" 
    Inherits="FineUIPro.Web.SafetyData.ProjectSafetyDataItemView" ValidateRequest="false" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            ...
            <f:FormRow>
                <Items>
                    <f:TextBox ID="txtCompileDate" runat="server" Label="单据日期" Required="true" ShowRedStar="true" Readonly="true">
                    </f:TextBox> 
