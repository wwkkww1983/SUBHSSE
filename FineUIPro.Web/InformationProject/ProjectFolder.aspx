<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectFolder.aspx.cs" Inherits="FineUIPro.Web.InformationProject.ProjectFolder" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" ShowBorder="false" ShowHeader="false" Layout="Region">
        <Items>
            <f:Panel runat="server" ID="panelLeftRegion" RegionPosition="Left" RegionSplit="true"
                EnableCollapse="true" Width="260" Title="项目文件夹" TitleToolTip="右键点击添加、修改、删除" ShowBorder="true"
                ShowHeader="false" AutoScroll="true" BodyPadding="5px" IconFont="ArrowCircleLeft" Layout="Fit">                
                <Items>
                    <f:Tree ID="tvProjectFolder" KeepCurrentSelection="true"
                        ShowHeader="false" OnNodeCommand="tvProjectFolder_NodeCommand" runat="server"
            ...
            <f:Panel runat="server" ID="panelCenterRegion" RegionPosition="Center" ShowBorder="true"
                Layout="VBox" ShowHeader="false" BodyPadding="5px" IconFont="PlusCircle" Title="项目文件夹明细"
                AutoScroll="true">
                <Items>
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" EnableCollapse="true" runat="server"
                        BoxFlex="1" DataKeyNames="ProjectFolderItemId" ClicksToEdit="2"
                        DataIDField="ProjectFolderItemId" AllowSorting="true" SortField="Code" SortDirection="DESC"
                        ...
                        <Columns>                           
                            ...
                            <f:RenderField ColumnID="Title" DataField="Title" SortField="Title" Width="200px" ExpandUnusedSpace="true"
                             ...
                             <f:RenderField ColumnID="CompileManName" DataField="CompileManName" SortField="CompileManName" Width="120px"
    ...
    <script type="text/javascript">
        var treeID = '<%= tvProjectFolder.ClientID %>';
