<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MillionsMonthlyReportEdit.aspx.cs"
    Inherits="FineUIPro.Web.InformationProject.MillionsMonthlyReportEdit" ValidateRequest="false" %>
                ...
                <Items>
                    ...
                    <%-- <f:FormRow>
                        <Items>
                            ...
                            <f:TextBox ID="txtName" runat="server" Label="名称" MaxLength="100" LabelAlign="Right"
                                Required="true" ShowRedStar="true">
                            </f:TextBox>
                            <f:NumberBox ID="txtTotalWorkNum" runat="server" Label="总工时数（万）" LabelAlign="Right"
                                NoNegative="false" LabelWidth="140px" EmptyText="0">
