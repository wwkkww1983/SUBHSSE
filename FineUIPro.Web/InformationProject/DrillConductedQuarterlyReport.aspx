<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DrillConductedQuarterlyReport.aspx.cs" Inherits="FineUIPro.Web.InformationProject.DrillConductedQuarterlyReport" ValidateRequest="false" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="应急演练开展情况季报" EnableCollapse="true"
                runat="server" BoxFlex="1" EnableColumnLines="true" DataKeyNames="DrillConductedQuarterlyReportId"
                AllowCellEditing="true" ClicksToEdit="2" DataIDField="DrillConductedQuarterlyReportId" AllowSorting="true"
