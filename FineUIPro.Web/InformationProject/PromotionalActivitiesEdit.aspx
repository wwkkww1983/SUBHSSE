<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PromotionalActivitiesEdit.aspx.cs"
    Inherits="FineUIPro.Web.InformationProject.PromotionalActivitiesEdit" ValidateRequest="false" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" Title="HSSE宣传活动" AutoScroll="true"
        ...
        <Rows>
            ...
            <f:FormRow>
                <Items>                   
                    <f:DropDownList ID="drpUsers" runat="server" Label="参与人员" EnableEdit="true" EnableMultiSelect="true"
                        EnableCheckBoxSelect="true"  LabelAlign="Right">
                    </f:DropDownList>
                </Items>
            </f:FormRow>
            <f:FormRow>
                <Items>
                    <f:DatePicker ID="txtActivitiesDate" runat="server" Label="活动日期" LabelAlign="Right"
                        EnableEdit="true">
                    </f:DatePicker>
