<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DrillPlanHalfYearReport.aspx.cs"
    Inherits="FineUIPro.Web.InformationProject.DrillPlanHalfYearReport" ValidateRequest="false" %>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="应急演练工作计划半年报" EnableCollapse="true"
                runat="server" BoxFlex="1" EnableColumnLines="true" DataKeyNames="DrillPlanHalfYearReportId"
                AllowCellEditing="true" ClicksToEdit="2" DataIDField="DrillPlanHalfYearReportId"
                ...
                <Columns>
                    ...
                    <f:RenderField Width="120px" ColumnID="YearAndHalfYear" DataField="YearAndHalfYear"
                        ExpandUnusedSpace="true" SortField="YearAndHalfYear" FieldType="String" HeaderText="半年报时间"
                        HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
                    <f:RenderField Width="120px" ColumnID="Telephone" DataField="Telephone" ExpandUnusedSpace="true"
                        SortField="Telephone" FieldType="String" HeaderText="联系电话" HeaderTextAlign="Center"
                        TextAlign="Left">
                    </f:RenderField>
                    <f:RenderField Width="120px" ColumnID="CompileMan" DataField="CompileMan"
