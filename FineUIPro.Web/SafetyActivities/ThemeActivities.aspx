...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="主题安全活动" EnableCollapse="true"
                ...
                AllowCellEditing="true" ClicksToEdit="2" DataIDField="ThemeActivitiesId" AllowSorting="true"
                ...
                <Columns>
                    ...
                    <f:WindowField TextAlign="Left" Width="60px" WindowID="WindowAtt" HeaderText="附件" Text="附件" ToolTip="附件上传查看"
                        DataIFrameUrlFields="ThemeActivitiesId" DataIFrameUrlFormatString="../AttachFile/webuploader.aspx?toKeyId={0}&path=FileUpload/ThemeActivitiesAttachUrl&menuId=9D04CD8B-575C-4854-B8B0-F90CEEB75815"
    ...
    <f:Window ID="Window1" Title="编辑主题安全活动" Hidden="true" EnableIFrame="true" EnableMaximize="true"
