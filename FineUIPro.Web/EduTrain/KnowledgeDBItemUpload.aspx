<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KnowledgeDBItemUpload.aspx.cs"
    Inherits="FineUIPro.Web.EduTrain.KnowledgeDBItemUpload" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>应知应会库上传资源</title>
                ...
                <Items>
                    <f:Form BodyPadding="5px" ID="SimpleForm1" Layout="VBox" EnableCollapse="false" runat="server"
                        ...
                        <Rows>
                            ...
                            <f:FormRow>
                                <Items>
                                    <f:TextBox ID="txtKnowledgeItemName" runat="server" Label="名称" Required="true" ShowRedStar="true"
