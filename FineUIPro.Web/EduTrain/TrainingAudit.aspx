<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainingAudit.aspx.cs"
    Async="true" Inherits="FineUIPro.Web.EduTrain.TrainingAudit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>培训教材库资源审核</title>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="培训教材库" EnableCollapse="true"
                runat="server" BoxFlex="1" DataKeyNames="TrainingItemId" AllowCellEditing="true"
                EnableColumnLines="true" ClicksToEdit="2" DataIDField="TrainingItemId" AllowSorting="true"
                ...
                <Columns>
                    ...
                    <f:RenderField Width="200px" ColumnID="TrainingItemCode" DataField="TrainingItemCode"
                        SortField="TrainingItemCode" FieldType="String" HeaderTextAlign="Center" TextAlign="Center"
                        HeaderText="教材编号">
                    </f:RenderField>
                    <f:RenderField Width="350px" ColumnID="TrainingItemName" DataField="TrainingItemName"
                        SortField="TrainingItemName" FieldType="String" HeaderText="教材名称" EnableFilter="true"
                    ...
                    <%--<f:LinkButtonField EnableAjax="false" Width="80px" CommandName="Attach" DataTextField="AttachUrlName"
    ...
    <f:Window ID="Window1" Title="编辑培训教材库" Hidden="true" EnableIFrame="true" EnableMaximize="true"
