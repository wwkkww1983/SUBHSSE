<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainTestDBUpload.aspx.cs"
    Inherits="FineUIPro.Web.EduTrain.TrainTestDBUpload" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>安全试题库上传资源</title>
                ...
                <Items>
                    <f:Form BodyPadding="5px" ID="SimpleForm1" Layout="VBox" EnableCollapse="false" runat="server"
                        ...
                        <Rows>
                            <f:FormRow>
                                <Items>
                                    <f:TextBox ID="txtTrainTestItemCode" runat="server" Label="试题编号" Required="true"
                                        ShowRedStar="true" FocusOnPageLoad="true" MaxLength="50" LabelAlign="Right">
                                    </f:TextBox>
                                </Items>
                            </f:FormRow>
                            <f:FormRow>
                            ...
                            <%--<f:FormRow>
                                <Items>
                                    <f:FileUpload runat="server" ID="fuAttachUrl" EmptyText="请上传附件" Label="附件" LabelAlign="Right">
                                    </f:FileUpload>
                                </Items>
                            </f:FormRow>
                            <f:FormRow>
                                    ...
                                    <f:Toolbar ID="Toolbar2" runat="server" ToolbarAlign="Right" Position="Bottom">
                                        <Items>
                                            <f:Button ID="btnUpFile" Icon="Tick" runat="server" OnClick="btnUpFile_Click" ValidateForms="SimpleForm1"
                                                ToolTip="上传附件" Hidden="true">
                                            </f:Button>
                                            <f:Button ID="btnDeleteFile" Icon="Delete" runat="server" OnClick="btnDeleteFile_Click"
                                                ToolTip="删除附件" Hidden="true">
                                            </f:Button>
