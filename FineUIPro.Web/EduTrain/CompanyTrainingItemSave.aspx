<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyTrainingItemSave.aspx.cs"
    Inherits="FineUIPro.Web.EduTrain.CompanyTrainingItemSave" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            <f:FormRow>
                <Items>
                    <f:TextBox ID="txtCompanyTrainingItemCode" runat="server" Label="教材编号" Required="true"
            ...
            <f:FormRow>
                <Items>
                    <f:TextBox ID="txtCompanyTrainingItemName" runat="server" Label="教材名称" Required="true"
