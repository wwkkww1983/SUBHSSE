<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmergencyList.aspx.cs" Inherits="FineUIPro.Web.Emergency.EmergencyList" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="应急预案管理清单" EnableCollapse="true"
                runat="server" BoxFlex="1" EnableColumnLines="true" DataKeyNames="EmergencyListId"
                AllowCellEditing="true" ClicksToEdit="2" DataIDField="EmergencyListId" AllowSorting="true"
                SortField="EmergencyCode" SortDirection="DESC" OnSort="Grid1_Sort" AllowPaging="true"
                ...
                <Columns>
                    ...
                    <f:RenderField Width="220px" ColumnID="EmergencyName" DataField="EmergencyName"
    ...
    <f:Window ID="Window1" Title="应急预案管理清单" Hidden="true" EnableIFrame="true" EnableMaximize="true"
        Target="Top" EnableResize="true" runat="server" IsModal="true" Width="1200px" Height="620px">
    </f:Window>    
