<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmergencyResponseRecord.aspx.cs" Inherits="FineUIPro.Web.Emergency.EmergencyResponseRecord" %>

<!DOCTYPE html>
<html>
<head id="Head1" runat="server">
    <title>应急响应记录/评价</title>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="应急响应记录/评价" EnableCollapse="true"
                ...
                <Columns>                                      
                    ...
                    <f:WindowField TextAlign="Left" Width="160px" WindowID="WindowAtt" HeaderText="附件" Text="附件查看" ToolTip="附件上传查看" 
                        DataIFrameUrlFields="FileId" DataIFrameUrlFormatString="../AttachFile/webuploader.aspx?toKeyId={0}&path=FileUpload/EmergencyResponseRecordAttachUrl&menuId=C5354813-7B1E-4155-8EE8-D349BF2F18F4"
    ...
    <f:Window ID="Window1" Title="应急响应记录/评价" Hidden="true" EnableIFrame="true" EnableMaximize="true"
