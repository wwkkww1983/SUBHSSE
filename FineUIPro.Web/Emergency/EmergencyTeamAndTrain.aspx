<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmergencyTeamAndTrain.aspx.cs" Inherits="FineUIPro.Web.Emergency.EmergencyTeamAndTrain" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="应急队伍与培训" EnableCollapse="true"
                ...
                <Columns>                                      
                    ...
                    <f:WindowField TextAlign="Left" Width="60px" WindowID="WindowAtt" HeaderText="附件" Text="附件" ToolTip="附件上传查看" 
                        DataIFrameUrlFields="FileId" DataIFrameUrlFormatString="../AttachFile/webuploader.aspx?toKeyId={0}&path=FileUpload/EmergencyTeamAndTrainAttachUrl&menuId=C5354813-7B1E-4155-8EE8-D349BF2F18F4"
