<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccidentStatistics.aspx.cs"
    Inherits="FineUIPro.Web.ProjectAccident.AccidentStatistics" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="事故处理" EnableCollapse="true"
                runat="server" BoxFlex="1" DataKeyNames="AccidentStatisticsId" AllowCellEditing="true"
                ClicksToEdit="2" DataIDField="AccidentStatisticsId" AllowSorting="true" SortField="UnitName"
                ...
                EnableRowDoubleClickEvent="true" OnRowDoubleClick="Grid1_RowDoubleClick"  EnableTextSelection="True">
                 <Toolbars>
                  ...
                  <Columns>
                    ...
                    <f:GroupField HeaderText="处理对象" TextAlign="Center" HeaderTextAlign="Center">
                        <Columns>
                            ...
                            <f:RenderField Width="90px" ColumnID="Person" DataField="Person" SortField="Person"
                                FieldType="String" HeaderText="处理人" TextAlign="Left" HeaderTextAlign="Center">
                            </f:RenderField>
                        </Columns>
                    </f:GroupField>
                    <f:RenderField Width="250px" ColumnID="Treatment" DataField="Treatment" SortField="Treatment"
                        FieldType="String" HeaderText="处理情况" TextAlign="Left" HeaderTextAlign="Center" ExpandUnusedSpace="true">
                    </f:RenderField>
