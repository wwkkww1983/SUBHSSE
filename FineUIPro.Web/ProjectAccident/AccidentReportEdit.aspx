<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccidentReportEdit.aspx.cs"
    Inherits="FineUIPro.Web.ProjectAccident.AccidentReportEdit" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            ...
            <f:FormRow>
                <Items>
                    <f:TextBox ID="txtWorkArea" runat="server" Label="区域"  MaxLength="200">
                    </f:TextBox>
            ...
            <f:FormRow>
                <Items>
                    <f:TextArea ID="txtAccidentDescription" runat="server"  Height="70px" Label="事故描述" MaxLength="1000">
                    </f:TextArea>
                </Items>
            </f:FormRow>
            <f:FormRow>
                <Items>
                    <f:TextArea ID="txtCasualties" runat="server"   Height="70px"  Label="伤亡情况" MaxLength="1000">
                    </f:TextArea>
                </Items>
            </f:FormRow>   
            <f:FormRow>
