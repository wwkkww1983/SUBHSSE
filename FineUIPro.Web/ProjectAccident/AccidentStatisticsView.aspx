<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccidentStatisticsView.aspx.cs"
    Inherits="FineUIPro.Web.ProjectAccident.AccidentStatisticsView" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            ...
            <f:FormRow>
                <Items>
                    <f:TextBox ID="txtPerson" runat="server" Label="处理人" Readonly="true">
                    </f:TextBox>
            ...
            <f:FormRow>
                <Items>
                    <f:TextArea ID="txtTreatment" runat="server"  Height="70px" Label="处理情况" Readonly="true">
                    </f:TextArea>
                </Items>
            </f:FormRow>  
             <f:FormRow>
