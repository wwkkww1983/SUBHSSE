<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectMap.aspx.cs" Inherits="FineUIPro.Web.ProjectData.ProjectMap" %>
<!DOCTYPE html>
<html>
<head runat="server">
    <title>项目地图</title>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="项目地图" EnableCollapse="true"
                runat="server" BoxFlex="1" EnableColumnLines="true" DataKeyNames="ProjectMapId"
                AllowCellEditing="true" ClicksToEdit="2" DataIDField="ProjectMapId" AllowSorting="true"
                SortField="UploadDate" SortDirection="DESC" OnSort="Grid1_Sort" AllowPaging="true"
                ...
                <Columns>                                      
                    ...
                    <f:RenderField Width="200px" ColumnID="Title" DataField="Title" SortField="Title" ExpandUnusedSpace="true"
                        FieldType="String" HeaderText="标题" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
                     <f:RenderField Width="150px" ColumnID="MapTypeName" DataField="MapTypeName" SortField="MapTypeName"
    ...
    <f:Window ID="Window1" Title="项目地图" Hidden="true" EnableIFrame="true" EnableMaximize="true"
