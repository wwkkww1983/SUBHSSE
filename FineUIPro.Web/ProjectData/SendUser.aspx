<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendUser.aspx.cs" Inherits="FineUIPro.Web.ProjectData.SendUser" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>项目用户批量转换</title>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            ...
            <f:FormRow>
                <Items>
                   <f:DropDownBox runat="server" ID="drpUser" Label="项目用户" EmptyText="请从下拉表格中选择" MatchFieldWidth="false" LabelAlign="Right"
                        EnableMultiSelect="true">
                        <PopPanel>
                            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" runat="server" DataIDField="UserId" DataTextField="UserName"
                                DataKeyNames="UserId"  AllowSorting="true" SortField="UnitName,UserName" SortDirection="ASC" EnableColumnLines="true"
                                ...
                                <Toolbars>
                                    <f:Toolbar ID="Toolbar2" Position="Top" runat="server">
                                        <Items>
                                            <f:TextBox runat="server" Label="查询" ID="txtUserName" EmptyText="输入查询条件" 
