...
namespace FineUIPro.Web.ProjectData
{
    public partial class WorkArea : PageBase
    {
        ...
        {
            string strSql = "SELECT WorkAreaId,ProjectId,UnitId,WorkAreaCode,WorkAreaName,Remark FROM ProjectData_WorkArea WHERE 1=1 ";
...
#pragma warning disable CS0108 // “WorkArea.GetGridTableHtml(Grid)”隐藏继承的成员“PageBase.GetGridTableHtml(Grid)”。如果是有意隐藏，请使用关键字 new。
        /// <summary>
        /// 导出方法
        /// </summary>
...
#pragma warning restore CS0108 // “WorkArea.GetGridTableHtml(Grid)”隐藏继承的成员“PageBase.GetGridTableHtml(Grid)”。如果是有意隐藏，请使用关键字 new。
        {
