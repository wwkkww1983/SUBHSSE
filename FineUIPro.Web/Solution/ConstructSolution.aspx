<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConstructSolution.aspx.cs" Inherits="FineUIPro.Web.Solution.ConstructSolution" ValidateRequest="false" %>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="施工方案/审查" EnableCollapse="true"
                ...
                AllowCellEditing="true" ClicksToEdit="2" DataIDField="ConstructSolutionId" AllowSorting="true"
