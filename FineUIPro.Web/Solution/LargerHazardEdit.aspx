<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LargerHazardEdit.aspx.cs" ValidateRequest="false" Inherits="FineUIPro.Web.Solution.LargerHazardEdit" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            ...
            <f:FormRow>
                <Items>                   
                    <f:TextArea ID="txtDescriptions" runat="server" Label="描述" LabelAlign="Right" MaxLength="500" Height="50px"></f:TextArea>
                </Items>
            </f:FormRow>
            <f:FormRow>
                <Items>                   
                    <f:HtmlEditor runat="server" Label="" ID="txtRemark" ShowLabel="false"
