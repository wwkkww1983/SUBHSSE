<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActionPlanList.aspx.cs"
    Inherits="FineUIPro.Web.ActionPlan.ActionPlanList" %>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="实施计划" EnableCollapse="true"
                ...
                AllowCellEditing="true" ClicksToEdit="2" DataIDField="ActionPlanListId" AllowSorting="true"
                ...
                <Columns>                                     
                    ...
                    <f:RenderField Width="150px" ColumnID="ProjectType" DataField="ProjectType" SortField="ProjectType"
