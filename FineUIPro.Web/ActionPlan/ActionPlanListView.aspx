<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActionPlanListView.aspx.cs"
    Inherits="FineUIPro.Web.ActionPlan.ActionPlanListView" ValidateRequest="false" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true" Title="安全实施计划"
        ...
        <Rows>
            <f:FormRow>
                <Items>
                    <f:TextBox ID="txtActionPlanListCode" runat="server" Label="实施计划编号" Readonly="true"
                        LabelAlign="Right" LabelWidth="120px">
                    </f:TextBox>
                    <f:TextBox ID="txtActionPlanListName" runat="server" Label="实施计划名称"  Readonly="true" LabelAlign="Right" LabelWidth="120px">
                    </f:TextBox>
                </Items>
            </f:FormRow>
            <f:FormRow>
