<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActionPlanSummaryView.aspx.cs"
    Inherits="FineUIPro.Web.ActionPlan.ActionPlanSummaryView" ValidateRequest="false" %>
        ...
        <Rows>
            <f:FormRow>
                <Items>
                    ...
                    <f:TextBox ID="txtName" runat="server" Label="总结名称"  Readonly="true" LabelAlign="Right" LabelWidth="120px">
                    </f:TextBox>
                </Items>
            </f:FormRow>
            <f:FormRow>
                <Items>
                    <f:TextBox ID="txtUnit" runat="server" Label="单位" LabelAlign="Right" LabelWidth="120px"  Readonly="true">
                    </f:TextBox>
                </Items>
            </f:FormRow>
            <f:FormRow>
