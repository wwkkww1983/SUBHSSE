<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HazardDetection.aspx.cs" Inherits="FineUIPro.Web.OccupationHealth.HazardDetection" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="危害检测" EnableCollapse="true"
    ...
    <f:Window ID="Window1" Title="编辑危害检测" Hidden="true" EnableIFrame="true" EnableMaximize="true"
