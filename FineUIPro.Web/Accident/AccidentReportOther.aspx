<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccidentReportOther.aspx.cs"
    Inherits="FineUIPro.Web.Accident.AccidentReportOther" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>事故调查处理报告</title>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="事故调查处理报告" EnableCollapse="true"
                runat="server" BoxFlex="1" EnableColumnLines="true" DataKeyNames="AccidentReportOtherId"
                AllowCellEditing="true" ClicksToEdit="2" DataIDField="AccidentReportOtherId"
                AllowSorting="true" SortField="AccidentReportOtherCode" SortDirection="DESC"
                ...
                <Columns>
                    <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center"
                        TextAlign="Center" />
                    <f:RenderField Width="120px" ColumnID="AccidentReportOtherCode" DataField="AccidentReportOtherCode"
                        SortField="AccidentReportOtherCode" FieldType="String" HeaderText="事故编号" HeaderTextAlign="Center"
                        TextAlign="Left">
                    </f:RenderField>
                    ...
                    <f:RenderField Width="150px" ColumnID="ReporterUnit" DataField="ReporterUnit" SortField="ReporterUnit"
                        FieldType="String" HeaderText="报告人员单位" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
