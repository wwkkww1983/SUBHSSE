            ...
            <f:Panel runat="server" ID="panelCenterRegion" RegionPosition="Center" ShowBorder="true"
                ...
                <Items>
                     <f:Form ID="SimpleForm1" ShowBorder="true" ShowHeader="false" AutoScroll="true" EnableCollapse="true" Collapsed="false"
                            BodyPadding="2px" runat="server" RedStarPosition="BeforeText" LabelAlign="Right" Height="280px">
                        <Rows>
                            <f:FormRow>
                                <Items>
                            ...
                            <f:FormRow>
                                <Items>                                                                        
                                     <f:TextArea ID="txtValues1" runat="server" FocusOnPageLoad="true" Height ="64px" Readonly="true"></f:TextArea>
                                </Items>
                            </f:FormRow>
                            <f:FormRow>
                                <Items>
                            ...
                            <f:FormRow>
                                <Items>                                                                        
                                     <f:TextArea ID="txtValues2" runat="server" Height ="48px" Readonly="true"></f:TextArea>
                                </Items>
                            </f:FormRow>
                            <f:FormRow>
                                <Items>
                            ...
                            <f:FormRow>
                                <Items>                                                                        
                                     <f:TextArea ID="txtValues3" runat="server" Height ="72px" Readonly="true"></f:TextArea>
                                </Items>
                            </f:FormRow>
                            <f:FormRow>
                                <Items>
                            ...
                            <f:FormRow>
                                <Items>                                                                        
                                     <f:TextArea ID="txtValues4" runat="server" Height ="64px" Readonly="true"></f:TextArea>
                                </Items>
                            </f:FormRow>
                            <f:FormRow>
                                <Items>
                            ...
                            <f:FormRow>
                                <Items>                                                                        
                                     <f:TextArea ID="txtValues5" runat="server" Height ="64px" Readonly="true"></f:TextArea>
                                </Items>
                            </f:FormRow>
                            <f:FormRow>
                                <Items>
                            ...
                            <f:FormRow>
                                <Items>                                                                        
                                     <f:TextArea ID="txtValues6" runat="server" Height ="64px" Readonly="true"></f:TextArea>
                                </Items>
                            </f:FormRow>
                            <f:FormRow>
                                <Items>
                            ...
                            <f:FormRow>
                                <Items>                                                                        
                                     <f:TextArea ID="txtValues7" runat="server" Height ="64px" Readonly="true"></f:TextArea>
                                </Items>
                            </f:FormRow>
                         </Rows>
                    </f:Form>
                ...
                <Items>
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="监督检查报告"  EnableCollapse="false" runat="server"
                        BoxFlex="1" DataKeyNames="ID" AllowCellEditing="true" EnableColumnLines="true" SortDirection="ASC"
                        ClicksToEdit="1" DataIDField="ID" AllowSorting="false"   EnableTextSelection="True" Height="200px" AutoScroll="true">
                        <Toolbars>     
