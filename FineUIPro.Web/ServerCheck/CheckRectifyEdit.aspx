<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckRectifyEdit.aspx.cs"
    Inherits="FineUIPro.Web.ServerCheck.CheckRectifyEdit" %>
            ...
            <f:FormRow>
                <Items>
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" EnableCollapse="true" runat="server"
                        BoxFlex="1" DataKeyNames="CheckRectifyItemId" AllowCellEditing="true"
                        ...
                        <Columns>
                            ...
                            <f:TemplateField Width="120px" HeaderText="隐患源点" HeaderTextAlign="Center" TextAlign="Left" ExpandUnusedSpace="true">
                                <ItemTemplate>
                                    <asp:Label ID="Label15" runat="server" Text='<%# Bind("DangerPoint") %>' ToolTip='<%#Bind("DangerPoint") %>'></asp:Label>
                                </ItemTemplate>
                            </f:TemplateField>
                            <f:TemplateField Width="160px" HeaderText="存在风险" HeaderTextAlign="Center" TextAlign="Left">
                                <ItemTemplate>
                                    <asp:Label ID="Label4" runat="server" Text='<%# Bind("RiskExists") %>' ToolTip='<%#Bind("RiskExists") %>'></asp:Label>
                                </ItemTemplate>
                            </f:TemplateField>
                             <f:WindowField TextAlign="Center" Width="80px" WindowID="WindowAtt" HeaderText="整改前" Text="查看"                       
                                ToolTip="相关照片附件" DataIFrameUrlFields="Table5ItemId" DataIFrameUrlFormatString="../AttachFile/webuploader.aspx?toKeyId={0}&path=FileUpload/Check&menuId=4A87774E-FEA5-479A-97A3-9BBA09E4862E&type=-1"
                                Title="相关照片" ColumnID="WindowAtt">
                             </f:WindowField>
                             <f:WindowField TextAlign="Center" Width="80px" WindowID="WindowAtt" HeaderText="整改后" Text="查看"                       
                            ...
                            <f:RenderField Width="80px" ColumnID="ConfirmMan" DataField="ConfirmMan" FieldType="String"
                            ...
                            <f:RenderField Width="90px" ColumnID="OrderEndPerson" DataField="OrderEndPerson"
                                FieldType="String" HeaderTextAlign="Center" TextAlign="Left" HeaderText="消项责任人">
                                <Editor>
