...
namespace FineUIPro.Web.SitePerson
{
    public partial class DayReport : PageBase
    {
        ...
        {
            string strSql = "select DayReport.DayReportId,Users.UserName,DayReport.CompileDate,CodeRecords.Code AS DayReportCode "
            ...
            //if (!string.IsNullOrEmpty(this.txtDayReportCode.Text.Trim()))
            //{
            //    strSql += " AND CodeRecords.Code LIKE @DayReportCode";
            //    listStr.Add(new SqlParameter("@DayReportCode", "%" + this.txtDayReportCode.Text.Trim() + "%"));
            //}
