<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonthReportEdit.aspx.cs" Inherits="FineUIPro.Web.SitePerson.MonthReportEdit" %>
                ...
                <Items>
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" runat="server" ClicksToEdit="1" DataIDField="MonthReportDetailId"
                        ...
                        <Columns>
                            ...
                            <f:RenderField Width="100px" ColumnID="DayNum" DataField="DayNum" SortField="DayNum"
