<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DayReportImport.aspx.cs" Inherits="FineUIPro.Web.SitePerson.DayReportImport" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
                ...
                <Items>
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" EnableCollapse="true" runat="server"
                        ...
                        HeaderTextAlign="Center" TextAlign="Center">
                            ...
                            <f:RenderField Width="280px" ColumnID="UnitName" DataField="UnitName" FieldType="String"
                                HeaderText="单位名称" HeaderTextAlign="Center" TextAlign="Center">
                            </f:RenderField>
                            <f:RenderField Width="150px" ColumnID="WorkTime" DataField="WorkTime" FieldType="String"
                                HeaderText="平均工时" HeaderTextAlign="Center" TextAlign="Center">
                            </f:RenderField>
            ...
            <f:FormRow>
                <Items>
                    <f:Label ID="lblBottom" runat="server" Text="说明：1 人工时日报导入模板中，灰色项为必填项。2 单位名称等必须与基础信息中对应类型的名称一致,否则无法导入。3 如需修改已有人工时日报，请到系统中修改。4 数据导入后，点击“保存”，即可完成人工时日报导入。">
                    </f:Label>
                </Items>
            </f:FormRow>
        </Rows>
