<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonOut.aspx.cs" Inherits="FineUIPro.Web.SitePerson.PersonOut" %>
            ...
            <f:FormRow>
                <Items>
                    <f:DropDownList ID="drpUnitId" runat="server" Label="单位" EnableEdit="true" Required="true"
                     ...
                     <f:DatePicker ID="txtChangeTime" runat="server" Label="出场时间" EnableEdit="true" ShowRedStar="true" Required="true">
                    </f:DatePicker> 
                </Items>
            </f:FormRow>
            <f:FormRow>
