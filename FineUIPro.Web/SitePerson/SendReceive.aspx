<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendReceive.aspx.cs" Inherits="FineUIPro.Web.SitePerson.SendReceive" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="人员项目转换" EnableCollapse="true"
                ...
                <Toolbars>
                    <f:Toolbar ID="Toolbar3" Position="Top" ToolbarAlign="Right" runat="server">
                        <Items>
                            ...
                            <f:CheckBox ID="ckbShow" runat="server" LabelWidth="70px" Label="待接收" 
                ...
                <Columns>                  
                    ...
                    <f:RenderField Width="85px" ColumnID="PersonName" DataField="PersonName" SortField="PersonName"
                    ...
                    <f:RenderField Width="250px" HeaderText="接收项目" ColumnID="ReceiveProjectName" DataField="ReceiveProjectName" 
                     ...
                     <f:RenderField Width="250px" ColumnID="ProjectName" DataField="ProjectName" SortField="ProjectName"
                        FieldType="String" HeaderText="当前所在项目" HeaderTextAlign="Center"
                        TextAlign="Left">                        
                    </f:RenderField>
                </Columns>
                <Listeners>
    ...
    <f:Window ID="Window1" Title="人员项目转换" Hidden="true" EnableIFrame="true" EnableMaximize="true"
