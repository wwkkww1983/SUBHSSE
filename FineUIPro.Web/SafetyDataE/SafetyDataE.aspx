<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SafetyDataE.aspx.cs" Inherits="FineUIPro.Web.SafetyDataE.SafetyDataE" %>
<!DOCTYPE html>
<html>
<head runat="server">   
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" ShowBorder="false" Layout="Region"
        ...
        <Toolbars>
            <f:Toolbar ID="Toolbar1" Position="Top" runat="server" ToolbarAlign="Left">
                <Items>
                    <f:RadioButtonList runat="server" ID="cbType" ShowLabel="true" Width="360px"  LabelAlign="Right"
                        OnSelectedIndexChanged="cbType_SelectedIndexChanged"  AutoPostBack="true" Label="资料类型">
                        <f:RadioItem Text="全部" Value="0" />
                        <f:RadioItem Text="考核项" Value="1" Selected="true"/>
                         <f:RadioItem Text="非考核项" Value="2" />
                     </f:RadioButtonList>
        ...
        <Items>
            <f:Tree ID="tvSafetyDataE" KeepCurrentSelection="true" ShowHeader="false"  runat="server"
    ...
    <script type="text/javascript">
        var treeID = '<%= tvSafetyDataE.ClientID %>';
