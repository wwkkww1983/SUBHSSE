<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectSafetyDataEItemView.aspx.cs" 
    Inherits="FineUIPro.Web.SafetyDataE.ProjectSafetyDataEItemView" ValidateRequest="false" %>
        ...
        <Rows>
             <f:FormRow>
                <Items>
                    ...
                    <f:TextBox ID="txtTitle" runat="server" Label="标题"  Required="true" ShowRedStar="true" Readonly="true">
                    </f:TextBox>
                </Items>
            </f:FormRow>
            <f:FormRow>
                <Items>
                   <f:TextBox ID="txtCheckDate" runat="server" Label="考核日期" Required="true" ShowRedStar="true" Readonly="true">
                    </f:TextBox> 
