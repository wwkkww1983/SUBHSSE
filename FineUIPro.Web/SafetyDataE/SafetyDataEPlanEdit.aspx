<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SafetyDataEPlanEdit.aspx.cs" Inherits="FineUIPro.Web.SafetyDataE.SafetyDataEPlanEdit" %>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            <f:FormRow>
             ...
             <f:FormRow >                
                <Items>                    
                     <f:DatePicker ID="txtCheckDate" runat="server" Label="考核日期" LabelAlign="Right"  
                        EnableEdit="true">
                    </f:DatePicker>
