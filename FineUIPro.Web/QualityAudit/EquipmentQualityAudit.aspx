<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EquipmentQualityAudit.aspx.cs" Inherits="FineUIPro.Web.QualityAudit.EquipmentQualityAudit" %>
            ...
            <f:FormRow>
                <Items>
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" runat="server" ClicksToEdit="1"
                        ...
                        ShowGridHeader="true" Height="400px" EnableColumnLines="true" AutoScroll="true"
                        ...
                        Text="附件" HeaderText="附件" ToolTip="附件上传查看" DataIFrameUrlFields="AuditDetailId" DataIFrameUrlFormatString="../AttachFile/webuploader.aspx?toKeyId={0}&path=FileUpload/EquipmentQualityAuditAttachUrl&menuId=2DEDD752-8BAF-43CD-933D-932AF9AF2F58&type=-1" />
                        </Columns>
                        <Listeners>
