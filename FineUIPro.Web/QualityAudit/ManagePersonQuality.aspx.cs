...
{
    public partial class ManagePersonQuality : PageBase
    {
        #region 项目主键
        /// <summary>
        /// 项目主键
        ...
        {
            string strSql = @"SELECT DISTINCT PersonQuality.ManagePersonQualityId,Person.PersonId,Person.ProjectId,Person.CardNo,Person.PersonName,Unit.UnitId,Unit.UnitCode,Unit.UnitName,WorkPost.WorkPostId,WorkPost.WorkPostName,WorkPost.WorkPostCode,"
        ...
        private void EditData()
        {
            ...
            if (person != null)
            {
                PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("ManagePersonQualityEdit.aspx?PersonId={0}", id, "编辑 - ")));
            }
        }
        #endregion
        ...
        {
            var buttonList = BLL.CommonService.GetAllButtonList(this.CurrUser.LoginProjectId, this.CurrUser.UserId, BLL.Const.ManagePersonQualityMenuId);
        ...
        protected void btnOut_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + System.Web.HttpUtility.UrlEncode("管理人员资质" + filename, System.Text.Encoding.UTF8) + ".xls");
...
#pragma warning disable CS0108 // “ManagePersonQuality.GetGridTableHtml(Grid)”隐藏继承的成员“PageBase.GetGridTableHtml(Grid)”。如果是有意隐藏，请使用关键字 new。
        /// <summary>
        /// 导出方法
        /// </summary>
...
#pragma warning restore CS0108 // “ManagePersonQuality.GetGridTableHtml(Grid)”隐藏继承的成员“PageBase.GetGridTableHtml(Grid)”。如果是有意隐藏，请使用关键字 new。
        {
