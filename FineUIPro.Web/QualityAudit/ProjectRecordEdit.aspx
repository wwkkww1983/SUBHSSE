<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectRecordEdit.aspx.cs"
    Inherits="FineUIPro.Web.QualityAudit.ProjectRecordEdit" ValidateRequest="false" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>编辑项目协议记录</title>
    ...
    <form id="form1" runat="server">
        ...
        <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" Title="项目协议记录" AutoScroll="true"
            ...
            <Rows>
                <f:FormRow>
                    <Items>
                        <f:TextBox ID="txtProjectRecordCode" runat="server" Label="编号" LabelAlign="Right"
                            MaxLength="50" Readonly="true">
                        </f:TextBox>
                        <f:TextBox ID="txtProjectRecordName" runat="server" Label="标题" LabelAlign="Right"
