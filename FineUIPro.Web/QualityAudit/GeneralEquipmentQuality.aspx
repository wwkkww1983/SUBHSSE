<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GeneralEquipmentQuality.aspx.cs" Inherits="FineUIPro.Web.QualityAudit.GeneralEquipmentQuality" %>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="一般机具设备资质" EnableCollapse="true"
                ...
                AllowCellEditing="true" ClicksToEdit="2" DataIDField="GeneralEquipmentQualityId" AllowSorting="true"
                SortField="GeneralEquipmentQualityCode" SortDirection="DESC" OnSort="Grid1_Sort" AllowPaging="true"
                ...
                <Toolbars>
                    <f:Toolbar ID="Toolbar2" Position="Top" runat="server" ToolbarAlign="Left">
                        <Items>
                            ...
                            <f:TextBox runat="server" Label="机具设备类型" ID="txtSpecialEquipmentName" EmptyText="输入查询条件"
