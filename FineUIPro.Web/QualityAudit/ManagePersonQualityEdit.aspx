<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagePersonQualityEdit.aspx.cs" Inherits="FineUIPro.Web.QualityAudit.ManagePersonQualityEdit" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" Title="人员资质" AutoScroll="true"
            ...
            <Rows>
                ...
                <f:FormRow>
                    <Items>
                        <f:Grid ID="Grid1" IsFluid="true" CssClass="blockpanel" ShowBorder="true" ShowHeader="false" Title="资质证书（双击编辑）" EnableCollapse="false"
                            runat="server" DataKeyNames="ManagePersonQualityItemId" AllowCellEditing="true" ClicksToEdit="2" OnPreDataBound="Grid1_PreDataBound"
                            DataIDField="ManagePersonQualityItemId" Height="200px" Margin="10px">
                            <Toolbars>
                                <f:Toolbar ID="Toolbar2" runat="server">
                                    <Items>
                                        <f:Label ID="lblTit" runat="server" Text="资质证书（双击编辑）"></f:Label>
                                        <f:ToolbarFill runat="server">
                                        </f:ToolbarFill>
                                        <f:Button ID="btnNew" ToolTip="新增资质证书" Icon="Add" EnablePostBack="false" runat="server">
                                        </f:Button>
                                    </Items>
                                </f:Toolbar>
                            </Toolbars>
                            <Columns>
                                <f:RenderField Width="150px" ColumnID="CertificateNo" DataField="CertificateNo"
                                    HeaderText="证书编号" HeaderTextAlign="Center">
                                    <Editor>
                                        <f:TextBox ID="txtCertificateNo" Required="true" ShowRedStar="true" runat="server">
                                        </f:TextBox>
                                    </Editor>
                                </f:RenderField>
                                <f:RenderField Width="150px" ColumnID="CertificateName" DataField="CertificateName"
                                    HeaderText="证书名称" HeaderTextAlign="Center">
                                    <Editor>
                                        <f:TextBox ID="txtCertificateName" Required="true" ShowRedStar="true" runat="server">
                                        </f:TextBox>
                                    </Editor>
                                </f:RenderField>
                                <f:RenderField Width="180px" ColumnID="SendUnit" DataField="SendUnit"
                                    HeaderText="发证单位" HeaderTextAlign="Center" ExpandUnusedSpace="true">
                                    <Editor>
                                        <f:TextBox ID="txtSendUnit" Required="true" ShowRedStar="true" runat="server">
                                        </f:TextBox>
                                    </Editor>
                                </f:RenderField>
                                <f:RenderField Width="120px" ColumnID="SendDate" DataField="SendDate" FieldType="Date"
                                    Renderer="Date" RendererArgument="yyyy-MM-dd" HeaderText="发证时间" HeaderTextAlign="Center">
                                    <Editor>
                                        <f:DatePicker ID="txtSendDate" runat="server">
                                        </f:DatePicker>
                                    </Editor>
                                </f:RenderField>
                                <f:RenderField Width="120px" ColumnID="LimitDate" DataField="LimitDate" FieldType="Date"
                                    Renderer="Date" RendererArgument="yyyy-MM-dd" HeaderText="有效期至" HeaderTextAlign="Center">
                                    <Editor>
                                        <f:DatePicker ID="txtLimitDate" runat="server">
                                        </f:DatePicker>
                                    </Editor>
                                </f:RenderField>
                                <f:RenderField Width="1px" ColumnID="ManagePersonQualityItemId" DataField="ManagePersonQualityItemId"
                                ...
                                <f:LinkButtonField ColumnID="Delete" Width="80px" EnablePostBack="false"
                                    Icon="Delete" HeaderText="删除" HeaderTextAlign="Center" TextAlign="Center" />
                            </Columns>
                        </f:Grid>
                    </Items>
                </f:FormRow>
