...
{
    public partial class SafePersonQuality : PageBase
    {
        #region 项目主键
        /// <summary>
        /// 项目主键
        ...
        private void EditData()
        {
            ...
            if (person != null)
            {
                PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("SafePersonQualityEdit.aspx?PersonId={0}", id, "编辑 - ")));
            }
        }
        #endregion
        ...
        {
            var buttonList = BLL.CommonService.GetAllButtonList(this.CurrUser.LoginProjectId, this.CurrUser.UserId, BLL.Const.SafePersonQualityMenuId);
        ...
        protected void btnOut_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + System.Web.HttpUtility.UrlEncode("安全人员资质" + filename, System.Text.Encoding.UTF8) + ".xls");
...
#pragma warning disable CS0108 // “SafePersonQuality.GetGridTableHtml(Grid)”隐藏继承的成员“PageBase.GetGridTableHtml(Grid)”。如果是有意隐藏，请使用关键字 new。
        /// <summary>
        /// 导出方法
        /// </summary>
...
#pragma warning restore CS0108 // “SafePersonQuality.GetGridTableHtml(Grid)”隐藏继承的成员“PageBase.GetGridTableHtml(Grid)”。如果是有意隐藏，请使用关键字 new。
        {
