...
{
    public partial class ProjectRecord : PageBase
    {
        #region 项目主键
        /// <summary>
        /// 项目主键
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                this.btnNew.OnClientClick = Window1.GetShowReference("ProjectRecordEdit.aspx") + "return false;";
        ...
        private void BindGrid()
        {
            string strSql = @"SELECT ProjectRecord.ProjectRecordId,"
                          ...
                          + @"CodeRecords.Code AS ProjectRecordCode,"
                          + @"ProjectRecord.ProjectRecordName,"
            ...
            {
                strSql += " AND ProjectRecordCode LIKE @ProjectRecordCode";
                listStr.Add(new SqlParameter("@ProjectRecordCode", "%" + this.txtProjectRecordCode.Text.Trim() + "%"));
            }
            if (!string.IsNullOrEmpty(this.txtProjectRecordName.Text.Trim()))
            {
                strSql += " AND ProjectRecordName LIKE @ProjectRecordName";
                listStr.Add(new SqlParameter("@ProjectRecordName", "%" + this.txtProjectRecordName.Text.Trim() + "%"));
            }
        ...
        private void EditData()
        {
            ...
            var projectRecord = BLL.ProjectRecordService.GetProjectRecordById(id);
            if (projectRecord != null)
            {
                PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("ProjectRecordEdit.aspx?ProjectRecordId={0}", id, "编辑 - ")));
            }
        }
        #endregion
        ...
        protected void btnOut_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + System.Web.HttpUtility.UrlEncode("项目安全协议清单" + filename, System.Text.Encoding.UTF8) + ".xls");
...
#pragma warning disable CS0108 // “ProjectRecord.GetGridTableHtml(Grid)”隐藏继承的成员“PageBase.GetGridTableHtml(Grid)”。如果是有意隐藏，请使用关键字 new。
        /// <summary>
        /// 导出方法
        /// </summary>
...
#pragma warning restore CS0108 // “ProjectRecord.GetGridTableHtml(Grid)”隐藏继承的成员“PageBase.GetGridTableHtml(Grid)”。如果是有意隐藏，请使用关键字 new。
        {
