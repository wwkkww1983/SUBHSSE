...
{
    public partial class SubUnitQualityAuditView : PageBase
    {
        #region 定义项
        /// <summary>
        /// 审查明细id
        ...
        protected void btnAttachUrl_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(this.AuditDetailId))
            {
                PageContext.RegisterStartupScript(WindowAtt.GetShowReference(String.Format("../AttachFile/webuploader.aspx?toKeyId={0}&path=FileUpload/SubUnitQualityAuditAttachUrl&menuId={1}&type=-1", this.AuditDetailId, BLL.Const.SubUnitQualityMenuId)));
            }
