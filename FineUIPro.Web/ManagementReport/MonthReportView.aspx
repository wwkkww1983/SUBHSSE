<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonthReportView.aspx.cs" Inherits="FineUIPro.Web.ManagementReport.MonthReportView" %>
            ...
            <f:FormRow>
                <Items>
                    <f:GroupPanel ID="GroupPanel2" Layout="Anchor" Title="项目总体数据统计" runat="server">
                        <Items>
                            <f:TextArea ID="txtAllProjectData" runat="server" Height="150px" Readonly="true">
                            </f:TextArea>
                            <f:TextArea ID="txtAllManhoursData" runat="server" Height="100px" Readonly="true">
                            </f:TextArea>
                        </Items>
                    </f:GroupPanel>
                </Items>
                                    ...
                                    <%--<f:FormRow>
                                        <Items>
                                            <f:NumberBox ID="txtHseNumber10" NoDecimal="false" NoNegative="true" MinValue="0"
                                                runat="server" Label="入场安全培训率（现场参加培训人数与现场全部作业人数的比值）" LabelWidth="400px" Readonly="true">
                                            </f:NumberBox>
                                            <f:Label runat="server" ID="Label39" Text="%">
                                            </f:Label>
                                        </Items>
                                    ...
                                    <f:FormRow>
                                        <Items>
                                            <f:NumberBox ID="txtHseNumber11" NoDecimal="false" NoNegative="true" MinValue="0"
                                                runat="server" Label="机械设备检验率（已检机械设备数量与全部在用机械设备数量的比值）" LabelWidth="425px" Readonly="true">
                                            </f:NumberBox>
