<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServerSafeUnitReport.aspx.cs" Inherits="FineUIPro.Web.ManagementReport.ServerSafeUnitReport" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>分公司安全文件上报</title>
    ...
    <f:Panel ID="Panel1" runat="server" ShowBorder="false" ShowHeader="false" Layout="Region">
        <Items>
            <f:Panel runat="server" ID="panelLeftRegion" RegionPosition="Left" RegionSplit="true"
                Layout="Fit" EnableCollapse="true" Width="250" Title="分公司安全文件上报" TitleToolTip="分公司安全文件上报"
                ShowBorder="false" ShowHeader="false" AutoScroll="true" BodyPadding="5px" IconFont="ArrowCircleLeft">
                <Items>
                    <f:Tree ID="trSafeReport" Width="200px" Title="分公司安全文件上报" ShowHeader="false" OnNodeCommand="trSafeReport_NodeCommand"
