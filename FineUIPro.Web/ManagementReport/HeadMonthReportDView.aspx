<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HeadMonthReportDView.aspx.cs"
    Inherits="FineUIPro.Web.ManagementReport.HeadMonthReportDView" %>
            ...
            <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
                ...
                <Rows>
                    <f:FormRow ColumnWidths="33% 33% 33%">
                        <Items>
                            <f:Label ID="txtMonths" runat="server" Label="月报月份" Width="300px" LabelAlign="right"
                                LabelWidth="120px">
                            </f:Label>
                            <f:Label ID="Label1" runat="server" Label="" Width="300px" LabelAlign="right" LabelWidth="140px">
                            </f:Label>
                            <f:Label ID="Label2" runat="server" Label="" Width="300px" LabelAlign="right" LabelWidth="140px">
                            </f:Label>
                        </Items>
                    </f:FormRow>
                    <f:FormRow>
                        <Items>
                            <f:TextArea ID="txtProjectNames" runat="server" MaxLength="500" Label="统计项目" LabelWidth="120px"
                                Readonly="true">
                            </f:TextArea>
                        </Items>
                    </f:FormRow>
                                        ...
                                        <Rows>
                                            <f:FormRow>
                                                <Items>
                                                    ...
                                                    <f:NumberBox ID="txtDeathPersonNum" NoDecimal="true" NoNegative="true" MinValue="0"
                                                        runat="server" Label="死亡人数" LabelWidth="200px" Readonly="true">
                                                    </f:NumberBox>
                                ...
                                <Items>
                                    <f:Form ID="Form3" ShowBorder="false" ShowHeader="false" AutoScroll="true" BodyPadding="10px"
                                        ...
                                        <Rows>
                                            ...
                                            <f:FormRow ColumnWidths="33% 33% 33%">
                                                <Items>
                                                    <f:NumberBox ID="txtPropertyLossMoney" NoDecimal="true" NoNegative="true" MinValue="0"
