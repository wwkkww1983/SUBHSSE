<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagerStatistic.aspx.cs"
    Inherits="FineUIPro.Web.ManagementReport.ManagerStatistic" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            <f:FormRow>
                <Items>
                    <f:DatePicker runat="server" Label="开始日期" ID="txtStartTime" LabelAlign="right" DateFormatString="yyyy-MM">
                    </f:DatePicker>
                    <f:DatePicker runat="server" Label="结束日期" ID="txtEndTime" LabelAlign="right" DateFormatString="yyyy-MM">
                    </f:DatePicker>
            ...
            <f:FormRow ColumnWidths="44% 7% 44%">
                <Items>
