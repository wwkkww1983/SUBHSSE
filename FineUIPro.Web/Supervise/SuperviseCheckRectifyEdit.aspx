<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SuperviseCheckRectifyEdit.aspx.cs"
    Async="true" Inherits="FineUIPro.Web.Supervise.SuperviseCheckRectifyEdit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>编辑安全监督检查整改</title>
                    ...
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" EnableCollapse="true" runat="server"
                        ...
                        <Columns>
                            ...
                            <f:RenderField Width="90px" EnableLock="true" ColumnID="ConfirmDate" DataField="ConfirmDate"
                                ...
                                <Editor>
                                    <f:DatePicker ID="txtConfirmDate" runat="server" Text='<%# Eval("ConfirmDate")%>'>
                                    </f:DatePicker>
                                </Editor>
                            </f:RenderField>
                            <f:RenderField Width="100px" EnableLock="true" ColumnID="OrderEndDate" DataField="OrderEndDate"
                                ...
                                TextAlign="Center" HeaderTextAlign="Center">
                                <Editor>
                                    <f:DatePicker ID="txtOrderEndDate" runat="server" Text='<%# Eval("OrderEndDate")%>'>
                                    </f:DatePicker>
                                </Editor>
                            </f:RenderField>
