...
{
    public partial class SuperviseCheckRectify : PageBase
    {
        #region 加载页面
        /// <summary>
        /// 加载页面
        ...
        protected void Grid1_RowCommand(object sender, GridCommandEventArgs e)
        {
            string rowID = Grid1.DataKeys[e.RowIndex][0].ToString();
                ...
                {
                    Model.Supervise_SuperviseCheckRectify rectify = BLL.SuperviseCheckRectifyService.GetSuperviseCheckRectifyById(rowID);
                    if(rectify!=null)
                    {
                        Model.Supervise_SuperviseCheckReport report = BLL.SuperviseCheckReportService.GetSuperviseCheckReportById(rectify.SuperviseCheckReportId);
                        if (report != null)
                        {
                            report.IsIssued = "0";   //未下发
                            BLL.SuperviseCheckReportService.UpdateSuperviseCheckReport(report);
                        }
                    }
                    BLL.SuperviseCheckRectifyItemService.DeleteSuperviseCheckRectifyItemBySuperviseCheckRectifyId(rowID);
                    BLL.SuperviseCheckRectifyService.DeleteSuperviseCheckRectifyById(rowID);
        ...
        private void EditData()
        {
                ...
                PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("SuperviseCheckRectifyEdit.aspx?SuperviseCheckRectifyId={0}", SuperviseCheckRectifyId, "编辑 - ")));
