<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HazardRegister.aspx.cs" Inherits="FineUIPro.Web.Hazard.HazardRegister" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="危险观察登记" EnableCollapse="true"
                ...
                <Columns>
                    ...
                    <f:RenderField Width="120px" ColumnID="RegistrationCode" DataField="RegistrationCode"
                        SortField="RegistrationCode" FieldType="String" HeaderText="登记编号" TextAlign="Left"
                    ...
                    <f:RenderField Width="100px" ColumnID="CheckMan" DataField="CheckMan" 
                    ...
                    <f:RenderField Width="100px" ColumnID="IsEffectiveStr" DataField="IsEffectiveStr" FieldType="String"
                        HeaderText="是否有效" HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
    ...
    <f:Window ID="Window1" Title="编辑危险观察登记" Hidden="true" EnableIFrame="true" EnableMaximize="true"
