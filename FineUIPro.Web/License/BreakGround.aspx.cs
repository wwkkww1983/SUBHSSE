...
namespace FineUIPro.Web.License
{
    public partial class BreakGround : PageBase
    {
        ...
        private void EditData()
        {
            ...
            PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("BreakGroundView.aspx?BreakGroundId={0}", id, "查看 - ")));
        }
        #endregion
        ...
        protected void btnMenuDelete_Click(object sender, EventArgs e)
        {
            if (Grid1.SelectedRowIndexArray.Length > 0)
            {
                foreach (int rowIndex in Grid1.SelectedRowIndexArray)
                {
                    ...
                    var BreakGround = LicensePublicService.GetBreakGroundById(rowID);
                    if (BreakGround != null)
                    {
                        LogService.AddSys_Log(this.CurrUser, BreakGround.LicenseCode, BreakGround.BreakGroundId, Const.ProjectBreakGroundMenuId, Const.BtnDelete);
                        LicensePublicService.DeleteBreakGroundById(rowID);
                    }
                }
        ...
        private void GetButtonPower()
        {
            ...
            var buttonList = BLL.CommonService.GetAllButtonList(this.CurrUser.LoginProjectId, this.CurrUser.UserId, BLL.Const.ProjectBreakGroundMenuId);
        ...
        protected void btnOut_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + System.Web.HttpUtility.UrlEncode("动土作业票" + filename, System.Text.Encoding.UTF8) + ".xls");
