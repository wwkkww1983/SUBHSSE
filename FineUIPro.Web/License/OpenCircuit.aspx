<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OpenCircuit.aspx.cs"
    Inherits="FineUIPro.Web.License.OpenCircuit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>断路(占道)作业票</title>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="断路(占道)作业票" EnableCollapse="true"
                runat="server" BoxFlex="1"  DataKeyNames="OpenCircuitId" AllowCellEditing="true"  ClicksToEdit="2" 
                DataIDField="OpenCircuitId" AllowSorting="true"
                ...
                <Columns>
                   ...
                   <f:RenderField Width="120px" ColumnID="RoadName" DataField="RoadName" 
                        SortField="RoadName" FieldType="String" HeaderText="占用道路名称" HeaderTextAlign="Center"
                        TextAlign="Left">
                    </f:RenderField>
                     <f:RenderField Width="200px" ColumnID="SafeMeasures" DataField="SafeMeasures" 
                        SortField="SafeMeasures" FieldType="String" HeaderText="安全措施及使用的工机具说明" HeaderTextAlign="Center"
                        TextAlign="Left">
                    </f:RenderField>
                </Columns>
                <Listeners>
