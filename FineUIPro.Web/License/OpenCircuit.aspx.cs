...
namespace FineUIPro.Web.License
{
    public partial class OpenCircuit : PageBase
    {
        ...
        {
            string strSql = "SELECT license.OpenCircuitId,license.ProjectId,license.LicenseCode,license.ApplyUnitId,ApplyUnit.UnitName AS ApplyUnitName,license.ApplyManId,license.ApplyDate,license.WorkPalce,license.ValidityStartTime,license.ValidityEndTime,license.WorkMeasures"
                        + @" ,license.SafeMeasures,license.RoadName,license.States"
                        ...
                        + @" FROM dbo.License_OpenCircuit AS license "
        ...
        private void EditData()
        {
            ...
            PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("OpenCircuitView.aspx?OpenCircuitId={0}", id, "查看 - ")));
        }
        #endregion
        ...
        protected void btnMenuDelete_Click(object sender, EventArgs e)
        {
            if (Grid1.SelectedRowIndexArray.Length > 0)
            {
                foreach (int rowIndex in Grid1.SelectedRowIndexArray)
                {
                    ...
                    var OpenCircuit = LicensePublicService.GetOpenCircuitById(rowID);
                    if (OpenCircuit != null)
                    {
                        LogService.AddSys_Log(this.CurrUser, OpenCircuit.LicenseCode, OpenCircuit.OpenCircuitId, Const.ProjectOpenCircuitMenuId, Const.BtnDelete);
                        LicensePublicService.DeleteOpenCircuitById(rowID);
                    }
                }
        ...
        private void GetButtonPower()
        {
            ...
            var buttonList = BLL.CommonService.GetAllButtonList(this.CurrUser.LoginProjectId, this.CurrUser.UserId, BLL.Const.ProjectOpenCircuitMenuId);
        ...
        protected void btnOut_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + System.Web.HttpUtility.UrlEncode("断路(占道)作业票" + filename, System.Text.Encoding.UTF8) + ".xls");
