<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RadialWorkView.aspx.cs"
    Inherits="FineUIPro.Web.License.RadialWorkView" %>
            ...
            <f:FormRow>
                 <Items>
                    <f:TextBox ID="txtRadialType" runat="server" Label="射线类型" Readonly="true" LabelWidth="140px">
                     ...
                     <f:TextBox ID="txtWorkLeader" runat="server" Label="作业负责人/电话" Readonly="true" LabelWidth="140px">
                    </f:TextBox>
                 </Items>
             </f:FormRow>
            <f:FormRow>
        ...
        <Toolbars>
            <f:Toolbar ID="Toolbar1" Position="Bottom" ToolbarAlign="Right" runat="server">
                <Items>
                    ...
                    <f:Button ID="btnAttachUrl" Text="影响区域平面图" ToolTip="影响区域平面图查看" Icon="TableCell" runat="server"
