<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RadialWork.aspx.cs"
    Inherits="FineUIPro.Web.License.RadialWork" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="射线作业票" EnableCollapse="true"
                runat="server" BoxFlex="1"  DataKeyNames="RadialWorkId" AllowCellEditing="true"  ClicksToEdit="2" 
                DataIDField="RadialWorkId" AllowSorting="true"
                ...
                <Columns>
                    ...
                    <f:RenderField Width="90px" ColumnID="RadialType" DataField="RadialType" SortField="RadialType"
                        FieldType="String" HeaderText="射线类型" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>  
                    ...
                    <f:RenderField Width="200px" ColumnID="WorkMeasures" DataField="WorkMeasures" 
                        SortField="WorkMeasures" FieldType="String" HeaderText="安全距离及受影响区域/单位" HeaderTextAlign="Center"
                        TextAlign="Left">
                    </f:RenderField>
                </Columns>
                <Listeners>
