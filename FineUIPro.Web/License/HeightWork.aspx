<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HeightWork.aspx.cs"
    Inherits="FineUIPro.Web.License.HeightWork" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="高处作业票" EnableCollapse="true"
                runat="server" BoxFlex="1"  DataKeyNames="HeightWorkId" AllowCellEditing="true"  ClicksToEdit="2" 
                DataIDField="HeightWorkId" AllowSorting="true"
                ...
                <Columns>
                    ...
                    <f:RenderField Width="160px" ColumnID="WorkPalce" DataField="WorkPalce" SortField="WorkPalce"
                     ...
                     <f:RenderField Width="90px" ColumnID="WorkType" DataField="WorkType" SortField="WorkType"
                        FieldType="String" HeaderText="作业类别" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField> 
                    ...
                    <f:RenderField Width="200px" ColumnID="WorkMeasures" DataField="WorkMeasures" 
                        SortField="WorkMeasures" FieldType="String" HeaderText="作业内容及安全措施" HeaderTextAlign="Center"
                        TextAlign="Left">
                    </f:RenderField>
                     <f:RenderField Width="150px" ColumnID="EquipmentTools" DataField="EquipmentTools" 
                        SortField="EquipmentTools" FieldType="String" HeaderText="设备及工具" HeaderTextAlign="Center"
                        TextAlign="Left">
                    </f:RenderField>
                </Columns>
                <Listeners>
