...
namespace FineUIPro.Web.License
{
    public partial class RadialWork : PageBase
    {
        ...
        {
            string strSql = "SELECT Fire.RadialWorkId,Fire.ProjectId,Fire.LicenseCode,Fire.ApplyUnitId,ApplyUnit.UnitName AS ApplyUnitName,Fire.ApplyManId,Fire.ApplyDate,Fire.WorkPalce,Fire.ValidityStartTime,Fire.ValidityEndTime,Fire.WorkMeasures,Fire.States"
                        ...
                        + @" FROM dbo.License_RadialWork AS Fire "
