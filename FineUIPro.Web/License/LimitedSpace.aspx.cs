...
namespace FineUIPro.Web.License
{
    public partial class LimitedSpace : PageBase
    {
        ...
        private void EditData()
        {
            ...
            PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("LimitedSpaceView.aspx?LimitedSpaceId={0}", id, "查看 - ")));
        }
        #endregion
        ...
        protected void btnMenuDelete_Click(object sender, EventArgs e)
        {
            if (Grid1.SelectedRowIndexArray.Length > 0)
            {
                foreach (int rowIndex in Grid1.SelectedRowIndexArray)
                {
                    ...
                    var LimitedSpace = LicensePublicService.GetLimitedSpaceById(rowID);
                    if (LimitedSpace != null)
                    {
                        LogService.AddSys_Log(this.CurrUser, LimitedSpace.LicenseCode, LimitedSpace.LimitedSpaceId, Const.ProjectLimitedSpaceMenuId, Const.BtnDelete);
                        LicensePublicService.DeleteLimitedSpaceById(rowID);
                    }
                }
        ...
        private void GetButtonPower()
        {
            ...
            var buttonList = BLL.CommonService.GetAllButtonList(this.CurrUser.LoginProjectId, this.CurrUser.UserId, BLL.Const.ProjectLimitedSpaceMenuId);
        ...
        protected void btnOut_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + System.Web.HttpUtility.UrlEncode("受限空间作业票" + filename, System.Text.Encoding.UTF8) + ".xls");
