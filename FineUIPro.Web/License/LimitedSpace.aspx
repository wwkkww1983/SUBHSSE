<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LimitedSpace.aspx.cs"
    Inherits="FineUIPro.Web.License.LimitedSpace" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="受限空间作业票" EnableCollapse="true"
                runat="server" BoxFlex="1"  DataKeyNames="LimitedSpaceId" AllowCellEditing="true"  ClicksToEdit="2" 
                DataIDField="LimitedSpaceId" AllowSorting="true"
                ...
                <Columns>
                    ...
                    <f:RenderField Width="140px" ColumnID="ValidityStartTime" DataField="ValidityStartTime" SortField="ValidityStartTime"
                        FieldType="Date" Renderer="Date" RendererArgument="yyyy-MM-dd HH:mm" HeaderText="作业开始时间"
                        HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="140px" ColumnID="ValidityEndTime" DataField="ValidityEndTime" SortField="ValidityEndTime"
                        FieldType="Date" Renderer="Date" RendererArgument="yyyy-MM-dd HH:mm" HeaderText="作业结束时间"
                        HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
    ...
    <f:Window ID="Window1" Title="受限空间作业票" Hidden="true" EnableIFrame="true" EnableMaximize="true"
