...
{
    public partial class NightWork : PageBase
    {
        #region 项目主键
        /// <summary>
        /// 项目主键
        ...
        private void EditData()
        {
            ...
            PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("NightWorkView.aspx?NightWorkId={0}", id, "查看 - ")));
        }
        #endregion
        ...
        protected void btnMenuDelete_Click(object sender, EventArgs e)
        {
            if (Grid1.SelectedRowIndexArray.Length > 0)
            {
                foreach (int rowIndex in Grid1.SelectedRowIndexArray)
                {
                    ...
                    var NightWork = LicensePublicService.GetNightWorkById(rowID);
                    if (NightWork != null)
                    {
                        LogService.AddSys_Log(this.CurrUser, NightWork.LicenseCode, NightWork.NightWorkId, Const.ProjectNightWorkMenuId, Const.BtnDelete);
                        LicensePublicService.DeleteNightWorkById(rowID);
                    }
                }
        ...
        protected void btnOut_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + System.Web.HttpUtility.UrlEncode("夜间施工作业票" + filename, System.Text.Encoding.UTF8) + ".xls");
